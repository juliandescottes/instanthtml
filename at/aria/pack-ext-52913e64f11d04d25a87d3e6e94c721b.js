...
$classpath:o}))}return r.push(this.generateFile(this.TYPE_HTMLTEMPLATE,i)),r},generateModuleCtrl:function(e,t){var n=[],r=e.lastIndexOf("."),i=e.substring(0,r),s=e.substring(r+1),o=i+".I"+s;n.push(this.generateFile(this.TYPE_MODULECONTROLLERINTERFACE,{$classpath:o,$description:e+" public interface definition"})),n.push(this.generateFile(this.TYPE_MODULECONTROLLER,{$classpath:e,$description:"My module controller",$publicInterface:o,$hasFlowCtrl:t}));if(t){var u=i+".I"+s+"Flow",a=e+"Flow";n.push(this.generateFile
(this.TYPE_FLOWCONTROLLERINTERFACE,{$classpath:u,$description:a+" public interface definition"})),n.push(this.generateFile(this.TYPE_FLOWCONTROLLER,{$classpath:a,$publicInterface:u,$description:"My flow controller"}))}return n},getUniqueClasspathIn:function(e){return e+"."+"Class"+this.__classNameCounter++},__isAllowedType:function(e){return aria.utils.Json.getValue(this,e)},__getSkeleton:function(e,t,n){return n||(n={}),aria.core.JsonValidator.normalize({json:n,beanName:t}),{cfg:n,content:e.processTextTemplate
(n)}}}});
//*******************
//LOGICAL-PATH:aria/ext/filesgenerator/GeneratorBeans.js
//*******************
Aria.beanDefinitions({$package:"aria.ext.filesgenerator.GeneratorBeans",$description:"Definition of the JSON beans used as input of the file skeleton generator",$namespaces:{json:"aria.core.JsonTypes"},$beans:{classSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a class skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the class",$default:"company.package.Class"},$description:{$type:"json:String",$description:"Description of the class"
,$default:"The description of this class and how it should be used"},$extends:{$type:"json:String",$description:"The namespace of the extended class",$default:"aria.core.JsObject"},$singleton:{$type:"json:Boolean",$description:"Whether the class is a singleton or not",$default:!1},$dependencies:{$type:"json:Array",$description:"The list of dependencies (namespaces) this class has",$default:null,$contentType:{$type:"json:String",$description:"Classpath of the dependency"}},$implements:{$type:"json:Array",$description
:"list of interfaces to be implemented",$default:null,$contentType:{$type:"json:String",$description:"Classpath of the interface"}}}},interfaceSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate an interface skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the interface",$default:"company.package.IClass"},$description:{$type:"json:String",$description:"Description of the interface",$default:"The description of this interface and how it should be implemented"
},$extends:{$type:"json:String",$description:"The namespace of the extended interface",$default:null}}},htmlTemplateSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate an HTML template skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the template",$default:"company.package.MyTemplate"},$extends:{$type:"json:String",$description:"The namespace of the extended class",$default:null},$hasScript:{$type:"json:Boolean",$description:"whether the template has an associated script or not"
,$default:!1},$css:{$type:"json:Array",$description:"list of CSS templates to be applied to this HTML template",$default:null,$contentType:{$type:"json:String",$description:"Classpath of the CSS templates"}},content:{$type:"json:String",$description:"Optional content of the template"}}},cssTemplateSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a CSS template skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the css template"
,$default:"company.package.MyCssTemplate"},$hasScript:{$type:"json:Boolean",$description:"whether the css template has an associated script or not",$default:!1}}},templateScriptSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a template script skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the template script",$default:"company.package.MyTemplateScript"}}},macroLibrarySkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a template script skeleton from a text template"
,$properties:{$classpath:{$type:"json:String",$description:"classpath of the template script",$default:"company.package.MyTemplateScript"},$hasScript:{$type:"json:Boolean",$description:"whether the macro lib has an associated script or not",$default:!1}}},cssLibrarySkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a template script skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the template script",$default:"company.package.MyTemplateScript"
},$hasScript:{$type:"json:Boolean",$description:"whether the CSS lib has an associated script or not",$default:!1}}},flowControllerSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a flow controller skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the flow controller",$default:"company.package.MyFlowController"},$description:{$type:"json:String",$description:"Description of the class",$default:"The description of this flow controller implementation"
},$publicInterface:{$type:"json:String",$description:"The classpath of the public interface of this flow controller",$default:"company.package.IMyFlowController"},$implements:{$type:"json:Array",$description:"list of other interfaces to be implemented",$default:[],$contentType:{$type:"json:String",$description:"Classpath of the interface"}},$extends:{$type:"json:String",$description:"The namespace of the extended class",$default:"aria.templates.FlowCtrl"},$dependencies:{$type:"json:Array",$description:"The list of dependencies (namespaces) this flow controller class has"
,$default:null,$contentType:{$type:"json:String",$description:"Classpath of the dependency"}}}},moduleControllerSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a module controller skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the module controller",$default:"company.package.MyModuleController"},$publicInterface:{$type:"json:String",$description:"The classpath of the public interface of this module controller",$default:"company.package.IMyModuleController"
},$implements:{$type:"json:Array",$description:"list of other interfaces to be implemented",$default:[],$contentType:{$type:"json:String",$description:"Classpath of the interface"}},$extends:{$type:"json:String",$description:"The namespace of the extended class",$default:"aria.templates.ModuleCtrl"},$description:{$type:"json:String",$description:"Description of the class",$default:"The description of this module controller implementation"},$dependencies:{$type:"json:Array",$description:"The list of dependencies (namespaces) this module controller class has"
,$default:null,$contentType:{$type:"json:String",$description:"Classpath of the dependency"}},$hasFlowCtrl:{$type:"json:Boolean",$description:"Whether the module controller has an associated flow controller.",$default:!1}}},moduleControllerInterfaceSkeletonTemplate:{$type:"interfaceSkeletonTemplate",$description:"Input parameter to generate a module controller interface skeleton from a text template"},flowControllerInterfaceSkeletonTemplate:{$type:"interfaceSkeletonTemplate",$description:"Input parameter to generate a flow controller interface skeleton from a text template"
},bootstrapSkeletonTemplate:{$type:"json:Object",$description:"Input parameter to generate a bootstrap skeleton from a text template",$properties:{$classpath:{$type:"json:String",$description:"classpath of the template",$default:"company.package.MyTemplate"},$fwkpath:{$type:"json:String",$description:"classpath of the framework script"},$fwkskin:{$type:"json:String",$description:"classpath of the skin script"},$moduleCtrl:{$type:"json:String",$description:"classpath of the module controller",$default:null}}}
}});
//*******************
