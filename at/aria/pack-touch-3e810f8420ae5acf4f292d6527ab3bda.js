...
,originalEvent:"The originating touchmove event."}},swipeend:{description:"Raised when a user completes a swipe",properties:{route:"Contains the direction and the distance of the swipe from the swipe start to the current swipe event coordinates.",originalEvent:"The originating touchend event."}},swipecancel:{description:"Raised when a swipe is cancelled or completed and the listeners for the event need to be removed."}},$constructor:function(){this.body={},this.touchEventMap=aria.touch.Event.touchEventMap;var e=
aria.utils.AriaWindow;e.$on({attachWindow:this._connectTouchEvents,detachWindow:this._disconnectTouchEvents,scope:this}),e.isWindowUsed&&this._connectTouchEvents()},$destructor:function(){aria.utils.AriaWindow.$unregisterListeners(this),this._disconnectTouchEvents(),this.body=null,this.touchEventMap=null},$statics:{MARGIN:20},$prototype:{_connectTouchEvents:function(){this.body=Aria.$window.document.body,aria.utils.Event.addListener(this.body,this.touchEventMap.touchstart,{fn:this._swipeStart,scope:this})},_disconnectTouchEvents
:function(){aria.utils.Event.removeListener(this.body,this.touchEventMap.touchstart,{fn:this._swipeStart,scope:this}),this._swipeCancel()},_swipeStart:function(e){var t={startX:e.pageX?e.pageX:e.clientX,startY:e.pageY?e.pageY:e.clientY,start:(new Date).getTime()};aria.utils.Event.addListener(this.body,this.touchEventMap.touchmove,{fn:this._swipeMove,scope:this,args:t}),aria.utils.Event.addListener(this.body,this.touchEventMap.touchend,{fn:this._swipeEnd,scope:this,args:t}),this.$raiseEvent({name:"swipestart"
,startX:t.startX,startY:t.startY,originalEvent:e})},_swipeEnd:function(e,t){var n=(new Date).getTime()-t.start;t.eventType="swipeend";var r=this._getRoute(t),i=!1;if(r){var s=e.target?e.target:e.srcElement,o=aria.DomEvent.getFakeEvent("swipe",s);i=e.returnValue,o.duration=n,o.distance=r.distance,o.direction=r.direction,o.startX=r.startX,o.startY=r.startY,o.endX=r.endX,o.endY=r.endY,aria.utils.Delegate.delegate(o),e.cancelBubble=o.hasStopPropagation,e.returnValue=!o.hasPreventDefault,this.$raiseEvent({name:"swipeend"
,route:r,originalEvent:e})}return this._swipeCancel(),i},_swipeCancel:function(){var e=!0;while(e)e=aria.utils.Event.removeListener(this.body,this.touchEventMap.touchend,{fn:this._swipeEnd,scope:this});e=!0;while(e)e=aria.utils.Event.removeListener(this.body,this.touchEventMap.touchmove,{fn:this._swipeMove,scope:this});this.$raiseEvent({name:"swipecancel"})},_swipeMove:function(e,t){t.endX=e.pageX?e.pageX:e.clientX,t.endY=e.pageY?e.pageY:e.clientY,t.eventType="swipemove";var n=this._getRoute(t);n?this.$raiseEvent
({name:"swipemove",route:n,originalEvent:e}):this._swipeCancel()},_getRoute:function(e){var t=e.endX-e.startX,n=e.endY-e.startY,r=Math.abs(t),i=Math.abs(n),s=i>r&&r<=this.MARGIN,o=r>i&&i<=this.MARGIN;return e.eventType==="swipemove"?{direction:"unknown",distance:"0",startX:e.startX,startY:e.startY,endX:e.endX,endY:e.endY}:s?{direction:n<0?"up":"down",distance:i,startX:e.startX,startY:e.startY,endX:e.endX,endY:e.endY}:o?{direction:t<0?"left":"right",distance:r,startX:e.startX,startY:e.startY,endX:e.endX,endY:
e.endY}:!1}}});
//*******************
...
,$mandatory:!0},to:{$type:"json:String",$description:"Name of the JSON property to bind to.",$mandatory:!0}}}}}}});
//*******************
