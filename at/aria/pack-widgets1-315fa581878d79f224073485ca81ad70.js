...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.AriaSkinInterface",$singleton:!0,$dependencies:["aria.core.JsonValidator","aria.widgets.AriaSkinBeans","aria.widgets.AriaSkinNormalization","aria.core.DownloadMgr"],$statics:{WIDGET_SKIN_CLASS_OBJECT_NOT_FOUND:"There is no skin configuration for skin class %1 of widget %2. Skin class std will be used instead. The widget will probably not be displayed correctly."},$prototype:{skinImageProperties:["spriteURL","handleSpriteURLh","proxySpriteURLh","spriteUrl","frameIcon"
,"spriteURLv","spriteURLh"],normalizeSkin:function(){aria.widgets.AriaSkinNormalization.normalizeSkin(aria.widgets.AriaSkin.skinObject)},getWidgetStates:function(e){var t=aria.core.JsonValidator.getBean("aria.widgets.AriaSkinBeans."+e+"Cfg");return t&&t.$properties.states?t.$properties.states.$properties:null},getSkinObject:function(e,t,n){var r=this.getSkinClasses(e);if(r){t==null&&(t="std");var i=r[t];return i?i:n?null:(this.$logWarn(this.WIDGET_SKIN_CLASS_OBJECT_NOT_FOUND,[t,e]),r.std)}},getSkinClasses:function(
e){var t=aria.widgets.AriaSkin.skinObject[e];if(!t||!t["aria:skinNormalized"]){var n=aria.widgets.AriaSkinNormalization.normalizeWidget(e,t);n&&n!=t&&(t=n,aria.widgets.AriaSkin.skinObject[e]=n)}return t},getGeneral:function(){var e=aria.widgets.AriaSkin.skinObject.general;if(!e||!e["aria:skinNormalized"]){var t=aria.widgets.AriaSkinNormalization.normalizeGeneral(e);e!=t&&(e=t,aria.widgets.AriaSkin.skinObject.general=t)}return e},getIcon:function(e,t){var n=this.getSkinObject("Icon",e,!0),r,i=0,s=0;if(n&&(r=n
.content[t])!==undefined){if(n.biDimensional){var o=r.split("_");i=(n.iconWidth+n.spriteSpacing)*o[0],s=(n.iconHeight+n.spriteSpacing)*o[1]}else n.direction==="x"?i=(n.iconWidth+n.spriteSpacing)*r:n.direction==="y"&&(s=(n.iconHeight+n.spriteSpacing)*r);return{iconLeft:i,iconTop:s,cssClass:"xICN"+e,spriteURL:n.spriteURL,width:n.iconWidth,height:n.iconHeight}}return!1},getSkinName:function(){return aria.widgets.AriaSkin.skinName||"atdefskin"},_extractSkinImages:function(e,t){if(e){var n=this.skinImageProperties
;for(var r=0,i=n.length;r<i;r++){var s=n[r],o=e[s];o&&(t[o]=1)}}},preloadSkinImages:function(e){var t={};e||(e=aria.widgets.AriaSkin.skinObject);if(e)for(var n in e){var r=e[n];if(r&&e.hasOwnProperty(n)&&n!="general")for(var i in r){var s=r[i];if(s&&r.hasOwnProperty(i)){this._extractSkinImages(s,t),this._extractSkinImages(s.frame,t);var o=this.getWidgetStates(n),u=s.states;if(u&&o)for(var a in u)if(o.hasOwnProperty(a)){var f=u[a];f&&(this._extractSkinImages(f,t),this._extractSkinImages(f.frame,t))}}}}var l=[
];for(var c in t)t.hasOwnProperty(c)&&l.push('<span style="background-image:url(',this.getSkinImageFullUrl(c),');">&nbsp;</span>');var h=Aria.$window.document,p=h.createElement("div");return h.body.appendChild(p),p.style.display="none",p.innerHTML=l.join(""),p},getSkinImageFullUrl:function(e){return aria.core.DownloadMgr.resolveURL(this.getGeneral().imagesRoot+e,!0)},backgroundMacro:function(e,t,n){var r="",i="";if(t){var s=this.getSkinImageFullUrl(t);r="url("+s+") ",aria.utils.String.endsWith(t,".png")?i=s.
substring(0,s.length-4)+".gif":i=s}var o=["background: ",e," ",r,n,";"];return i&&o.push("_background-image: url(",i,") !important;"),o.join("")}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.CfgBeans",$description:"Definition of the JSON beans used by the aria widgets library",$namespaces:{json:"aria.core.JsonTypes",templates:"aria.templates.CfgBeans",environmentBase:"aria.core.environment.EnvironmentBaseCfgBeans",FormListCfg:"aria.widgets.form.list.CfgBeans",dragDrop:"aria.utils.dragdrop.DragDropBean",common:"aria.widgetLibs.CommonBeans"},$beans:{WidgetCfg:{$type:"json:Object",$description:"Base config object used for any widget",$properties:{id:{$type
:"json:String",$description:"unique id (within the template) to associate to the widget - if not provided, a unique id will automatically be generated by the framework",$mandatory:!1},bind:{$type:"json:Object",$description:"List of properties that we want to bind for this widget - the property name being used as Map item key",$properties:{tooltip:{$type:"common:BindingRef"}},$sample:{tooltip:{to:"name",inside:"REF HERE - e.g.: data"}}},tooltip:{$type:"json:String",$description:"Floating text to display when mouse is over the widget - if empty or null the tooltip will be considered as unset"
,$default:null},tooltipId:{$type:"json:String",$description:"Id of the tooltip widget to be displayed when mouse is over the widget. - if empty or null no tooltip widget will be displayed",$default:null},width:{$type:"json:Integer",$description:"Widget width in pixel - note: some widgets may ignore this property. If negative, the width will be considered as unset and the widget will use the most appropriate width when possible",$default:-1},verticalAlign:{$type:"json:String",$description:"Define the vertical alignment of the widget. It can be any valid vertical-align CSS values. Nothing is set by default if the widgetSettings.middleAlignment environment property value is set to false, otherwise, the default value is middle."
},margins:{$type:"json:String",$description:"Width margin in the format: top right bottom left. Each margin is either an json:Integer or an x (meaning no change)",$default:null},block:{$type:"json:Boolean",$description:"This determines whether a display:block or display:inline-block should be used for the top-level span",$default:!1},printOptions:{$type:"templates:PrintOptions"},sclass:{$type:"json:String",$description:"which class defined in the skin is being used",$default:"std"},tabIndex:{$type:"json:Integer"
,$description:"The tab index of the widget. If null it's not taken into account, if 0 or above the widget will be focusable thorugh tab, if negative it won't be focusable.",$default:null}}},ContainerCfg:{$type:"ResizableWidgetCfg",$description:"Container widget which is used to give control over size and scrolling of widgets",$properties:{}},ResizableWidgetCfg:{$type:"WidgetCfg",$description:"Base config for any widget that can be resized in width and height (by default widgets only support width)",$properties
:{height:{$type:"json:Integer",$description:"Widget height in pixel - note: some widgets may ignore this property. If negative, the height will be considered as unset and the widget will use the most appropriate height when possible",$default:-1},minWidth:{$type:"json:Integer",$description:"Minimum widget width in pixel - note: some widgets may ignore this property. This requires width unset/equals to -1."},maxWidth:{$type:"json:Integer",$description:"Maximum widget width in pixel - note: some widgets may ignore this property. This requires width unset/equals to -1."
},minHeight:{$type:"json:Integer",$description:"Minimum widget height in pixel - note: some widgets may ignore this property. This requires height unset/equals to -1."},maxHeight:{$type:"json:Integer",$description:"Maximum widget height in pixel - note: some widgets may ignore this property. This requires height unset/equals to -1."},scrollBarX:{$type:"json:Boolean",$description:"Display horizontal scrollbar. This must be set to true if the list should overflow on the X axis.",$default:!1},scrollBarY:{$type:"json:Boolean"
,$description:"Display vertical scrollbar. This must be set to false if the list shouldn't overflow on the Y axis.",$default:!0}}},InputCfg:{$type:"WidgetCfg",$description:"Base config for any input object - adds label support to any widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{label:{$type:"common:BindingRef"},value:{$type:"common:BindingRef"},mandatory:{$type:"common:BindingRef"},readOnly:{$type:"common:BindingRef"},disabled:{$type:"common:BindingRef"},error:{$type:"common:BindingRef"},errorMessages
:{$type:"common:BindingRef"},formatError:{$type:"common:BindingRef"},formatErrorMessages:{$type:"common:BindingRef"},invalidText:{$type:"common:BindingRef"},requireFocus:{$type:"common:BindingRef"},name:{$type:"common:BindingRef"}}},inputMetaData:{$type:"json:String",$description:"Reference to the object that holds the input data (this object may contain $value, mandatory, readOnly, error, errorMessages, formatError, formatErrorMessages and validators properties that will be automatically bound to the widget)"
},value:{$type:"json:MultiTypes",$description:"Internal value associated to the widget - may be different from the text displayed or entered by the user (e.g. in case of codes or enums)"},mandatory:{$type:"json:Boolean",$description:"Indicates if the widget value must be provided (a specific style may apply to the widget to highlight this state to the user)",$default:!1},readOnly:{$type:"json:Boolean",$description:"Indicates if the widget must be read-only or if it can be edited",$default:!1},error:{$type:"json:Boolean"
,$description:"Highlights the input widget to notify an error to the user, defined in a template script.",$default:!1},errorMessages:{$type:"json:Array",$description:"List of error messages associated to the input widget, defined in a template script - these messages will be automatically displayed in a contextual error tooltip. If this array is not empty the error property is automatically set to true",$contentType:{$type:"json:String",$description:"Error message associated to the widget (can be generated by one of the validators)"
},$default:[]},formatError:{$type:"json:Boolean",$description:"Highlights the input widget to notify an error to the user, defined in the framework."},formatErrorMessages:{$type:"json:Array",$description:"List of error messages associated to the input widget, defined in the framework. - these messages will be automatically displayed in a contextual error tooltip.",$contentType:{$type:"json:String",$description:"Error messages associated to the widget, defined in the framework."},$default:[]},invalidText:{$type
:"json:String",$description:"Text displayed in the input when the field is invalid"},requireFocus:{$type:"json:Boolean",$description:"Set this bindable property to true to put the focus on the field. As soon as the focus has been put on the field, the property will be set back to false.",$default:!1},directOnBlurValidation:{$type:"json:Boolean",$description:"Whether validation on input widgets is automatically called by default on blur."},validationGroups:{$type:"json:Array",$description:"Contains groups that validation should occur for onblur."
,$contentType:{$type:"json:String",$description:"Contains the groups to validate."}},onvalidate:{$type:"common:Callback",$description:"Function to be called for custom validation."},validationEvent:{$type:"json:Enum",$enumValues:["onFocus","onBlur","none"],$default:"onFocus",$description:"contains the event used to display the error tip"},name:{$type:"json:String",$description:"name of the input in current language - useful to describe the error location to the user",$mandatory:!1},disabled:{$type:"json:Boolean"
,$description:"Indicates if the widget must be disabled",$default:!1},label:{$type:"json:String",$description:"Label text to associate to the control - must contain a separator if needed (e.g. :)",$default:null},labelAlign:{$type:"json:Enum",$description:"Alignment of the label",$enumValues:["left","right","center"],$default:"left"},labelPos:{$type:"json:Enum",$description:"Position of the label from the widget",$enumValues:["left","top","right","bottom"],$default:"left"},labelWidth:{$type:"json:Integer",$description
:"Width of the label container in px - if negative, the value is considered as unset",$default:-1},labelHeight:{$type:"json:Integer",$description:"Height of the label container in px - if negative, the value is considered as unset",$default:-1},hideLabel:{$type:"json:Boolean",$description:"Indicates if the label must be displayed or not (if true the label is hidden)",$default:!1}}},CheckBoxCfg:{$type:"InputCfg",$description:"Base config for any check box widget",$properties:{labelPos:{$type:"InputCfg.labelPos"
,$description:"Position of the Checkbox (or radio box) label",$default:"right"},value:{$type:"InputCfg.value",$description:"Value associated to the widget representing the selected state",$default:!1},onchange:{$type:"common:Callback",$description:"Function to be called when the state of the widget changes due to user action(click)"},icon:{$type:"json:String",$description:"The name of the sprite and the icon that is to be used in the form sprite:icon",$default:null},tabIndex:{$type:"WidgetCfg.tabIndex",$default
:0}}},RadioButtonCfg:{$type:"CheckBoxCfg",$description:"Configuration for a radio button",$properties:{bind:{$type:"CheckBoxCfg.bind",$properties:{keyValue:{$type:"common:BindingRef"}}},value:{$type:"CheckBoxCfg.value",$description:"Value associated to the widget representing the selected value",$default:""},keyValue:{$type:"json:String",$description:"Indicates the selected value",$default:""}}},TextInputCfg:{$type:"InputCfg",$description:"Base config for any text input widgets",$properties:{maxlength:{$type
:"json:Integer",$description:"Maximum number of characters to allow in the textinput - if negative, no maximum applies",$default:-1},helptext:{$type:"json:String",$description:"Text to be initially put in the text input in italics to help the user"},validationDelay:{$type:"json:Integer",$description:"The time period (in miliseconds) after which validation will be triggered on keydown event",$default:null},onchange:{$type:"common:Callback",$description:"Function to be called when the user changes the value from this widget"
},spellCheck:{$type:"json:Boolean",$description:"Specifies whether native spell check from the browser is enabled or not on this field. If null, uses the default behaviour from the browser. If true or false, tries to enable or disable native spell check from the browser."},autoselect:{$type:"json:Boolean",$description:"Specifies whether display text should be highlighted when the field gains focus."},bind:{$type:"InputCfg.bind",$properties:{prefill:{$type:"common:BindingRef"},prefillError:{$type:"common:BindingRef"
}}}}},TextFieldCfg:{$type:"TextInputCfg",$description:"The configuration for a text field",$properties:{}},TextareaCfg:{$type:"TextInputCfg",$description:"The configuration for a text field",$properties:{height:{$type:"json:Integer",$description:"Widget height in pixel. If negative, the height will be considered as unset and the widget will use the most appropriate height when possible",$default:-1}}},SortIndicatorCfg:{$type:"ActionWidgetCfg",$description:"The configuration for a sort list widget",$properties
:{view:{$type:"json:ObjectRef",$description:"Passes the view name that is to be applied when using Sort List",$classpath:"aria.templates.View"},sortKeyGetter:{$type:"json:FunctionRef",$description:"An anonymous function to pass the field by which we want to sort"},refreshArgs:{$type:"json:Array",$description:"Which section should the sort list refresh",$contentType:{$type:"templates:RefreshCfg"}},sortName:{$type:"json:String",$description:"Name of the current sort",$mandatory:!0},labelWidth:{$type:"json:Integer"
,$description:"Widget width in pixel - If negative, the width will be considered as unset and the widget will use the most appropriate width when possible",$default:-1},activateEllipsis:{$type:"json:Boolean",$description:"DEPRECATED. Ellipsis is now automatically activated if you specify a non-empty ellipsis parameter.",$default:!1},ellipsis:{$type:"json:String",$description:"What characters to use for ellipsis, by default this will be '...'"},ellipsisLocation:{$type:"json:Enum",$enumValues:["left","right"],
$description:"Which side will the ellipsis be, left or right",$default:"right"}}},PasswordFieldCfg:{$type:"TextInputCfg",$description:"The configuration for a text field",$properties:{}},DateFieldCfg:{$type:"TextInputCfg",$description:"The configuration for a text field",$properties:{pattern:{$type:"environmentBase:FormatTypes",$description:"Date pattern used to propose a best value for the date entry"},minValue:{$type:"json:Date",$description:"Minimum date for the value property."},maxValue:{$type:"json:Date"
,$description:"Maximum date for the value property."},referenceDate:{$type:"json:Date",$description:"Reference date from which value can be calculated."},bind:{$type:"TextInputCfg.bind",$properties:{referenceDate:{$type:"common:BindingRef"}}}}},TimeFieldCfg:{$type:"TextInputCfg",$description:"The configuration for a text field",$properties:{pattern:{$type:"environmentBase:FormatTypes",$description:"Time pattern used to generate a value for the time entry"}}},NumberFieldCfg:{$type:"TextInputCfg",$description:"The configuration for a text field"
,$properties:{pattern:{$type:"environmentBase:FormatTypes",$description:"Formatting pattern used to format number fields",$default:""}}},DropDownTextInputCfg:{$type:"TextInputCfg",$description:"The base configuration for any widget extending DropDownInput",$properties:{popupWidth:{$type:"json:Integer",$description:"Width of the dropdown popup in px - if negative, the width is computed dynamically.",$default:-1}}},DropDownInputCfg:{$type:"InputCfg",$description:"Configuration for widgets extending DropDownInput"
,$properties:{popupWidth:{$type:"json:Integer",$description:"Width of the dropdown popup in px - if negative, the width is computed dynamically.",$default:-1}}},ListItemCfg:{$type:"json:Object",$description:"Option structure",$restricted:!1,$properties:{value:{$type:"json:String",$description:"Internal value associated to the option - usually a language-independent code",$mandatory:!0},label:{$type:"json:String",$description:"Text to display to the user - must be in translated in user language",$mandatory:!0
}}},MultiSelectCfg:{$type:"DropDownTextInputCfg",$description:"The base configuration for any widget extending DropDownInput",$properties:{activateSort:{$type:"json:Boolean",$description:"Allows the developer to specify if the list of options should be sorted by labels",$default:!1},fieldSeparator:{$type:"json:String",$description:"Template to use to display the list.",$default:","},maxOptions:{$type:"json:Integer",$description:"Maximum number of options that can be selected at the same time.",$minValue:1},fieldDisplay
:{$type:"json:Enum",$description:"Whether to display code or value in the text input value.",$enumValues:["code","label"],$default:"label"},valueOrderedByClick:{$type:"json:Boolean",$description:"Whether to display the values in the order they were clicked.",$default:!0},instantBind:{$type:"json:Boolean",$description:"If true, the 'value' property is refreshed (and 'onchange' is triggered) each time user clicks on one of the options of a dropdown. Otherwise, it's refreshed after the dropdown is closed.",$default
:!1},listTemplate:{$type:"json:PackageName",$description:"Template to use to display the list.",$default:"aria.widgets.form.templates.TemplateMultiSelect"},items:{$type:"ListCfg.items",$description:"List of options on a MultiSelect"},numberOfColumns:{$type:"FormListCfg:numberOfColumns",$description:"Number of Columns used in the template"},numberOfRows:{$type:"FormListCfg:numberOfRows",$description:"Number of Rows used in the template"},displayOptions:{$type:"FormListCfg:displayOptions",$description:"Display options that are not interpreted by the list controller."
}}},DatePickerCfg:{$type:"DropDownTextInputCfg",$description:"Configuration of a DatePicker",$properties:{pattern:{$type:"environmentBase:FormatTypes",$description:"Date pattern used to propose a best value for the date entry in the date picker field."},inputPattern:{$type:"environmentBase:inputFormatTypes",$description:"Date pattern used to match user input and convert it in a Javascript valid date."},minValue:{$type:"json:Date",$description:"Minimum date for the value property."},maxValue:{$type:"json:Date"
,$description:"Maximum date for the value property."},referenceDate:{$type:"json:Date",$description:"Reference date from which value can be calculated."},calendarTemplate:{$type:"json:PackageName",$description:"Template to use to display the calendar."},calendarLabel:{$type:"json:String",$description:"Label to be displayed inside the calendar when the DatePicker is open."},calendarDisplayUnit:{$type:"json:Enum",$description:"Minimum time unit which must be displayed entirely in the calendar. May be either month (M) or week (W). The default template currently only supports month (M)."
,$enumValues:["M","W"]},calendarNumberOfUnits:{$type:"json:Integer",$description:"Number of display units to show at the same time in the calendar."},calendarFirstDayOfWeek:{$type:"json:Integer",$description:"First day of the week for the display of the calendar. 0 = Sunday, ... 6 = Saturday. The null value means that it is set according to the regional settings.",$minValue:0,$maxValue:6},calendarMonthLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each month in the calendar."
},calendarDayOfWeekLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each day of the week in the calendar."},calendarDateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each date in the calendar."},calendarCompleteDateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying complete dates in the calendar."},calendarShowWeekNumbers:{$type:"json:Boolean",$description:"Specifies whether week numbers should be displayed."
},calendarShowShortcuts:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed"},calendarRestrainedNavigation:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed"},calendarSclass:{$type:"json:String",$description:"sclass to be used for the calendar the calendar.",$default:"dropdown"},iconTooltip:{$type:"json:String",$description:"Tooltip label for the datepicker icon",$default:"Open the Calendar"},bind:{$type:"TextInputCfg.bind"
,$properties:{referenceDate:{$type:"common:BindingRef"}}}}},SelectBoxCfg:{$type:"DropDownTextInputCfg",$description:"Configuration of a SelectBox",$properties:{listTemplate:{$type:"json:PackageName",$description:"Template to use to display the list."},options:{$type:"json:Array",$description:"List of the possible values that have to be proposed to the user",$contentType:{$type:"ListItemCfg"},$default:[]},bind:{$type:"TextInputCfg.bind",$properties:{options:{$type:"common:BindingRef"}}}}},SelectCfg:{$type:"DropDownInputCfg"
,$description:"Configuration of a Select",$properties:{tabIndex:{$type:"WidgetCfg.tabIndex",$default:0},listTemplate:{$type:"json:PackageName",$description:"Template used for displaying the list."},options:{$type:"json:Array",$description:"List of the possible values displayed to the user",$contentType:{$type:"ListItemCfg"},$default:[]},onchange:{$type:"common:Callback",$description:"Function to be called when the state of the widget changes."},bind:{$type:"InputCfg.bind",$properties:{options:{$type:"common:BindingRef"
}}}}},AutoCompleteCfg:{$type:"DropDownTextInputCfg",$description:"Configuration of an AutoComplete",$properties:{autoFill:{$type:"json:Boolean",$description:"Autofill the autocomplete textfield on navigation in the suggestions",$default:!0},freeText:{$type:"json:Boolean",$description:"Specifies if the user can enter its own text",$default:!0},suggestionsTemplate:{$type:"json:PackageName",$description:"Template to use to display the list."},resourcesHandler:{$type:"json:MultiTypes",$description:"",$contentTypes
:[{$type:"json:PackageName",$description:"Classpath of the resources handler"},{$type:"json:ObjectRef",$description:"Instance of a resources handler"}],$mandatory:!0},preselect:{$type:"json:String",$description:"strict: for strict highlighting (exact match only), always: for selecting the first item everytime, none: for no highlighting",$default:"strict"},expandButton:{$type:"json:Boolean",$description:"Specifies if the button to get all the suggestions is displayed. Note that the getAllSuggestions method must be implemented on the resources handler for this feature to work (which is not the case for the default Air and Cities resources handlers)."
,$default:!1},popupMaxHeight:{$type:"json:Integer",$description:"Maximum height of the dropdown."}}},ActionWidgetCfg:{$type:"WidgetCfg",$description:"The base configuration for the button widget",$properties:{label:{$type:"json:String",$description:"Text to put inside the label in the button",$default:""},onclick:{$type:"common:Callback",$description:"Function to be called when the user clicks on the button."}}},ButtonCfg:{$type:"ActionWidgetCfg",$description:"The base configuration for the button widget",$properties
:{bind:{$type:"WidgetCfg.bind",$properties:{disabled:{$type:"common:BindingRef"}}},height:{$type:"json:Integer",$description:"The height of the button",$default:-1},disabled:{$type:"json:Boolean",$description:"A boolean whether the button is disabled or not",$default:!1},selected:{$type:"json:Boolean",$description:"DEPRECATED: A boolean whether the button is selected or not",$default:!1},tabIndex:{$type:"WidgetCfg.tabIndex",$default:0}}},TextCfg:{$type:"WidgetCfg",$description:"The base configuration for the Text widget"
,$properties:{bind:{$type:"WidgetCfg.bind",$properties:{text:{$type:"common:BindingRef"}}},text:{$type:"json:String",$description:"The text to be displayed",$default:""},activateEllipsis:{$type:"json:Boolean",$description:"DEPRECATED. Ellipsis is now automatically activated if you specify a non-empty ellipsis parameter.",$default:!1},ellipsis:{$type:"json:String",$description:"The string to be used as ellipsis"},ellipsisLocation:{$type:"json:Enum",$enumValues:["left","right"],$description:"Which side will the ellipsis be, left or right"
,$default:"right"}}},IconButtonCfg:{$type:"ButtonCfg",$description:"The base configuration for the icon button widget",$properties:{icon:{$type:"json:String",$description:"The name of the sprite and the icon that is to be used in the form sprite:icon",$default:null}}},LinkCfg:{$type:"ActionWidgetCfg",$description:"The base configuration for the link widget",$properties:{color:{$type:"json:String",$description:"The color of the text for the link"}}},SpriteCfg:{$type:"json:Object",$description:"Configuration needed when registering a new icon library"
,$properties:{name:{$type:"json:String",$description:"Name used to identify the icon lib that is being declared",$default:null},cssClass:{$type:"json:String",$description:"A css class that provides the sprite - either this or the spriteURL is needed",$default:""},spriteURL:{$type:"json:String",$description:"A URL to the sprite",$default:null},spriteSpacing:{$type:"json:Integer",$description:"The number of pixels between each icon in the sprite - constant for all icons in this sprite",$default:0},iconWidth:{$type
:"json:Integer",$description:"The width of each icon in the sprite in pixels - constant across all icons in this sprite",$default:-1},iconHeight:{$type:"json:Integer",$description:"The height of each icon in the sprite in pixels - constant across all icons in this sprite",$default:-1},biDimensional:{$type:"json:Boolean",$description:"This indicates whether the images are all in 1 line if false or in rows and columns if true",$default:!1},direction:{$type:"json:String",$description:"This can take two values x or y. It is used if the sprite is 1-dimensional, it corresponds to whether the icons are side-by-side (x), or one on top of another (y)"
,$default:"x"},content:{$type:"json:Map",$description:"This is the object that names each icon and gives a position",$contentType:{$type:"json:MultiTypes",$description:"",$contentTypes:[{$type:"json:Integer",$description:"A position in the sprite"},{$type:"json:String",$description:"A 2D position in the form x_y"}]}}}},IconCfg:{$type:"WidgetCfg",$description:"Configuaration needed to use an icon in a template",$properties:{icon:{$type:"json:String",$description:"The name of the sprite and the icon that is to be used in the form sprite:icon"
,$default:null}}},DivCfg:{$type:"ResizableWidgetCfg",$description:"The base configuration for the div widget",$properties:{cssClass:{$type:"json:String",$description:"A string to be used to inject a Class into the main content area",$default:""}}},TemplateCfg:{$type:"ResizableWidgetCfg",$description:"The configuration for the template widget, to display sub-templates.",$properties:{printOptions:{$type:"WidgetCfg.printOptions",$default:"adaptXY"},defaultTemplate:{$type:"json:PackageName",$description:"Classpath of the template to be displayed when no customization has been done."
,$mandatory:!0},data:{$type:"json:ObjectRef",$description:"JSON object to be made accessible in the sub-template as this.data. By default, use the parent template data, unless moduleCtrl is specified, in which case the data model of that module controller is used.",$mandatory:!1},moduleCtrl:{$type:"templates:ModuleCtrl",$description:"Module controller to be used with the sub-template. By default, use the parent template module controller, unless data is specified and is the data model of one of the sub-modules of the parent template module controller, in which case that sub-module is used."
,$mandatory:!1},args:{$type:"json:Array",$description:"Parameters to pass to the main macro in the sub-template.",$contentType:{$type:"json:MultiTypes",$description:"Any parameter to be passed to the main macro in the sub-template."},$default:[]},baseTabIndex:{$type:"json:Integer",$description:"The base tab index that will be added to all tab indexes in the template",$default:0}}},TooltipCfg:{$type:"ResizableWidgetCfg",$description:"",$properties:{id:{$type:"WidgetCfg.id",$mandatory:!0},macro:{$type:"templates:MacroCfg"
,$description:"Macro to call to get the tooltip content. The Tooltip widget can either be used as a container, in which case this property must not be specified and the content of the tooltip is the content of the widget, or be used as a simple widget with no content, in which case this property must specify which macro to call to get the content of the tooltip.",$mandatory:!1},sclass:{$type:"WidgetCfg.sclass",$default:"tooltip"},showOnlyOnMouseStill:{$type:"json:Boolean",$description:"",$default:!0},showDelay
:{$type:"json:Integer",$description:"Delay before the tooltip is shown.",$default:100},closeOnMouseClick:{$type:"json:Boolean",$description:"Close the tooltip when the user clicks outside of the tooltip",$default:!0},closeOnMouseOut:{$type:"json:Boolean",$description:"Close the tooltip when the user leaves the tooltip, after a delay, set in closeOnMouseOutDelay",$default:!0},closeOnMouseOutDelay:{$type:"json:Integer",$description:"Delay before closing the tooltip when the user leaves the tooltip",$default:100
},closeOnMouseScroll:{$type:"json:Boolean",$description:"Close the tooltip when the user scrolls outside of the popup",$default:!0}}},ErrorListCfg:{$type:"ResizableWidgetCfg",$description:"Configuration for the ErrorList widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{messages:{$type:"common:BindingRef"}}},defaultTemplate:{$type:"json:String",$description:"Template used to display the messages list.",$default:"aria.widgets.errorlist.ErrorListTemplate"},messages:{$type:"json:ObjectRef",$description
:"Messages list (of type aria.validators.CfgBeans.MessagesList) to be displayed in the widget.",$default:[]},displayCodes:{$type:"json:Boolean",$description:"True if message codes should be displayed along with localized messages.",$default:!0},title:{$type:"json:String",$description:"Title to be displayed in the widget.",$default:""},filterTypes:{$type:"json:Array",$description:"If not null, specifies the types of messages which should be displayed in the widget. It must match the type property in aria.utils.validators.CfgBeans.Message."
,$default:null,$contentType:{$type:"json:String",$description:"Type of message.",$mandatory:!0},$sample:["F","E"]},block:{$type:"ResizableWidgetCfg.block",$default:!0}}},CalendarCfg:{$type:"ResizableWidgetCfg",$description:"Configuration for the Calendar widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{value:{$type:"common:BindingRef"},startDate:{$type:"common:BindingRef"}}},tabIndex:{$type:"WidgetCfg.tabIndex",$default:0},label:{$type:"json:String",$description:"Label text to associate to the calendar."
},showWeekNumbers:{$type:"json:Boolean",$description:"Specifies whether week numbers should be displayed.",$default:!0},defaultTemplate:{$type:"json:PackageName",$description:"Template to use to display the calendar."},onclick:{$type:"common:Callback",$description:"Function to be called when the user clicks on a date in the calendar, before it is actually selected."},onchange:{$type:"common:Callback",$description:"Function to be called when the selected date in the calendar changes because of user action (click or keyboard selection)."
},value:{$type:"json:Date",$description:"Date currently selected in the calendar."},minValue:{$type:"json:Date",$description:"Minimum date for the value property."},maxValue:{$type:"json:Date",$description:"Maximum date for the value property."},displayUnit:{$type:"json:Enum",$description:"Minimum time unit which must be displayed entirely in the calendar. May be either month (M) or week (W). The default template currently only supports month (M).",$enumValues:["M","W"]},numberOfUnits:{$type:"json:Integer",$description
:"Number of display units to show at the same time.",$default:3},startDate:{$type:"json:Date",$description:"Approximate first date in the currently displayed calendar. However, as the calendar may have a display with whole weeks or whole months, dates before this date may also appear."},firstDayOfWeek:{$type:"json:Integer",$description:"First day of the week. 0 = Sunday, ... 6 = Saturday. The null value means that it is set according to the regional settings.",$minValue:0,$maxValue:6},monthLabelFormat:{$type
:"json:String",$description:"Date pattern to be used when displaying each month."},dayOfWeekLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each day of the week."},dateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each date in the calendar."},completeDateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying complete dates."},showShortcuts:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed"
,$default:!0},restrainedNavigation:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed",$default:!0}}},ListCfg:{$type:"ResizableWidgetCfg",$description:"Configuration for the List widget. ",$properties:{tabIndex:{$type:"WidgetCfg.tabIndex",$default:0},defaultTemplate:{$type:"json:PackageName",$description:"Template to use to display the list.",$default:"aria.widgets.form.list.templates.ListTemplate"},preselect:{$type:"json:String",$description:"strict: for strict highlighting (exact match only), always: for selecting the first item everytime, none: for no highlighting"
,$default:"strict"},items:{$type:"json:MultiTypes",$description:"The possible choices in the list.",$contentTypes:[{$type:"json:Array",$description:"value/label pairs",$contentType:{$type:"json:Object",$description:"Label/value pairs",$properties:{label:{$type:"json:String",$description:"The string to show"},value:{$type:"json:MultiTypes",$description:"The value of the item"}}}},{$type:"json:Object",$description:"Container reference with Label/value property names",$properties:{container:{$type:"json:Object"
,$description:"The container to take the items from",$default:{}},labelProperty:{$type:"json:String",$description:"The name of the property containing the label",$default:""},valueProperty:{$type:"json:String",$description:"The name of the property containing the value",$default:""}}}]},selectedValues:{$type:"json:Array",$description:"Values of currently selected items.",$default:[],$contentType:{$type:"json:MultiTypes",$description:"Same type as the key for the items"}},selectedIndex:{$type:"json:Integer",$description
:"Index of the selected element in the list, if only one is or should be selected. -1 means no element is selected. A null value means several elements are selected."},maxOptions:{$type:"json:Integer",$description:"Maximum number of options that can be selected at the same time. It is only taken into account if multipleSelect is true. A null value means there is no maximum.",$minValue:1},multipleSelect:{$type:"json:Boolean",$description:"This must be set to true if several items can be selected at the same time."
,$default:!1},activateSort:{$type:"json:Boolean",$description:"Allows the developer to specify if the list of options should be sorted by labels",$default:!1},disabled:{$type:"json:Boolean",$description:"true if input is disabled",$default:!1},onclick:{$type:"common:Callback",$description:"Function to be called when the user clicks on an element in the list, before it is actually selected."},onchange:{$type:"common:Callback",$description:"Function to be called when the state of the widget changes due to user action (click or keyboard)."
},onkeyevent:{$type:"common:Callback",$description:"Function to be called when a key event occurs."},onmouseover:{$type:"common:Callback",$description:"Function to be called when the user moves the mouse over an item in the list."},bind:{$type:"WidgetCfg.bind",$properties:{selectedValues:{$type:"common:BindingRef"},selectedIndex:{$type:"common:BindingRef"},items:{$type:"common:BindingRef"},disabled:{$type:"common:BindingRef"},multipleSelect:{$type:"common:BindingRef"},maxOptions:{$type:"common:BindingRef"}}}
,displayOptions:{$type:"FormListCfg:displayOptions",$description:"This is a configuration object that is used by the multi-select"},numberOfColumns:{$type:"FormListCfg:numberOfColumns",$description:"Number of Columns used by the multi-select List. This property can be applied only with multi-select List"},numberOfRows:{$type:"FormListCfg:numberOfRows",$description:"Number of Rows used by the multi-select List. This property can be applied only with multi-select List"},onclose:{$type:"common:Callback",$description
:"Function to be called when the user triggers the close event of the List"}}},DialogCfg:{$type:"DivCfg",$description:"The base configuration for the Dialog widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{visible:{$type:"common:BindingRef"},contentMacro:{$type:"common:BindingRef"},title:{$type:"common:BindingRef"},xpos:{$type:"common:BindingRef"},ypos:{$type:"common:BindingRef"},center:{$type:"common:BindingRef"}}},title:{$type:"json:String",$description:"The title of the dialog which will be displayed in the header"
,$default:""},visible:{$type:"json:Boolean",$description:"A boolean whether the dialog is visible",$default:!1},contentMacro:{$type:"templates:MacroCfg",$description:"The macro that will be used as dialog content, Browser will freeze if it does not find this property  as part of widget or bindable property"},icon:{$type:"json:String",$description:"Icon to use in the title bar (same as the icon property of the Icon widget)"},modal:{$type:"json:Boolean",$description:"Whether the dialog box is modal. If it is modal, a mask is shown behind the dialog box so that mouse and keyboard interraction with elements behind the dialog box is not possible."
,$default:!1},closable:{$type:"json:Boolean",$description:"Whether the dialog has a close button in its title bar.",$default:!0},closeOnMouseClick:{$type:"json:Boolean",$description:"Close the dialog when the user clicks outside of it",$default:!1},center:{$type:"json:Boolean",$description:"If true, the dialog is always centered in the browser window. Takes priority over xpos and ypos. However, if the dialog box is movable and the user manually moves it, the centered behavior will be switched off.",$default:!0
},xpos:{$type:"json:Integer",$description:"x position of the top left corner of the dialog box.",$default:0},ypos:{$type:"json:Integer",$description:"y position of the top left corner of the dialog box.",$default:0},movable:{$type:"json:Boolean",$description:"If true, the dialog can be moved. The default is read from the application environment."},resizable:{$type:"json:Boolean",$description:"If true, the dialog can be resizable. The default is false.",$default:!1},movableProxy:{$type:"dragDrop:ProxyCfg",$description
:"Specifies the type of proxy dor the dialog motion. The default is read from the application environment."},onOpen:{$type:"common:Callback",$description:"Callback called when the dialog is open, right after it is displayed. Can be used to set the focus on the right element in the dialog."},onCloseClick:{$type:"common:Callback",$description:"Callback called when the close button is clicked. If not specified, the dialog will simply be closed when clicking on the close button. If specified, the dialog will only be closed if the callback either sets the visible property of the Dialog to false (through bindings) or sets to false the cancelDefault property of its first parameter. This allows the developper to give the same callback method to both the onCloseClick property of the dialog and the onclick property of a close button inside the dialog."
},ondragstart:{$type:"common:Callback",$description:"Callback called after the dialog starts to be dragged."},ondragend:{$type:"common:Callback",$description:"Callback called after the dialog movement ends."},beforeresize:{$type:"common:Callback",$description:"Callback called after the dialog starts to be resized."},resizeend:{$type:"common:Callback",$description:"Callback called after the dialog resizing ends."}}},FieldsetCfg:{$type:"ResizableWidgetCfg",$description:"The base configuration for the Fieldset widget"
,$properties:{onSubmit:{$type:"common:Callback",$description:"Callback function called when the user presses ENTER in a field inside the fieldset."},label:{$type:"json:String",$description:"Text to put on the fieldset to describe its content."}}},TabCfg:{$type:"ContainerCfg",$description:"The base configuration for the Tab widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{selectedTab:{$type:"common:BindingRef"}}},tabId:{$type:"json:String",$description:"The id of the tab",$mandatory:!0},disabled
:{$type:"json:Boolean",$description:"A boolean whether the tab is disabled",$default:!1},selectedTab:{$type:"json:String",$description:"The id of the currently selected tab"}}},TabPanelCfg:{$type:"ContainerCfg",$description:"The base configuration for the Tab widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{selectedTab:{$type:"common:BindingRef"}}},selectedTab:{$type:"json:String",$description:"The id of the currently selected tab"},macro:{$type:"templates:MacroCfg",$description:"Macro to call to display the content of the TabPanel"
,$mandatory:!1},block:{$type:"WidgetCfg.block",$default:!0}}},GaugeCfg:{$type:"WidgetCfg",$description:"The base configuration for the Gauge widget",$properties:{bind:{$type:"WidgetCfg.bind",$properties:{label:{$type:"common:BindingRef"},currentValue:{$type:"common:BindingRef"},maxValue:{$type:"common:BindingRef"}}},label:{$type:"json:String",$description:"The label to be displayed in the gauge",$default:""},labelWidth:{$type:"json:Integer",$description:"Width of the label container in px - if negative, the value is considered as unset."
,$default:-1},labelAlign:{$type:"json:Enum",$description:"Alignment of the label",$enumValues:["left","right","center"],$default:"center"},gaugeWidth:{$type:"json:Integer",$description:"The width of the gauge",$default:150},minValue:{$type:"json:Integer",$description:"The min value of the gauge",$default:0},maxValue:{$type:"json:Integer",$description:"The max value of the gauge",$default:100},currentValue:{$type:"json:Integer",$description:"The current value of the gauge",$default:0}}},SplitterCfg:{$type:"ResizableWidgetCfg"
,$description:"Base config for any Splitter widget",$properties:{macro1:{$type:"templates:MacroCfg",$description:"Defines the macro for first panel.",$mandatory:!0},macro2:{$type:"templates:MacroCfg",$description:"Defines the macro for second panel.",$mandatory:!0},size1:{$type:"json:Integer",$description:"Defines the size of the first panel in pixels"},size2:{$type:"json:Integer",$description:"Defines the size of the second panel in pixels"},height:{$type:"ResizableWidgetCfg.height",$mandatory:!0},width:{$type
:"ResizableWidgetCfg.width",$mandatory:!0},adapt:{$type:"json:Enum",$enumValues:["size1","size2","both"],$description:"Size adapted when the size of the splitter is different than the sum of size1 and size2",$default:"both"},orientation:{$type:"json:Enum",$enumValues:["horizontal"],$description:"Defines the position horizontal or vertical for the splitter (vertical is not supported yet)",$default:"horizontal"},border:{$type:"json:Boolean",$description:"This determines whether a border should be shown around the splitter"
,$default:!0},bind:{$type:"WidgetCfg.bind",$properties:{size1:{$type:"common:BindingRef"},size2:{$type:"common:BindingRef"}}}}}}});
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.Icon",$extends:"aria.widgets.Widget",$dependencies:["aria.utils.Dom"],$css:["aria.widgets.IconStyle"],$constructor:function(e,t){this.$Widget.constructor.apply(this,arguments),this._iconInfo=null,this._cssClassNames="xWidget"},$statics:{ERROR_ICON:null,ERROR_ICON_TITLE:"Icon % not found",ICON_BADLY_FORMATTED:"%1Icon name is not valid: %2",ICON_NOT_FOUND:"%1Icon was not found: %2"},$prototype:{writeMarkup:function(e){var t=this._cfg,n=this._domId,r=t.tooltip,i;i=
this._getIconInfo(t.icon),i||(r=this.ERROR_ICON_TITLE.replace("%",t.icon),i=this._getErrIcon()),this._cfgOk&&(r!=null&&r!==""?r='title="'+r+'" ':r="",e.write(['<span id="',n,'" class="',this._getIconClasses(i),'" ',r,'style="',this._getIconStyle(i),'"></span>'].join("")),this._iconInfo=i),this._domReady=!0},changeIcon:function(e){if(!this._iconInfo)return;var t=this._getIconInfo(e);if(t){var n=this.getDom();n.style.cssText=this._getIconStyle(t),n.className=this._getIconClasses(t)}this._iconInfo=t},getCurrentIconInfo
:function(){return this._iconInfo},_getIconInfo:function(e){var t=e.split(":");if(t.length!==2)return this.$logError(this.ICON_BADLY_FORMATTED,[e]),null;var n=aria.widgets.AriaSkinInterface.getIcon(t[0],t[1]);return n?n:(this.$logError(this.ICON_NOT_FOUND,[e]),null)},_getIconStyle:function(e){var t=this._cfg,n=e.verticalAlign?"vertical-align: "+e.verticalAlign:"",r="margin: 0 0 0 0 ";if(t.margins!=null&&t.margins.match(/^(\d+|x) (\d+|x) (\d+|x) (\d+|x)$/)){var i=t.margins.split(" ");r=["margin:",i[0],"px ",i
[1],"px ",i[2],"px ",i[3],"px; "].join("")}else e.margins!=null&&(r=e.margins);return[r,";padding:0;background-position:-",e.iconLeft,"px -",e.iconTop,"px;width:",e.width,"px;height:",e.height,"px;",n].join("")},_getIconClasses:function(e){var t=this._cfg,n=aria.core.TplClassLoader.addPrintOptions(this._cssClassNames,t.printOptions);return e.cssClass&&(n+=" "+e.cssClass),t.block&&(n+=" xBlock"),n},_getErrIcon:function(){return this.ERROR_ICON||(aria.widgets.Icon.prototype.ERROR_ICON=aria.widgets.AriaSkinInterface
.getIcon("std","missing")),this.ERROR_ICON}}});
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.Template",$extends:"aria.widgets.container.Container",$dependencies:["aria.templates.TemplateTrait","aria.templates.TemplateCtxt","aria.utils.Dom","aria.templates.CfgBeans","aria.templates.ModuleCtrlFactory","aria.core.environment.Customizations"],$events:{ElementReady:{description:"Raised when the template content is fully displayed."}},$constructor:function(e,t){aria.widgets.Template.superclass.constructor.apply(this,arguments),e.width!=-1&&(this._cssClassNames+=" xOverflowXAuto"
),e.height!=-1&&(this._cssClassNames+=" xOverflowYAuto"),this._defaultMargin=0,this._subTplDiv=null,this.subTplCtxt=null,this._needCreatingModuleCtrl=e.moduleCtrl&&e.moduleCtrl.getData==null,this._tplcfg={classpath:aria.core.environment.Customizations.getTemplateCP(e.defaultTemplate),args:e.args,id:this._domId,originalId:this.getId()},this.tplLoadCallback=null},$destructor:function(){this.removeDelegation(),this._subTplDiv=null,this.subTplCtxt&&(this.subTplCtxt.$dispose(),this.subTplCtxt=null),this.tplLoadCallback=
null,this._deleteTplcfg(),aria.widgets.Template.superclass.$destructor.call(this)},$prototype:{$init:function(e){var t=aria.templates.TemplateTrait.prototype;for(var n in t)t.hasOwnProperty(n)&&!e.hasOwnProperty(n)&&(e[n]=t[n])},_directInit:!0,_deleteTplcfg:function(){if(this._tplcfg){var e=this._tplcfg,t=e.toDispose;if(t){var n=t.length;for(var r=0;r<n;r++)t[r].$dispose()}e.toDispose=null,e.tplDiv=null,e.div=null,e.data=null,this._tplcfg=null}},_errorWhileLoadingTemplate:function(){var e=this._subTplDiv;e&&
(e.className="xTplContent",aria.utils.Dom.replaceHTML(e,"#ERROR WHILE LOADING TEMPLATE#")),this._deleteTplcfg(),this.$callback(this.tplLoadCallback,{success:!1})},_checkCfgConsistency:function(){var e=this._tplcfg,t=this._cfg;if(this._needCreatingModuleCtrl){if(!aria.core.JsonValidator.normalize({json:t.moduleCtrl,beanName:"aria.templates.CfgBeans.InitModuleCtrl"})){this._cfgOk=!1;return}}else e.moduleCtrl=t.moduleCtrl;t.width>-1&&(e.width=t.width),t.height>-1&&(e.height=t.height),e.printOptions=t.printOptions
,e.baseTabIndex=t.baseTabIndex},_onTplLoad:function(e,t){var n=this._tplcfg;if(!n){t.autoDispose&&e.moduleCtrlPrivate.$dispose();return}var r=this._subTplDiv;n.tplDiv=r,n.div=this._domElt,n.data=this._cfg.data,e.moduleCtrl&&(n.moduleCtrl=e.moduleCtrl),n.isRootTemplate=!1,n.context=this._context,t.autoDispose&&(n.toDispose==null?n.toDispose=[e.moduleCtrlPrivate]:n.toDispose.push(e.moduleCtrlPrivate));var i=new aria.templates.TemplateCtxt;this.subTplCtxt=i,i.parent=this._context;var e=i.initTemplate(n);e?(i.dataReady
(),r&&i._cfg&&(r.className=i.getCSSClassNames(),i.$onOnce({Ready:this.__innerTplReadyCb,SectionRefreshed:{fn:this.__innerTpl1stRefreshed,args:{success:!0,templateCtxt:i},scope:this},scope:this}),i.$refresh()),this.tplcfg=null):(i.$dispose(),this.subTplCtxt=null,this._errorWhileLoadingTemplate()),r=null},__innerTpl1stRefreshed:function(e,t){this.$callback(this.tplLoadCallback,t)},_init:function(){aria.widgets.Template.superclass._init.call(this);var e=aria.utils.Dom.getDomElementChild(this._domElt,0);this._subTplDiv=
e;var t=this.subTplCtxt;t&&(t.linkToPreviousMarkup(e),this.$callback(this.tplLoadCallback,{success:!0,templateCtxt:t}),t.viewReady()),this.isDiffered||(this.isDiffered=t&&!t._ready,this.isDiffered&&t.$on({Ready:{fn:this.__differedComplete,scope:this}}))},_widgetMarkup:function(e){var t=this._tplcfg;Aria.load({templates:[t.classpath],classes:this._needCreatingModuleCtrl?[this._cfg.moduleCtrl.classpath]:null,oncomplete:{scope:this,fn:this._onModuleCtrlLoad}});var n=this.subTplCtxt,r;n?(e.write('<div class="'+n
.getCSSClassNames()+'">'),r=n.getMarkup(),r!=null?e.write(r):e.write("#ERROR IN SUBTEMPLATE#"),e.write("</div>")):this._tplcfg?(e.write('<div class="xLDI"></div>'),this.isDiffered=!0):e.write("<div>#ERROR IN SUBTEMPLATE#</div>")},getDomElt:function(){return this._domElt},__differedComplete:function(){this.isDiffered=!1,this.$raiseEvent("ElementReady")}}});
//*******************
//LOGICAL-PATH:aria/widgets/TemplateBasedWidget.js
//*******************
Aria.classDefinition({$classpath:"aria.widgets.TemplateBasedWidget",$extends:"aria.widgets.container.Container",$dependencies:["aria.widgets.Template"],$events:{widgetContentReady:{description:"Raised when the template content is displayed."}},$destructor:function(){this._subTplModuleCtrl&&(this._subTplModuleCtrl.$unregisterListeners(this),this._subTplModuleCtrl=null),this._subTplCtxt=null,this._subTplData=null,this._tplWidget&&(this._tplWidget.$dispose(),this._tplWidget=null),aria.widgets.TemplateBasedWidget
.superclass.$destructor.call(this)},$prototype:{__inherithCfg:["tooltip","tooltipId","tabIndex","margins","block","printOptions"],_initTemplate:function(e){if(this._cfgOk){var t=this._cfg;for(var n=0,r=this.__inherithCfg.length;n<r;n+=1){var i=this.__inherithCfg[n];e.hasOwnProperty(i)||(e[i]=t[i])}t.defaultTemplate&&(e.defaultTemplate=t.defaultTemplate),t.id&&(e.id=t.id+"_t_"),this._tplWidget=new aria.widgets.Template(e,this._context,this._lineNumber),this._tplWidget.tplLoadCallback={fn:this._tplLoadCallback
,scope:this}}},_onModuleEvent:function(e){},_tplLoadCallback:function(e){e.success&&(this._subTplCtxt=e.templateCtxt,this._subTplModuleCtrl=e.templateCtxt.moduleCtrl,this._subTplData=this._subTplCtxt.data,this._subTplModuleCtrl&&this._subTplModuleCtrl.$on({"*":this._onModuleEvent,scope:this}),this._registerBindings(),this._tplWidget&&(this.initWidgetDom(this._tplWidget.getDom()),this.$raiseEvent("widgetContentReady")))},writeMarkup:function(e){if(!this._cfgOk)return aria.widgets.TemplateBasedWidget.superclass
.writeMarkup.call(this,e);this._tplWidget._delegateId=aria.utils.Delegate.add({fn:this.delegate,scope:this}),this._tplWidget.writeMarkup(e),this._domReady=!0},initWidget:function(){if(!this._cfgOk)return;this._tplWidget.initWidget()}}});
//*******************
...
,verticalAlignTester:/^[%a-z0-9-]*$/},$prototype:{_cfgPackage:"aria.widgets.CfgBeans",_cfgBean:null,_directInit:!1,$init:function(e,t,n){e.bindableProperties=["tooltip"]},writeMarkup:function(e){this._cfgOk?(this._hasMarkup&&this.__markupBegin(e),this._widgetMarkup(e),this._hasMarkup&&this.__markupEnd(e),this._domReady=!0):e.write('#ERROR#<span style="font-size:x-small"><br/>Widget: '+this.$classpath+"<br/>Tpl:"+this._context.tplClasspath+"<br/>Line: "+this._lineNumber+"</span>")},writeMarkupBegin:function(e
){this._cfgOk?(this._hasMarkup&&this.__markupBegin(e),this._widgetMarkupBegin(e)):e.write('#ERROR - Begin#<span style:"font-size:x-small"><br/>Widget: '+this.$classpath+"<br/>Tpl:"+this._context.tplClasspath+"<br/>Line: "+this._lineNumber+"</span>")},writeMarkupEnd:function(e){this._cfgOk?(this._widgetMarkupEnd(e),this._hasMarkup&&this.__markupEnd(e),this._domReady=!0):e.write("#ERROR - End#")},getId:function(){return this._cfg.id},__markupEnd:function(e){e.write("</span>")},__markupBegin:function(t){var n=this
._cfg,r=aria.core.TplClassLoader.addPrintOptions(this._cssClassNames,n.printOptions);n.block&&(r+=" xBlock"),this._checkCfgConsistency(),t.write('<span id="'+this._domId+'" '),this._delegateId||(this._delegateId=e.add({fn:this.delegate,scope:this})),t.write(e.getMarkup(this._delegateId)+" "),t.write('class="'+r+'" '),t.write('style="'),this._spanStyle!=null&&t.write(this._spanStyle),n.width>-1&&t.write("width:"+n.width+"px;"),n.height!=null&&n.height!=-1&&t.write("height:"+n.height+"px;"),n.verticalAlign!=null&&
(this.verticalAlignTester.test(n.verticalAlign)?t.write("vertical-align:"+n.verticalAlign+";"):this.$logError(this.INVALID_VERTICAL_ALIGN,[n.verticalAlign]));if(n.margins!=null&&n.margins.match(/^(\d+|x) (\d+|x) (\d+|x) (\d+|x)$/)){var i=n.margins.split(" ");t.write(["margin:",i[0]==="x"?this._defaultMargin:i[0],"px ",i[1]==="x"?this._defaultMargin:i[1],"px ",i[2]==="x"?this._defaultMargin:i[2],"px ",i[3]==="x"?this._defaultMargin:i[3],'px;" '].join(""))}else t.write("margin:"+this._defaultMargin+'px;" ');n.
tooltip&&t.write('title="'+n.tooltip+'" ');if(n.tabIndex!=null&&!this._customTabIndexProvided&&!n.disabled){var s=this._calculateTabIndex();t.write('tabindex="'+s+'" ')}t.write(">")},_calculateTabIndex:function(){var e=-1;return this._context&&this._context._cfg&&this._context._cfg.baseTabIndex>=0&&(this._cfg.tabIndex>0?e=this._context._cfg.baseTabIndex+this._cfg.tabIndex:e=this._cfg.tabIndex),e},_widgetMarkup:function(e){},_widgetMarkupBegin:function(e){},_widgetMarkupEnd:function(e){},_checkCfgConsistency:
function(){},_linkToTooltipWidget:function(){var e=this._cfg.tooltipId;if(!e)return;var t=this._context.getBehaviorById(e);if(!t){this.$logError(this.WIDGET_TOOLTIP_NOT_FOUND,[e,this.$class,this._context.tplClasspath]);return}this._tooltipWidget=t},_dom_onmousemove:function(e){this._tooltipWidget&&(this._tooltipWidget.associatedWidgetMouseMove(this,e),e.$dispose())},_dom_onmouseover:function(e){this._tooltipWidget&&(this._tooltipWidget.associatedWidgetMouseOver(this,e),e.$dispose())},_dom_onmouseout:function(
e){this._tooltipWidget&&(this._tooltipWidget.associatedWidgetMouseOut(this,e),e.$dispose())},initWidget:function(){this._linkToTooltipWidget(),this._registerBindings(),this._directInit&&this._hasMarkup&&this.initWidgetDom()},initWidgetDom:function(e){this._initDone=!0,e||(e=aria.utils.Dom.getElementById(this._domId),e||this.$logError(this.WIDGET_NOT_FOUND,[this._domId,this.$class])),e.__widget=this,this._domElt=e,this._init()},_init:function(){},setProperty:function(e,n){var r;if(!this._cfg)return null;var i=
this._cfg.bind,s=this.getProperty(e);this._cfg[e]=n;if(i){var o=i[e];if(o){var u=o.inside,a=o.to,f=o.transform;if(u&&(a||a===0)){r=this._transform(f,n,"fromWidget");var l=this._bindingListeners[e];t.setValue(u,a,r,l?l.cb:null)}}}if(s!==n)return{oldValue:s,newValue:n}},setWidgetProperty:function(e,t){if(!this._cfg)return;var n=this.getProperty(e);t!=n&&(this._cfg[e]=t,this._onBoundPropertyChange(e,t,n))},changeProperty:function(e,t){if(!this._cfg)return;this.setWidgetProperty(e,t),this.setProperty(e,t)},getProperty
:function(e){return this._cfg?this._cfg[e]:null},_notifyDataChange:function(e,t){if(!this._cfg)return;var n=this._cfg.bind[t],r=this._transform(n.transform,n.inside[n.to],"toWidget");aria.templates.RefreshManager.isStopped()?(this._refreshMap||(aria.templates.RefreshManager.queue({fn:this._notifyDataChangeCB,scope:this},this),this._refreshMap={}),this._refreshMap[t]=r):this.setWidgetProperty(t,r)},_notifyDataChangeCB:function(){var e=this._refreshMap;if(!e)return;this._refreshMap=null;for(var t in e)e.hasOwnProperty
(t)&&this.setWidgetProperty(t,e[t])},_onBoundPropertyChange:function(e,t,n){var r=this.getDom();e=="tooltip"&&(r.title=t);if(e=="disabled"){var i=r.tabIndex!=null;t&&i&&r.removeAttribute("tabindex",0);if(!t&&!i){var s=this.getProperty("tabIndex");s&&(r.tabIndex=s)}}},delegate:function(e){var t=e.delegateTarget;if(!this._cfg.disabled&&!this._cfg.readOnly){this._initDone||(e.type=="contentchange"&&(this.__initWhileContentChange=!0),this.initWidgetDom(t));var n="_dom_on"+e.type;return this[n]?this[n](e)!==!1:!0
}},getDom:function(){return!this._domElt&&this._domReady&&this.initWidgetDom(),this._domElt},removeDelegation:function(){this._delegateId&&(e.remove(this._delegateId),delete this._delegateId)}}})})();
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.environment.WidgetSettingsCfgBeans",$namespaces:{json:"aria.core.JsonTypes",dragDrop:"aria.utils.dragdrop.DragDropBean"},$description:"",$beans:{AppCfg:{$type:"json:Object",$description:"",$restricted:!1,$properties:{widgetSettings:{$type:"WidgetSettingsCfg",$description:"Default widget settings for the application",$default:{}},defaultWidgetLib:{$type:"json:String",$description:"Deprecated. There is no longer a single default library. Please use defaultWidgetLibs instead (defined in aria.widgetLibs.environment.WidgetLibsSettingsCfgBeans.AppCfg)."
}}},WidgetSettingsCfg:{$type:"json:Object",$description:"Global settings for widgets",$properties:{directOnBlurValidation:{$type:"json:Boolean",$description:"Whether validation on input widgets is automatically called by default on blur.",$default:!0},autoselect:{$type:"json:Boolean",$description:"Specifies whether display text should be highlighted when the field is clicked.",$default:!1},middleAlignment:{$type:"json:Boolean",$description:"Specifies whether the widgets should be middle-aligned vertically.",
$default:!0},dialog:{$type:"json:Object",$description:"Default values for Dialog widget configuration.",$properties:{movable:{$type:"json:Boolean",$description:"If true, the dialog can be moved.",$default:!1},movableProxy:{$type:"dragDrop:ProxyCfg",$description:"Specifies the type of proxy dor the dialog motion."}},$default:{}}}}}});
//*******************
...
),this._simpleHTML=aria.widgets.AriaSkinInterface.getSkinObject(this._skinnableClass,e.sclass).simpleHTML,this._simpleHTML||(this._frame=aria.widgets.frames.FrameFactory.createFrame({height:e.height,width:e.width,state:this._state,sclass:e.sclass,skinnableClass:this._skinnableClass,"oldStuff:cssRoot":"BTN",scrollBarX:!1,scrollBarY:!1}))},$destructor:function(){this.currTarget=null,this._frame&&(this._frame.$dispose(),this._frame=null),this.$ActionWidget.$destructor.call(this)},$prototype:{$init:function(e,t,
n){e.bindableProperties=e.bindableProperties.concat(["disabled"])},_updateState:function(e){var t="normal",n=this._cfg;n.disabled?t="disabled":this._mousePressed&&this._mouseOver||this._keyPressed?t="msdown":this._mouseOver&&(t="msover"),this._state=t,e||(this.getDom(),this._simpleHTML?t=="disabled"?this._focusElt.setAttribute("disabled","disabled"):this._focusElt.removeAttribute("disabled"):(this._frame.changeState(this._state),this._focusElt.className=t=="disabled"?"xButton xButtonDisabled":"xButton"))},_onBoundPropertyChange
:function(e,t,n){this.$ActionWidget._onBoundPropertyChange.apply(this,arguments);var r=!1;e==="disabled"&&(r=!0,this._isDisabled=!!t),r&&(this._cfg[e]=t,this._updateState())},_initActionWidget:function(e){this._simpleHTML||this._frame.linkToDom(aria.utils.Dom.getDomElementChild(e,0)),this._focusElt=e},_widgetMarkup:function(e){var t=this._cfg,n=t.tabIndex!=null?' tabindex="'+this._calculateTabIndex()+'" ':"",r=aria.core.Browser.isIE7||aria.core.Browser.isIE6,i=Aria.testMode?' id="'+this._domId+'_button" ':""
,s=t.disabled?"xButton xButtonDisabled":"xButton";if(this._simpleHTML){var o=t.disabled?" disabled='disabled' ":"",u=t.width!="-1"?" style='width:"+t.width+"px;' ":"";e.write(['<input type="button" value="',aria.utils.String.encodeForQuotedHTMLAttribute(t.label),'"',i,n,o,u,"/>"].join(""))}else{if(r)e.write(['<span class="'+s+'" style="margin: 0;"',n,i,">"].join(""));else{var a=aria.core.Browser.isIE?" onfocusin='this.blur()' ":"";e.write(['<button type="button" class="'+s+'"',a,n,i,">"].join(""))}this._frame
.writeMarkupBegin(e),this._widgetMarkupContent(e),this._frame.writeMarkupEnd(e),r?e.write("</span>"):e.write("</button>")}},_widgetMarkupContent:function(e){e.write(aria.utils.String.escapeHTML(this._cfg.label))},_dom_onmouseover:function(e){this.$ActionWidget._dom_onmouseover.call(this,e),this._mouseOver=!0,this._updateState()},_dom_onmouseout:function(e){this.$ActionWidget._dom_onmouseout.call(this,e),this._mouseOver=!1,this._mousePressed=!1,this._updateState()},_dom_onmousedown:function(e){this.focus(),this
._mouseOver=!0,this._mousePressed=!0,this._updateState();if(aria.core.Browser.isChrome||aria.core.Browser.isSafari)this.currTarget=e.currentTarget},_dom_onmouseup:function(e){if(aria.core.Browser.isChrome||aria.core.Browser.isSafari)this._mousePressed&&e.currentTarget==this.currTarget&&this._performAction(e),this.currTarget=null;this._cfg&&(this._mousePressed=!1,this._updateState())},_dom_onkeydown:function(e){return e.keyCode==aria.DomEvent.KC_SPACE||e.keyCode==aria.DomEvent.KC_ENTER?(this._keyPressed=!0,this
._updateState(),e.stopPropagation(),!1):!0},_dom_onclick:aria.core.Browser.isChrome||aria.core.Browser.isSafari?function(e){this._keyPressed=!1;return}:function(e){if(this._keyPressed){this._keyPressed=!1;return}this._performAction(e)},_dom_onkeyup:function(e){return e.keyCode==aria.DomEvent.KC_SPACE||e.keyCode==aria.DomEvent.KC_ENTER?(this._keyPressed=!1,this._updateState(),this._performAction(e)?!0:(e.stopPropagation(),!1)):!0}}});
//*******************
...
:e.showWeekNumbers,showShortcuts:e.showShortcuts,restrainedNavigation:e.restrainedNavigation,label:e.label,focus:this._hasFocus}}}})},$prototype:{$init:function(e,t,n){e.bindableProperties=e.bindableProperties.concat(["value","startDate"])},_onModuleEvent:function(e){if(this._inOnBoundPropertyChange)return;e.name=="update"?(e.properties.startDate&&this.setProperty("startDate",this._subTplData.settings.startDate),e.properties.value&&(this.setProperty("value",this._subTplData.settings.value),this.evalCallback(
this._cfg.onchange))):e.name=="dateClick"&&this.evalCallback(this._cfg.onclick,{date:e.date})},_onBoundPropertyChange:function(e,t,n){this._inOnBoundPropertyChange=!0;try{e=="startDate"?this._subTplModuleCtrl.navigate({},{date:t}):e=="value"&&this._subTplModuleCtrl.selectDay({date:t})}finally{this._inOnBoundPropertyChange=!1}},_dom_onkeydown:function(e){var t=this.getDom();this.sendKey(e.charCode,e.keyCode)&&(e.preventDefault(!0),t.focus())},_dom_onfocus:function(){this._hasFocus=!0,this._focusUpdate()},_dom_onblur
:function(){this._hasFocus=!1,this._focusUpdate()},_tplLoadCallback:function(e){this.$TemplateBasedWidget._tplLoadCallback.call(this,e),e.success&&this._focusUpdate()},_focusUpdate:function(){var e=this._subTplModuleCtrl,t=this.getDom();if(e&&t&&this._cfg.tabIndex!=null&&this._cfg.tabIndex>=0){var n=e.notifyFocusChanged(this._hasFocus);if(!n){var r=t.style,i=aria.utils.VisualFocus?aria.utils.VisualFocus.getStyle():null;this._hasFocus?aria.core.Browser.isIE6||aria.core.Browser.isIE7?(r.border="1px dotted black"
,r.padding="0px"):i==null&&(r.outline="1px dotted black"):aria.core.Browser.isIE6||aria.core.Browser.isIE7?(r.border="0px",r.padding="1px"):i==null&&(r.outline="none")}}},sendKey:function(e,t){var n=this._subTplModuleCtrl;return n?n.keyevent({charCode:e,keyCode:t}):!1}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.calendar.CfgBeans",$description:"Beans used for the data model of the calendar module controller.",$namespaces:{json:"aria.core.JsonTypes",AppCfg:"aria.core.environment.EnvironmentBaseCfgBeans"},$beans:{CalendarSettings:{$type:"json:Object",$description:"Properties which can be set directly. They are taken into account when calling one of the the refresh methods of the calendar controller.",$properties:{value:{$type:"json:Date",$description:"Date currently selected in the calendar."
},minValue:{$type:"json:Date",$description:"Minimum date for the value property."},maxValue:{$type:"json:Date",$description:"Maximum date for the value property."},displayUnit:{$type:"json:Enum",$description:"Unit which must be displayed entirely in the calendar. May be either month (M) or week (W). The default template only supports month view.",$enumValues:["M","W"],$default:"M"},numberOfUnits:{$type:"json:Integer",$description:"Number of display units to show at the same time.",$minValue:1,$default:2},startDate
:{$type:"json:Date",$description:"Approximate first date in the currently displayed calendar. However, as the calendar may have a display with whole weeks or whole months, dates before this date may also appear."},firstDayOfWeek:{$type:"json:Integer",$description:"First day of the week. 0 = Sunday, ... 6 = Saturday. The null value means that it is set according to the regional settings.",$minValue:0,$maxValue:6},monthLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each month."
,$default:"MMMM yyyy"},dayOfWeekLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each day of the week.",$default:"EE"},dateLabelFormat:{$type:"json:String",$description:"Date pattern to be used when displaying each date in the calendar.",$default:"d"},completeDateLabelFormat:{$type:"AppCfg:FormatTypes",$description:"Date pattern to be used when displaying complete dates (for example, in the default template, the tooltip on the today link)."},label:{$type:"json:String",$description
:"Label text to associate to the calendar."},showWeekNumbers:{$type:"json:Boolean",$description:"Specifies whether week numbers should be displayed."},showShortcuts:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed",$default:!0},restrainedNavigation:{$type:"json:Boolean",$description:"Specifies if today and selected day shortcuts should be displayed",$default:!0},focus:{$type:"json:Boolean",$description:"Is true if the calendar currently has the focus."}}},
CalendarModel:{$type:"json:Object",$description:"Data model for the calendar.",$properties:{settings:{$type:"CalendarSettings"},skin:{$type:"json:Object",$description:"Skin properties",$properties:{sclass:{$type:"json:String",$description:"Skin class."},baseCSS:{$type:"json:String",$description:"Name of CSS classes provided by the skin class."},skinObject:{$type:"json:ObjectRef",$description:"Properties provided by the skin class."}}},calendar:{$type:"json:Object",$description:"Data to be used when displaying the calendar. They are managed by the calendar controller and must not be changed directly."
,$properties:{startDate:{$type:"json:Date",$description:"First date which must be displayed in the calendar.",$mandatory:!0},endDate:{$type:"json:Date",$description:"Last date which must be displayed in the calendar.",$mandatory:!0},daysOfWeek:{$type:"json:Array",$description:"Array of the days of the week, starting with settings.firstDayOfWeek.",$contentType:{$type:"DayOfWeek"},$mandatory:!0},startWeekIndex:{$type:"json:Integer",$description:"Index of first week to display in the weeks array (the weeks array may contain additional weeks before this index for caching purposes, but they should not be currently displayed)."
,$mandatory:!0},endWeekIndex:{$type:"json:Integer",$description:"Index of the last week to display in the weeks array (the weeks array may contain additional weeks after this index for caching purposes, but they should not be currently displayed).",$mandatory:!0},weeks:{$type:"json:Array",$description:"Array of weeks. May be larger than the actual weeks to display. Use startWeekIndex and endWeekIndex to know which weeks to display.",$contentType:{$type:"Week"},$mandatory:!0},startMonthIndex:{$type:"json:Integer"
,$description:"Index of first month to display in the months array (the months array may contain additional months before this index for caching purposes, but they should not be currently displayed).",$mandatory:!0},endMonthIndex:{$type:"json:Integer",$description:"Index of last month to display in the months array (the months array may contain additional months after this index for caching purposes, but they should not be currently displayed).",$mandatory:!0},months:{$type:"json:Map",$description:"Array and map of months. May be larger than the actual months to display. Use startMonthIndex and endMonthIndex to know which months to display."
,$contentType:{$type:"Month"},$mandatory:!0},previousPageEnabled:{$type:"json:Boolean",$description:"Is true if it is possible to get the previous page.",$mandatory:!0},nextPageEnabled:{$type:"json:Boolean",$description:"Is true if it is possible to get the next page.",$mandatory:!0},today:{$type:"json:Date",$description:"Date of the current day.",$mandatory:!0}}}}},DayOfWeek:{$type:"json:Object",$description:"Information about a day of the week.",$properties:{label:{$type:"json:String",$description:"Label to be displayed for the day (see settings.dayOfWeekLabelFormat)."
},day:{$type:"json:Integer",$description:"Day in the week. 0 = Sunday, ... 6 = Saturday",$minValue:0,$maxValue:6}}},Month:{$type:"json:Object",$description:"Contains information about a specific month.",$properties:{label:{$type:"json:String",$description:"Label to be displayed for the month (see settings.monthLabelFormat).",$mandatory:!0},monthKey:{$type:"json:String",$description:"String which specify the month. Its format could change in the future. It should only be used to compare several monthKey fields or to retrieve the month from the calendar.months array."
,$mandatory:!0},firstOfMonth:{$type:"json:Date",$description:"Javascript Date for the first day of the month.",$mandatory:!0},weeks:{$type:"json:Array",$description:"Array of the weeks in this month.",$contentType:{$type:"Week"},$mandatory:!0},weeksInMonth:{$type:"json:Integer",$description:"Number of weeks in the month, including weeks overlapping with other months (is equal to weeks.length).",$minValue:4,$maxValue:6,$mandatory:!0},wholeWeeksInMonth:{$type:"json:Integer",$description:"Number of whole weeks in the month (not including weeks overlapping with other months)."
,$minValue:3,$maxValue:4,$mandatory:!0},daysBeforeStartOfMonth:{$type:"json:Integer",$description:"Number of days between the first day of the week and the first day of the month.",$minValue:0,$maxValue:6,$mandatory:!0},daysInMonth:{$type:"json:Integer",$description:"Number of days in the month.",$minValue:28,$maxValue:31,$mandatory:!0},daysAfterEndOfMonth:{$type:"json:Integer",$description:"Number of days between the last day of the month and the end of the week.",$minValue:0,$maxValue:6,$mandatory:!0}},$mandatory
:!0},Week:{$type:"json:Object",$description:"Contains information about a specific week.",$properties:{overlappingDays:{$type:"json:Integer",$description:"Number of days at the begining of the week which belong to the previous month, if the whole week is not in a single month. The value is 0 if the whole week is in a single month.",$mandatory:!0},monthStart:{$type:"json:String",$description:"If the week contains the first day of a month, contain the monthKey of that month. Is null or undefined otherwise.",$mandatory
:!1},month:{$type:"json:String",$description:"If overlappingDays is 0, contain the monthKey of the month which this week belongs to.",$mandatory:!1},monthEnd:{$type:"json:String",$description:"If the week contains the last day of a month, contain the monthKey of that month. Is null or undefined otherwise.",$mandatory:!1},indexInMonth:{$type:"json:Integer",$description:"Contain the index of this week inside the month specified by month or monthEnd.",$mandatory:!0},weekNumber:{$type:"json:Integer",$description
:"Number of the week in the year (first whole week = 1).",$mandatory:!0},days:{$type:"json:Array",$description:"Contains the days of this week.",$contentType:{$type:"Date"},$mandatory:!0}}},Date:{$type:"json:Object",$description:"Contains information about a specific date.",$properties:{jsDate:{$type:"json:Date",$description:"Javascript date object.",$mandatory:!0},label:{$type:"json:String",$description:"Label to use when displaying the date in the calendar.",$mandatory:!0},monthKey:{$type:"json:String",$description
:"String which specify the month. Its format could change in the future. It should only be used to compare several monthKey fields or to retrieve the month from the calendar.months array.",$mandatory:!0},isFirstOfMonth:{$type:"json:Boolean",$description:"Is true if the date is the first of its month.",$mandatory:!1},isLastOfMonth:{$type:"json:Boolean",$description:"Is true if the date is the last of its month.",$mandatory:!1},isSelected:{$type:"json:Boolean",$description:"Is true if the date is selected.",$mandatory
:!1},isWeekend:{$type:"json:Boolean",$description:"Is true if the date is in the week-end (either a saturday or a sunday).",$mandatory:!1},isToday:{$type:"json:Boolean",$description:"Is true if the date is today.",$mandatory:!1},isSelectable:{$type:"json:Boolean",$description:"Is true if the date is selectable.",$mandatory:!1}},$mandatory:!0},DatePosition:{$type:"json:Object",$description:"Information about the position of a specific date inside the data model of the calendar.",$properties:{weekIndex:{$type:"json:Integer"
,$description:"Index in the general weeks array.",$mandatory:!0},monthIndex:{$type:"json:Integer",$description:"Index in the general months array, or null if the month is not in the data model."},weekInMonthIndex:{$type:"json:Integer",$description:"Index in the weeks array of the month, or null if the month is not in the data model",$mandatory:!0},dayInWeekIndex:{$type:"json:Integer",$description:"Index in the days array of the week.",$mandatory:!0},month:{$type:"Month",$description:"Month in which the date is found, or null if the month is not in the data model"
,$mandatory:!0},week:{$type:"Week",$description:"Week in which the date is found.",$mandatory:!0},day:{$type:"Date",$description:"Date information.",$mandatory:!0}}}}});
//*******************
//LOGICAL-PATH:aria/widgets/calendar/ICalendarController.js
//*******************
Aria.interfaceDefinition({$classpath:"aria.widgets.calendar.ICalendarController",$extends:"aria.templates.IModuleCtrl",$events:{focusChanged:{description:"Raised when the focus changed.",properties:{focus:"Contains the current value of the focus property.",cancelDefault:"If true, prevent the default focus visual notification."}},update:{description:"Raised when one or more calendar settings have changed and the data model has been updated.",properties:{properties:"Map of properties which have changed in the settings. This map must stay read-only."
,propertiesNbr:"Number of properties which have changed in the settings."}},dateClick:{description:"Raised when the user clicked on a date in the calendar.",properties:{date:"Date which the user clicked on.",cancelDefault:""}},keyevent:{description:"Raised when the keyevent method is called, which is normally when the user has pressed a key. A listener of this event can change some of the event properties to change the default behavior.",properties:{charCode:"",keyCode:"",increment:"",incrementUnit:"",refDate
:"",date:"",cancelDefault:"Set this property to true if some action is done on this key when receiving this event, so that the key propagation and the default action of the browser on this key is canceled."}}},$interface:{navigate:function(e,t){},selectDay:function(e){},update:function(){},keyevent:function(e){},dateClick:function(e){},getDatePosition:function(e){},notifyFocusChanged:function(e){}}});
//*******************
//LOGICAL-PATH:aria/widgets/container/Container.js
//*******************
Aria.classDefinition({$classpath:"aria.widgets.container.Container",$extends:"aria.widgets.Widget",$dependencies:["aria.utils.Size"],$constructor:function(e,t){this.$Widget.constructor.apply(this,arguments),this._cssClassNames=aria.core.TplClassLoader.addPrintOptions(this._cssClassNames,e.printOptions),this._sizeConstraints=e.width==-1&&(!!e.minWidth||!!e.maxWidth)||e.height==-1&&(!!e.minHeight||!!e.maxHeight),this._directInit=this._directInit||this._sizeConstraints},$prototype:{initWidgetDom:function(e){this
.$Widget.initWidgetDom.call(this,e),this._sizeConstraints&&this._updateContainerSize(!0)},_dom_oncontentchange:function(e){this.__initWhileContentChange!==!0&&this._updateContainerSize(),this.__initWhileContentChange=!1},_updateContainerSize:function(e){var t=this._cfg,n=this.getDom(),r,i,s;n&&this._sizeConstraints&&(t.width==-1&&(r={min:t.minWidth,max:t.maxWidth}),t.height==-1&&(i={min:t.minHeight,max:t.maxHeight}),this._changedContainerSize&&(n.style.width=t.width>-1?t.width+"px":"",n.style.height=t.height>-1?
t.height+"px":"",this._frame&&this._frame.resize(t.width,t.height)),s=aria.utils.Size.setContrains(n,r,i),s&&this._frame&&(this._frame.resize(s.width,s.height),n.parentNode&&e&&aria.utils.Delegate.delegate(aria.DomEvent.getFakeEvent("contentchange",n.parentNode))),this._changedContainerSize=s)},_widgetMarkupBegin:function(e){},_widgetMarkupEnd:function(e){}}});
//*******************
...
.getSkinObject("Dialog",e.sclass),this._popup=null,this._hasMarkup=!1,this._closeDelegateId=null,this._draggable=null;var n=e.handles||"n-resize,s-resize,e-resize,w-resize,ne-resize,nw-resize,se-resize,sw-resize";this._handlesArr=n.split(","),this._resizable={}},$destructor:function(){this.close(),this.$Container.$destructor.call(this)},$statics:{MISSING_CONTENT_MACRO:"Missing contentMacro in Dialog configuration."},$prototype:{$init:function(e,t,n){e.bindableProperties=e.bindableProperties.concat(["contentMacro"
,"visible"])},_onViewportResized:function(e){var t=this._domElt;t.style.width="",t.style.height="";var n=aria.utils.Dom._getViewportSize(),r=aria.utils.Math;this._div.updateSize({height:this._cfg.height,maxHeight:r.min(this._cfg.maxHeight,n.height),width:this._cfg.width,maxWidth:r.min(this._cfg.maxWidth,n.width)}),this._updateContainerSize()},_checkCfgConsistency:function(e){!("contentMacro"in e)&&!("bind"in e&&"contentMacro"in e.bind)&&this.$logError(this.MISSING_CONTENT_MACRO);var t=aria.widgets.environment
.WidgetSettings.getWidgetSettings().dialog;"movable"in e||(e.movable=t.movable),"movableProxy"in e||(e.movableProxy=t.movableProxy)},_widgetMarkupBegin:function(e){var t=this._cfg;this._skipContent=e.sectionState==e.SECTION_KEEP||!t.visible,e.beginSection({id:"__dialog_"+this._domId});if(this._skipContent)return;var n=aria.utils.Dom._getViewportSize(),r=aria.utils.Math,i=r.min(this._cfg.maxHeight,n.height),s=r.min(this._cfg.maxWidth,n.width);this._div=new aria.widgets.container.Div({sclass:this._skinObj.divsclass
,margins:"0 0 0 0",block:!0,cssClass:this._context.getCSSClassNames(!0)+" "+this._cfg.cssClass,height:this._cfg.height,minHeight:this._cfg.minHeight,maxHeight:i,width:this._cfg.width,minWidth:this._cfg.minWidth,maxWidth:s,scrollBarX:this._cfg.scrollBarX,scrollBarY:this._cfg.scrollBarY},this._context,this._lineNumber),e.registerBehavior(this._div),this._div.writeMarkupBegin(e),e.beginSection({id:"__dialogContent_"+this._domId,keyMap:[{key:"ESCAPE",callback:{fn:this.actionClose,scope:this}}]})},_widgetMarkupEnd
:function(e){var t=this._cfg;if(!this._skipContent){e.endSection(),this._div.writeMarkupEnd(e);if(t.resizable&&this._handlesArr){var n=this._handlesArr;for(var r=0,i=n.length;r<i;r++)e.write(['<span class="xDialog_resizable xDialog_'+n[r]+'">',"</span>"].join(""))}e.write(['<div class="xDialog_titleBar xDialog_',t.sclass,'_titleBar">'].join(""));if(t.icon){e.write(['<span class="xDialog_icon xDialog_',t.sclass,'_icon">'].join(""));var s=new aria.widgets.Icon({icon:t.icon},this._context,this._lineNumber);e.registerBehavior
(s),s.writeMarkup(e),e.write("</span>")}e.write(['<span class="xDialog_title xDialog_',t.sclass,'_title">',aria.utils.String.escapeHTML(t.title),"</span>"].join(""));if(t.closable){var o=aria.utils.Delegate;this._closeDelegateId=o.add({fn:this._onCloseBtnEvent,scope:this}),e.write(['<span class="xDialog_close xDialog_',t.sclass,'_close" '+o.getMarkup(this._closeDelegateId)+">"].join(""));var u=new aria.widgets.Icon({icon:this._skinObj.closeIcon},this._context,this._lineNumber);e.registerBehavior(u),u.writeMarkup
(e),e.write("</span>")}e.write("</div>")}e.endSection()},_widgetMarkup:function(e){this._widgetMarkupBegin(e),this._widgetMarkupEnd(e)},_writerCallback:function(e){this._widgetMarkupBegin(e),this._cfg.contentMacro&&e.callMacro(this._cfg.contentMacro),this._widgetMarkupEnd(e)},initWidget:function(){this.$Container.initWidget.apply(this,arguments),this._cfgOk&&this._checkCfgConsistency(this._cfg),this._init()},_init:function(){this.getProperty("visible")&&this._cfgOk&&this.open()},_onBoundPropertyChange:function(
e,t,n){if(e==="visible")this._cfg.visible=t,t?this.open():this.close();else if(e==="title")this._cfg.title=t,this._titleDomElt&&(this._titleDomElt.innerHTML=t);else if(e==="contentMacro"){this._cfg.contentMacro=t;if(this._popup)if(!this._popup.isOpen)this.open();else{var r={outputSection:"__dialogContent_"+this._domId,macro:t};this._context.$refresh(r)}}else e==="xpos"||e==="ypos"?(this._cfg[e]=t,this.setProperty("center",!1),this.updatePosition()):e==="center"?(this._cfg.center=t,this.updatePosition()):this
.$Container._onBoundPropertyChange.apply(this,arguments)},_onCloseBtnEvent:function(e){e.type=="click"&&this.actionClose()},actionClose:function(){var e=this._cfg.onCloseClick,t=!1;if(e){var n={cancelDefault:!0};this.evalCallback(e,n),t=n.cancelDefault}t||this.changeProperty("visible",!1)},open:function(){var e=this._cfg,t={filterSection:"__dialog_"+this._domId,writerCallback:{fn:this._writerCallback,scope:this}},n=this._context.getRefreshedSection(t),r=new aria.popups.Popup;this._popup=r,r.$on({onAfterOpen:
this._onAfterPopupOpen,scope:this}),e.closeOnMouseClick&&r.$on({onMouseClickClose:this._onMouseClickClose,scope:this});if(this._cfg.modal){var i=aria.templates.NavigationManager;i.addGlobalKeyMap({key:"ESCAPE",modal:!0,callback:{fn:this.actionClose,scope:this}}),i.setModalBehaviour(!0)}r.open({section:n,keepSection:!0,absolutePosition:{left:e.xpos,top:e.ypos},center:e.center,modal:e.modal,maskCssClass:"xDialogMask",closeOnMouseClick:e.closeOnMouseClick,closeOnMouseScroll:!1,parentDialog:this}),aria.templates
.Layout.$on({viewportResized:this._onViewportResized,scope:this})},_onAfterPopupOpen:function(){var e=this._cfg,t=aria.utils.Dom.getDomElementChild;this._domElt=this._popup.domElement,this._titleBarDomElt=t(this._domElt,0,!0),this._titleDomElt=t(this._titleBarDomElt,e.icon?1:0),this._calculatePosition(),e.modal&&aria.templates.NavigationManager.focusFirst(this._domElt),this.evalCallback(e.onOpen),e.movable&&Aria.load({classes:["aria.utils.dragdrop.Drag"],oncomplete:{fn:this._createDraggable,scope:this}}),e.resizable&&
Aria.load({classes:["aria.utils.resize.Resize"],oncomplete:{fn:this._createResize,scope:this}})},_onMouseClickClose:function(){this.actionClose()},close:function(){var e=this._cfg;if(this._popup){e.movable&&this._destroyDraggable(),e.resizable&&this._destroyResizable(),this._domElt=null,this._titleBarDomElt=null,this._titleDomElt=null,this._closeDelegateId&&aria.utils.Delegate.remove(this._closeDelegateId),this._popup.close(),this._popup.$dispose(),this._popup=null;if(e.modal){var t=aria.templates.NavigationManager
;t.removeGlobalKeyMap({key:"ESCAPE",modal:!0,callback:{fn:this.actionClose,scope:this}}),t.setModalBehaviour(!1)}aria.templates.Layout.$removeListeners({viewportResized:this._onViewportResized,scope:this})}},_updateContainerSize:function(){this.$Container._updateContainerSize.call(this),this.updatePosition()},updatePosition:function(){this._popup&&this._popup.isOpen&&(this._popup.moveTo({center:this._cfg.center,absolutePosition:{left:this._cfg.xpos,top:this._cfg.ypos,height:this._cfg.height,width:this._cfg.width
}}),this._calculatePosition())},_calculatePosition:function(){var e=aria.utils.Dom.calculatePosition(this._domElt);this.setProperty("xpos",e.left),this.setProperty("ypos",e.top)},_calculateSize:function(){var e=aria.utils.Dom.getGeometry(this._domElt);this.setProperty("height",e.height),this.setProperty("width",e.width)},_createDraggable:function(){this._draggable=new aria.utils.dragdrop.Drag(this._domElt,{handle:this._titleBarDomElt,cursor:"move",proxy:this._cfg.movableProxy,constrainTo:aria.utils.Dom.VIEWPORT
}),this._draggable.$on({dragstart:{fn:this._onDragStart,scope:this},move:{fn:this._onDragMove,scope:this},dragend:{fn:this._onDragEnd,scope:this}})},_createResize:function(){if(this._handlesArr){var e=this._handlesArr,t=0,n=this._domElt,r=aria.utils.Dom.getDomElementChild;for(var i=0,s=e.length;i<s;i++){var o=r(n,++t,!1),u=null,a;a=e[i];if(a=="n-resize"||a=="s-resize")u="y";if(a=="w-resize"||a=="e-resize")u="x";this._resizable[a]=new aria.utils.resize.Resize(this._domElt,{handle:o,cursor:a,axis:u}),this._resizable
[a].$on({beforeresize:{fn:this._onResizeStart,scope:this},resize:{fn:this._onResizing,scope:this},resizeend:{fn:this._onResizeEnd,scope:this}})}}},_onDragStart:function(){this.evalCallback(this._cfg.ondragstart)},_onDragMove:function(){!this._cfg.movableProxy&&this._popup&&this._popup.refreshProcessingIndicators()},_onDragEnd:function(){this._popup&&this._popup.refreshProcessingIndicators(),this.setProperty("center",!1),this._calculatePosition(),this.updatePosition(),this.evalCallback(this._cfg.ondragend)},_onResizeStart
:function(){this.evalCallback(this._cfg.beforeresize)},_onResizing:function(){this._popup&&this._popup.refreshProcessingIndicators()},_onResizeEnd:function(){this._calculatePosition(),this._calculateSize(),this.setProperty("center",!1),this._popup&&(this.close(),this.open(),this._popup.refreshProcessingIndicators()),this.evalCallback(this._cfg.resizeend)},_destroyDraggable:function(){this._draggable.$removeListeners({dragstart:{fn:this._onDragStart,scope:this},move:{fn:this._onDragMove,scope:this},dragend:{fn
:this._onDragEnd,scope:this}}),this._draggable.$dispose(),this._draggable=null},_destroyResizable:function(){var e=this._handlesArr;for(var t=0,n=e.length;t<n;t++){var r=e[t];this._resizable[r].$dispose(),this._resizable[r]=null}}}});
//*******************
...
//*******************
Aria.classDefinition({$classpath:"aria.widgets.controllers.TextDataController",$dependencies:["aria.widgets.controllers.reports.ControllerReport"],$events:{onCheck:{description:"Notifies that controller has finished am asynchronouse check (internal, of the value or of a keystroke)",properties:{report:"{aria.widgets.controllers.reports.ControllerReport} a check report"}}},$constructor:function(){this._dataModel={value:null,displayText:""}},$prototype:{checkKeyStroke:function(e,t,n,r){return new aria.widgets.controllers
.reports.ControllerReport},checkText:function(e){var t=new aria.widgets.controllers.reports.ControllerReport;return aria.utils.Type.isString(e)||aria.utils.Type.isNumber(e)?(t.value=e,t.ok=!0):t.ok=!1,t},checkValue:function(e){e==null&&(e="");var t=this.checkText(e);return t.text=t.value,t},getDataModel:function(){return this._dataModel},_getTypedValue:function(e,t,n,r){var i;if(e===0)return i={nextValue:t,caretPosStart:n,caretPosEnd:r},i;var s=String.fromCharCode(e);if(s==="")return i={nextValue:t,caretPosStart
:n,caretPosEnd:r},i;if(t==null||t==="")return i={nextValue:s,caretPosStart:s.length,caretPosEnd:s.length},i;var o=t.length;if(n>=o)return i={nextValue:t+s,caretPosStart:n+s.length,caretPosEnd:n+s.length},i;var u=t.slice(0,n),a=t.slice(r,o);return i={nextValue:u+s+a,caretPosStart:n+s.length,caretPosEnd:n+s.length},i},_getTypedValueOnDelete:function(e,t,n,r){var i={};if(t==null||t==="")return i={nextValue:"",caretPosStart:0,caretPosEnd:0},i;var s=t.length;n>=s&&(n=s);var o="",u="";return n!=r&&(e=aria.DomEvent
.KC_DELETE),e==aria.DomEvent.KC_DELETE?(n!=r?(o=t.slice(0,n),u=t.slice(r,s)):(o=t.slice(0,n),n==s?u="":u=t.slice(n+1,s)),i.caretPosStart=n,i.caretPosEnd=n):(n<1?(o="",i.caretPosStart=n,i.caretPosEnd=n):(o=t.slice(0,n-1),i.caretPosStart=n-1,i.caretPosEnd=n-1),u=t.slice(r,s)),i.nextValue=o+u,i},_raiseReport:function(e,t){this.$raiseEvent({name:"onCheck",report:e,arg:t})}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.errorlist.CfgBeans",$description:"Data model of the error list widget.",$namespaces:{json:"aria.core.JsonTypes"},$beans:{Model:{$type:"json:Object",$description:"Root of the data model for the error list widget.",$mandatory:!0,$properties:{title:{$type:"json:String",$description:"Title for the list of messages."},displayCodes:{$type:"json:Boolean",$description:"True if message codes should be displayed along with localized messages."},messages:{$type:"json:ObjectRef"
,$description:"List of messages, with the structure described in aria.utils.validators.CfgBeans.MessagesList.",$mandatory:!0},filterTypes:{$type:"json:Array",$description:"If not null, specifies the types of messages which should be displayed in the widget. It must match the type property in aria.utils.validators.CfgBeans.Message.",$default:null,$contentType:{$type:"json:String",$description:"Type of message.",$mandatory:!0},$sample:["F","E"]},divCfg:{$type:"json:ObjectRef",$mandatory:!0,$description:"Configuration to give to the @aria:Div widget surrounding the messages (if necessary)."
},messageTypes:{$type:"json:Map",$description:"Map giving for each type of message present in the messages property the number of messages of that type in the messages property.",$contentType:{$type:"json:Integer",$description:"Number of messages of the corresponding type in the messages property.",$minValue:0}}}}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.form.AutoCompleteBean",$description:"Definition of the suggestions used in the autocomplete",$namespaces:{json:"aria.core.JsonTypes"},$beans:{Suggestion:{$type:"json:Object",$description:"A Label-Code suggestion",$properties:{exactMatch:{$type:"json:Boolean",$description:"is this entry an exact match in the suggestions",$default:!1}}}}});
//*******************
...
(),s={block:!0,startDate:i.jsDate,tabIndex:-1,sclass:t.calendarSclass,label:t.calendarLabel,defaultTemplate:t.calendarTemplate,minValue:t.minValue,maxValue:t.maxValue,onclick:{fn:this._clickOnDate,scope:this},bind:{value:{to:"calendarValue",inside:i}}},o=["displayUnit","numberOfUnits","firstDayOfWeek","monthLabelFormat","dayOfWeekLabelFormat","dateLabelFormat","completeDateLabelFormat","showWeekNumbers","showShortcuts","restrainedNavigation"];for(var u=0,a;a=o[u];u++)this._applyCalendarCfg(a,s);var f=new aria
.widgets.calendar.Calendar(s,this._context,this._lineNumber);f.$on({widgetContentReady:this._refreshPopup,scope:this}),this.controller.setCalendar(f),e.registerBehavior(f),f.writeMarkup(e),r&&e.write("</div>")},_closeDropdown:function(){this._dropdownPopup&&(this.$DropDownTextInput._closeDropdown.call(this),this.focus())},_refreshPopup:function(){this._dropdownPopup&&this._dropdownPopup.refresh()},_afterDropdownClose:function(){this.$DropDownTextInput._afterDropdownClose.call(this),this.controller.setCalendar
(null)},_onBoundPropertyChange:function(e,t,n){e==="referenceDate"?this.controller.setReferenceDate(t):this.$DropDownTextInput._onBoundPropertyChange.call(this,e,t,n)}}});
//*******************
...
({fn:this._enableMouseOverItem,scope:this,delay:100});var t=this.$DropDownTextInput||this.$DropDownInput;t._handleKey.call(this,e)},_enableMouseOverItem:function(){this._ignoreMouseOverItemCallback=null},_mouseOverItem:function(e){if(!this._ignoreMouseOverItemCallback){var t=this.controller.getDataModel();aria.utils.Json.setValue(t,"selectedIdx",e.index)}},_keyPressed:function(e){return this._hasFocus?!1:(this.focus(),this._handleKey({charCode:e.charCode,keyCode:e.keyCode}),!0)},_renderDropdownContent:function(
e,t){t=t||{};var n=this._cfg,r=this.controller.getDataModel(),i=this._domElt.lastChild,s=aria.utils.Dom,o=s.getGeometry(i);if(o===null)return;s.scrollIntoView(i);var u=o.y,a=aria.utils.Dom._getViewportSize(),f=a.height-u-o.height,l=u>f?u:f,c=t.maxHeight||this.MAX_HEIGHT;l=l<this.MIN_HEIGHT?this.MIN_HEIGHT:l,l=l>c?c:l-2;var h=new aria.widgets.form.list.List({id:n.id,defaultTemplate:"defaultTemplate"in t?t.defaultTemplate:n.listTemplate,block:!0,sclass:"dropdown",onclick:{fn:this._clickOnItem,scope:this},onmouseover
:{fn:this._mouseOverItem,scope:this},onkeyevent:{fn:this._keyPressed,scope:this},onclose:{fn:this._closeDropdown,scope:this},maxHeight:l,minWidth:"minWidth"in t?t.minWidth:this._inputMarkupWidth+15,width:this.__computeListWidth(n.popupWidth,this._inputMarkupWidth+15),preselect:n.preselect,bind:{items:{to:"listContent",inside:r},selectedIndex:{to:"selectedIdx",inside:r}},scrollBarX:!1},this._context,this._lineNumber);h.$on({widgetContentReady:this._refreshPopup,scope:this}),e.registerBehavior(h),h.writeMarkup
(e),this.controller.setListWidget(h)},_afterDropdownClose:function(){this.controller.setListWidget(null),this.$DropDownTrait._afterDropdownClose.call(this)},__computeListWidth:function(e,t){return e<0?null:aria.core.Browser.isIE6?e:e>t?e:t}}});
//*******************
...
(n)&&(e[n]=t[n])},_toggleDropdown:function(){this._hasFocus||this.focus();var e=this.controller.toggleDropdown(this.getTextInputField().value,this._dropdownPopup!=null);this._reactToControllerReport(e,{hasFocus:!0}),this.focus()},_handleKey:function(e){this.controller&&(!e.ctrlKey&&!e.altKey?this._checkKeyStroke(e):aria.core.Timer.addCallback({fn:this._checkKeyStroke,scope:this,args:e,delay:4}))},_checkKeyStroke:function(e){var t=this.controller,n=this.getCaretPosition();if(n){var r=t.checkKeyStroke(e.charCode
,e.keyCode,this.getTextInputField().value,n.start,n.end);r&&r.cancelKeyStroke&&e.preventDefault&&e.preventDefault(!0),this._reactToControllerReport(r,{hasFocus:!0})}},_dom_onkeydown:function(e){this.$DropDownTrait._dom_onkeydown.call(this,e),e.hasStopPropagation||this.$TextInput._dom_onkeydown.call(this,e)},_dom_onkeyup:function(e){var t=aria.core.Browser;t.isAndroid&&t.isChrome&&!e.isSpecialKey&&e.keyCode==229&&(e.charCode=0,this._handleKey(e)),this.$TextInput._dom_onkeydown.call(this,e)},_reactToControllerReport
...
null,this._inputMarkupHeight=-1,this._isIE7OrLess=aria.core.Browser.isIE&&aria.core.Browser.majorVersion<8},$destructor:function(){this._onValidatePopup&&(this._onValidatePopup.$dispose(),this._onValidatePopup=null),this._label=null,this.$Widget.$destructor.call(this)},$statics:{WIDGET_INPUT_NO_LABEL:"%1Label HTML Element was not found.",WIDGET_INPUT_TOO_MANY_LABELS:"%1More than one label HTML Element has been found."},$prototype:{$init:function(e,t,n){e.bindableProperties=e.bindableProperties.concat(["label"
,"value","mandatory","readOnly","disabled","error"]),e.automaticallyBindedProperties=["formatError","formatErrorMessages","error","errorMessages","requireFocus"]},_init:function(){var e=this._getInputMarkupDomElt();e&&this._initInputMarkup(e);var t=this._getInputLabelMarkupDomElt();t&&this._initLabelMarkup(t)},_initInputMarkup:function(e){},_initLabelMarkup:function(e){this._label=e},_widgetMarkup:function(e){var t=this._cfg,n=!t.hideLabel&&!!t.label;this._isIE7OrLess&&e.write('<span style="display: inline-block;">'
),n?t.labelPos==="left"?(this._inputLabelMarkup(e,"inline-block","right"),this._inputMarkup(e)):t.labelPos==="top"?(this._inputLabelMarkup(e,"block",!1),this._inputMarkup(e)):t.labelPos==="bottom"?(this._inputMarkup(e),this._inputLabelMarkup(e,"block",!1)):(this._inputMarkup(e),this._inputLabelMarkup(e,"inline-block","left")):this._inputMarkup(e),this._isIE7OrLess&&e.write("</span>")},_getInputMarkupDomElt:function(){var e=this._cfg,t=!e.hideLabel&&!!e.label,n;t?e.labelPos==="right"||e.labelPos==="bottom"?n=0
:n=1:n=0;var r=this.getDom();return this._isIE7OrLess&&(r=r?r.firstChild:null),aria.utils.Dom.getDomElementChild(r,n)},_getInputLabelMarkupDomElt:function(){var e=this._cfg,t=!e.hideLabel&&!!e.label;if(t){var n=this.getDom();this._isIE7OrLess&&(n=n?n.firstChild:null);var r=aria.utils.Dom.getDomElementsChildByTagName(n,"label");if(r)if(r.length===0)this.$logError(this.WIDGET_INPUT_NO_LABEL,[]);else{if(r.length==1)return r[0];this.$logError(this.WIDGET_INPUT_TOO_MANY_LABELS,[])}}return null},getLabel:function(
){return!this._label&&!this._initDone&&this.getDom(),this._label},_inputMarkup:function(e){},_inputLabelMarkup:function(e,t,n){var r=this._cfg,i='class="x'+this._skinnableClass+"_"+r.sclass+"_"+this._state+'_label"',s=aria.core.Browser.isIE7?"-25%":"middle";e.write("<label "+i+' style="'),aria.widgets.environment.WidgetSettings.getWidgetSettings().middleAlignment?e.write("vertical-align:"+s+";"):e.write("vertical-align:-1px;"),e.write("display:"+t),n&&e.write(";margin-"+n+":"+this._labelPadding+"px"),r.labelWidth>-1&&
e.write(";width:"+r.labelWidth+"px"),r.labelHeight>-1&&e.write(";height:"+r.labelHeight+"px"),e.write(";text-align:"+r.labelAlign+';">'),e.write(aria.utils.String.escapeHTML(r.label)),e.write("</label>")},_checkCfgConsistency:function(){var e=this._cfg,t=e.width,n=e.labelPos==="top"||e.labelPos==="bottom",r=!e.hideLabel&&!!e.label,i;t>-1&&(t<this._minInputMarkupWidth&&(t=this._minInputMarkupWidth),i=e.labelWidth,r&&i>-1?(n?(i<t?i=t:i>t&&(t=i),this._inputMarkupWidth=t):i+this._minInputMarkupWidth>t?(t=i+this.
_minInputMarkupWidth,this._inputMarkupWidth=this._minInputMarkupWidth):this._inputMarkupWidth=t-i,e.labelWidth=i):this._inputMarkupWidth=t,e.width=t),this._inputMarkupWidth<0&&(this._inputMarkupWidth=this._defaultInputMarkupWidth),r&&!n&&(this._inputMarkupWidth-=this._labelPadding),e.directOnBlurValidation==null&&(e.directOnBlurValidation=aria.widgets.environment.WidgetSettings.getWidgetSettings().directOnBlurValidation),e.height>-1&&(this._inputMarkupHeight=e.height,r&&n&&(this._inputMarkupHeight-=e.labelHeight
)),this.$Widget._checkCfgConsistency.call(this)},_validationPopupShow:function(){this._onValidatePopup||(this._onValidatePopup=new aria.widgets.form.InputValidationHandler(this)),this._onValidatePopup.show()},_validationPopupHide:function(){this._onValidatePopup&&this._onValidatePopup.hide()},_onBoundPropertyChange:function(e,t,n){if(e==="requireFocus"){if(!t||!this.focus||this._cfg.disabled)return;var r=this._cfg.bind[e],i=r.inside[r.to];i&&(this.focus(),aria.utils.Json.setValue(r.inside,r.to,!1))}else if(e==="label"
){this._cfg[e]=t;var s=this.getLabel();s&&(s.innerHTML=aria.utils.String.escapeHTML(t))}return this.$Widget._onBoundPropertyChange.apply(this,arguments)},_setAutomaticBindings:function(e){var t,n,r,i=this.automaticallyBindedProperties,s=null;e&&e.bind&&(s=e.bind.value);if(s&&s.inside){t=aria.utils.Data._getMeta(s.inside,s.to,!1),e.bind.error||(e.bind.error={inside:t,to:"error"}),e.bind.errorMessages||(e.bind.errorMessages={inside:t,to:"errorMessages"}),e.bind.formatErrorMessages||(e.bind.formatErrorMessages=
{inside:t,to:"formatErrorMessages"}),e.bind.requireFocus||(e.bind.requireFocus={inside:t,to:"requireFocus"});if(e.inputMetaData){r="local:"+e.inputMetaData,n=t[r],n==null&&(n={},t[r]=n);for(var o=0;o<i.length;o++)e.bind[i[o]]||(e.bind[i[o]]={inside:n,to:i[o]})}}}}});
//*******************
...
_state="disabled";else if(this._cfg.readOnly)this._state="readOnly";else{var e;this._cfg.mandatory?e="mandatory":e="normal";if(this._cfg.formatError||this._cfg.error)e+="Error";if(this._hasFocus||this._keepFocus)e+="Focused";this._state=e}},_dom_onblur:function(){this._hasFocus=!1,this._updateState();if(this._cfg.formatError&&this._cfg.validationEvent==="onBlur")this._validationPopupShow(this);else{this._validationPopupHide(this);if(this._cfg.directOnBlurValidation){if(this._cfg.bind){var e=this._cfg.bind.value
;if(e){var t=e.inside,n=e.to,r=this._cfg.validationGroups;aria.utils.Data.validateValue(t,n,null,r,"onblur")}}this._onvalidate({popup:!1})}}this._updateValue(!0)},_dom_onfocus:function(){this._hasFocus=!0,this._cfg&&this._cfg.validationEvent==="onFocus"&&(this._cfg.formatError&&this._cfg.formatErrorMessages.length||this._cfg.error&&this._cfg.errorMessages.length)&&this._validationPopupShow(this),this._updateState()},_onvalidate:function(e){this._cfg.onvalidate&&this.$logWarn(this.WIDGET_PROPERTY_DEPRECATION,
["onvalidate"]),this.evalCallback(this._cfg.onvalidate),e.popup&&this._cfg.error?this._validationPopupShow(this):this._validationPopupHide(this)},_dom_onmousedown:function(e){var t=e.target,n=this._getInputMarkupDomElt();this.controller&&aria.utils.Dom.isAncestor(t,n)&&(this._toggleDropdown(),e.preventDefault())},_dom_onclick:function(){this._updateValue(!1)},_dom_onchange:function(){this._updateValue(!1)},_dom_onkeypress:function(e){var t=aria.DomEvent;e.keyCode===t.KC_ENTER&&this._updateValue(!1),this.$DropDownInput
._dom_onkeypress.call(this,e)},_getPopupIgnoreClicksOnDomElts:function(){var e=this.$DropDownInput._getPopupIgnoreClicksOnDomElts.call(this);return e.push(this._getInputMarkupDomElt()),e},_updateValue:function(e){var t=null;if(this._skinObj.simpleHTML)t=this.setProperty("value",this.getSelectField().value);else if(e){var n=this.controller,r=n.getDataModel();t=this.setProperty("value",r.value)}this._cfg&&t!=null&&(this.changeProperty("error",!1),(!this._cfg.formatError||!this._cfg.formatErrorMessages.length||
this._cfg.error&&this._cfg.errorMessages.length)&&this._validationPopupHide(this),this._cfg.onchange&&this.evalCallback(this._cfg.onchange))},_initInputMarkup:function(e){this.$InputWithFrame._initInputMarkup.call(this,e),this._selectField=this._frame.getChild(0)},_inputWithFrameMarkup:function(e){var t=this._cfg,n=this._frame.innerWidth,r=t.disabled||t.readOnly,i=r?"":' tabindex="'+this._calculateTabIndex()+'"';if(this._skinObj.simpleHTML){var s=aria.utils.String,o=t.options,u=t.value,a=["<select",Aria.testMode?' id="'+
this._domId+'_input"':"",n>0?' style="width: '+n+'px;" ':"",i,r?' disabled="disabled"':"",' _ariaInput="1">'];for(var f=0,l=o.length;f<l;f++){var c=""+o[f].value;a.push('<option value="',s.encodeForQuotedHTMLAttribute(c),'"',c==u?' selected="selected"':"",">",s.escapeHTML(o[f].label),"</option>")}a.push("</select>"),e.write(a.join(""))}else{var h=this.controller.checkValue(t.value),p=h.text;h.$dispose(),e.write(["<span",Aria.testMode?' id="'+this._domId+'_input"':"",' class="xSelect" style="',n>0?"width:"+n+"px;"
:"",'"',i,' _ariaInput="1">',aria.utils.String.escapeHTML(p),"&nbsp;</span>"].join(""))}},_onBoundPropertyChange:function(e,t,n){if(e==="value"){this._checkValue();if(this.controller){var r=this.controller.checkValue(t);this._reactToControllerReport(r,{stopValueProp:!0})}else{var i=this.getSelectField();for(var s=0;s<i.options.length;s++)if(i.options[s].value===t){i.options[s].selected=!0;break}}}else if(e==="mandatory")this._updateState();else if(e==="readOnly"||e==="disabled"){var i=this.getSelectField(),o=
this.getProperty("disabled")||this.getProperty("readOnly");this._skinObj.simpleHTML&&(i.disabled=o?"disabled":"");var u=o?-1:this._calculateTabIndex();i.tabIndex=u,this._updateState()}else if(e==="options")if(this.controller){this.controller.setListOptions(t);var r=this.controller.checkValue(null);this._reactToControllerReport(r,{stopValueProp:!0})}else{var a=[],f=aria.utils.String;for(var s=0,l=t.length;s<l;s++){var c=""+t[s].value;a.push('<option value="',f.encodeForQuotedHTMLAttribute(c),'">',f.escapeHTML
(t[s].label),"</option>")}var i=this.getSelectField(),h=a.join("");if(aria.core.Browser.isIE9||aria.core.Browser.isIE8||aria.core.Browser.isIE7){i.innerHTML="";var p=Aria.$window.document.createElement("div");p.innerHTML="<select>"+h+"</select>";for(var d=0,v=p.children[0].children;d<v.length;d++)i.appendChild(v[d])}else i.innerHTML=h}else e==="formatError"||e==="formatErrorMessages"||e==="error"||e==="errorMessages"?(this._cfg[e]=t,this._updateState()):this.$DropDownInput._onBoundPropertyChange.apply(this,arguments
)},getSelectField:function(){return!this._selectField&&!this._initDone&&this.getDom(),this._selectField},getTextInputField:function(){return this.getSelectField()}}});
//*******************
...
:"%1Value %2 is of incorrect type."},$prototype:{$init:function(e,t,n){e.bindableProperties=e.bindableProperties.concat("prefill"),e.automaticallyBindedProperties=e.automaticallyBindedProperties.concat("prefillError")},_getTextFieldColor:function(){if(this._simpleHTML)return this._skinObj.states[this._state].color;if(this._isIE7OrLess){var e=this._skinObj.states[this._state];return e.color||e.frame.color}return"inherit"},_inputWithFrameMarkup:function(e){var t=this._cfg,n=this._skinObj,r=this._helpTextSet,i=
this._skinObj.helpText,s=this._getTextFieldColor(),o,u=aria.utils.String,a=["padding:",n.innerPaddingTop,"px ",n.innerPaddingRight,"px ",n.innerPaddingBottom,"px ",n.innerPaddingLeft,"px;position:relative;margin:0;"];this._simpleHTML||a.push("background-color:transparent;border-width:0px;vertical-align:top;");var f=t.invalidText||"",l=this.checkValue({text:f,value:t.value,performCheckOnly:!0});l.report&&(o=l.report,!f&&o.text!=null&&(f=""+o.text),o.$dispose());if(!f){var c=t.prefill&&this.controller&&this.controller
.getDisplayTextFromValue?this.controller.getDisplayTextFromValue(t.prefill):t.prefill;f=c}r&&(this._isIE7OrLess&&this._isPassword?(this._helpTextSet=r=!1,t.helptext=null):s=i.color+(i.italics?";font-style:italic":""));var h=this._isPassword&&!r?"password":"text",p=this._frame.innerWidth-n.innerPaddingLeft-n.innerPaddingRight;p<0&&(p=0);var d="";t.spellCheck!=null&&(d=' spellcheck="'+(t.spellCheck?"true":"false")+'"'),this._isTextarea?e.write(["<textarea",Aria.testMode?' id="'+this._domId+'_textarea"':"",t.disabled?' disabled="disabled"'
:t.readOnly?' readonly="readonly"':"",' type="',h,'" style="',a.join(""),"color:",s,";overflow:auto;resize:none;height: "+this._frame.innerHeight+"px; width:",p,'px;"','value=""',t.maxlength>-1?'maxlength="'+t.maxlength+'" ':" ",t.tabIndex!=null?'tabindex="'+this._calculateTabIndex()+'" ':" ",d,">",u.encodeForQuotedHTMLAttribute(this._helpTextSet?t.helptext:f),"</textarea>"].join("")):e.write(['<input class="xTextInputInput" ',Aria.testMode?' id="'+this._domId+'_input"':"",t.disabled?' disabled="disabled"':t
.readOnly?' readonly="readonly"':"",' type="',h,'" style="',a.join(""),"color:",s,";width:",p,'px;"','value="',u.encodeForQuotedHTMLAttribute(this._helpTextSet?t.helptext:f),'" ',t.maxlength>-1?'maxlength="'+t.maxlength+'" ':" ",t.tabIndex!=null?'tabindex="'+this._calculateTabIndex()+'" ':" ",d,' _ariaInput="1"/>'].join(""))},_initInputMarkup:function(e){this.$InputWithFrame._initInputMarkup.call(this,e),this._textInputField=this._frame.getChild(0),this._reactToChange()},getTextInputField:function(){return!this
._textInputField&&!this._initDone&&this.getDom(),this._textInputField},checkValue:function(e){var t=this.getTextInputField(),n=t?t.value:"",r=null,i=!1;e&&(n=e.text!=null?e.text:n,r=e.value,i=e.performCheckOnly),!i&&this._cfg.directOnBlurValidation&&this.changeProperty("formatError",!1);if(this.controller){var s=this._cfg.formatErrorMessages.length?!0:!1,o;r!=null?o=this.controller.checkValue(r):o=this.controller.checkText(n,s);if(o){o.errorMessages.length?(this.changeProperty("invalidText",n),this._cfg.directOnBlurValidation&&!
i&&this.changeProperty("formatErrorMessages",o.errorMessages)):this._cfg.formatError===!1&&aria.utils.Type.isArray(this._cfg.formatErrorMessages)&&this._cfg.formatErrorMessages.length?(this.changeProperty("invalidText",null),this.changeProperty("formatErrorMessages",[])):o.ok&&this.changeProperty("invalidText",null);if(i)return{isValid:o.ok,report:o};this._reactToControllerReport(o,e);return}return{isValid:!0,report:null}}return{isValid:!0,report:null}},_reactToControllerReportEvent:function(e){this._keepFocus||
this._hasFocus?this._reactToControllerReport(e.report,e.arg):e.report&&e.report.$dispose()},_reactToControllerReport:function(e,t){var n=!1,r=this._cfg;if(e){var i=!0,s=this._hasFocus,o=!1,u=!1;t&&(i=t.resetErrorIfOK!==!1,t.hasFocus!=null&&(s=t.hasFocus),t.stopValueProp&&(o=t.stopValueProp),t.delayedValidation&&(u=t.delayedValidation));if(!u){var a=e.text,f=e.value;a!=null&&!this._helpTextSet&&(this.getTextInputField().value=a,e.caretPosStart!=null&&e.caretPosEnd!=null&&this.setCaretPosition(e.caretPosStart,
e.caretPosEnd)),typeof f!="undefined"&&!o&&!this._isPropertyEquals("value",f)&&(n=this.setProperty("value",f))}this._cfg&&(e.ok?i&&r.directOnBlurValidation&&this.changeProperty("formatError",!1):e.ok===!1&&(s&&e.matchCorrectValueStart?r.directOnBlurValidation&&this.changeProperty("formatError",!1):r.directOnBlurValidation&&this.changeProperty("formatError",!0),n=this.setProperty("value",undefined))),n&&this._cfg&&(this.changeProperty("error",!1),this.evalCallback(r.onchange)),e.$dispose()}},getCaretPosition:
function(){if(!this._hasFocus)return null;var e=this.getTextInputField();return aria.utils.Caret.getPosition(e)},setCaretPosition:function(e,t){if(!this._hasFocus)return;var n=this.getTextInputField();aria.utils.Caret.setPosition(n,e,t)},_isPropertyEquals:function(e,t){var n=this.getProperty(e);return n===t},_onBoundPropertyChange:function(e,t,n){if(e==="value"){this.setHelpText(!1),this.setPrefillText(!1,null,!0);var r=this._cfg,i="",s=this.checkValue({performCheckOnly:!0,value:t,text:t==null?"":null});if(!
s.isValid){this.$logError(this.WIDGET_VALUE_IS_WRONG_TYPE,[t]),s.report.$dispose();return}this._cfg&&s.report&&s.report.text!=null&&(this._cfg.directOnBlurValidation&&this.changeProperty("formatError",!1),i=s.report.text),this.getTextInputField().value=i,s.report.$dispose();if(s.report&&s.report.value!=t){var o=s.report.value;this._isPropertyEquals("value",o)||this.setProperty("value",o)}this.setHelpText(!0),(aria.utils.Type.isArray(r.value)&&aria.utils.Array.isEmpty(r.value)||!r.value)&&r.prefill&&r.prefill+""&&
this.setPrefillText(!0,r.prefill,!0)}else if(e==="invalidText"){if(t==n)return;var s;this._cfg.value&&(s=this.checkValue({performCheckOnly:!0,value:this._cfg.value,text:t==null?"":null}));if(!s||!s.isValid){var u=this.getTextInputField();u&&(u.value=t)}s&&s.report&&s.report.$dispose(),t||(this.changeProperty("formatErrorMessages",[]),this.changeProperty("formatError",!1),this.changeProperty("error",!1)),this.setProperty("invalidText",t),this._reactToChange()}else e==="readOnly"||e==="disabled"?(t&&(this._hasFocus=!1
),this._cfg[e]=t,this._reactToChange()):e==="mandatory"||e==="formatError"||e==="formatErrorMessages"||e==="error"||e==="errorMessages"?(this._cfg[e]=t,this._reactToChange()):e=="prefill"?this.setPrefillText(!0,t,!0):e=="prefillError"?t?this.setPrefillText(!0,"",!0):t===!1&&this.setPrefillText(!0,this._cfg.prefill,!0):this.$InputWithFrame._onBoundPropertyChange.apply(this,arguments)},_setState:function(){if(this._cfg.disabled)this._state="disabled";else if(this._cfg.readOnly)this._state="readOnly";else if(this
._isPrefilled)this._state="prefill";else{this._cfg.mandatory?this._state="mandatory":this._state="normal";if(this._cfg.formatError||this._cfg.error)this._state+="Error";if(this._hasFocus||this._keepFocus)this._state+="Focused"}},_updateState:function(){this.$InputWithFrame._updateState.call(this);var e=this._skinObj,t=this._frame.innerWidth-e.innerPaddingLeft-e.innerPaddingRight;t<0&&(t=0),this.getTextInputField().style.width=t+"px",(this._isIE7OrLess||this._simpleHTML)&&!this._helpTextSet&&(this.getTextInputField
().style.color=this._getTextFieldColor()),!this._cfg.formatError&&!this._cfg.error&&this._validationPopupHide()},_reactToChange:function(){var e=this.getTextInputField();e&&(this._updateState(),e.readOnly=this._cfg.readOnly,e.disabled=this._cfg.disabled)},_onvalidate:function(e){this._cfg.onvalidate&&(this.$logWarn(this.WIDGET_PROPERTY_DEPRECATION,["onvalidate"]),this.evalCallback(this._cfg.onvalidate)),e.popup&&this._cfg.error?this._validationPopupShow(this):this._validationPopupHide(this)},_dom_onkeydown:function(
e){var t=e.keyCode==e.KC_ENTER;t&&this.checkValue()},_dom_onkeyup:function(e){this._cfg.validationDelay&&(this._valTimer&&aria.core.Timer.cancelCallback(this._valTimer),this._valTimer=aria.core.Timer.addCallback({fn:this.checkValue,scope:this,args:{delayedValidation:!0},delay:this._cfg.validationDelay}))},_dom_onclick:function(){this._autoselect()},_dom_onfocus:function(e){this._hasFocus=!0;if(!this._keepFocus){var t=this._cfg;if(t.readOnly)return;this.setHelpText(!1),this._isPrefilled&&(this.setPrefillText(!1
),this.checkValue({value:t.prefill})),this.checkValue({stopValueProp:!0}),this._cfg&&(t=this._cfg,t.validationEvent==="onFocus"&&(t.formatError&&t.formatErrorMessages.length||t.error&&t.errorMessages.length)&&this._validationPopupShow(this)),this._updateState()}else{var n=this._currentCaretPosition;this._currentCaretPosition=null,n&&this.setCaretPosition(n.start,n.end)}},_dom_onblur:function(e){if(!this._hasFocus)return;if(!this._keepFocus){var t=this._cfg,n=this._skinObj.helpText;this._hasFocus=!1,this._firstFocus=!0
;if(t.readOnly)return;this.checkValue(),t=this._cfg;if(!t)return;t.prefill?this.setPrefillText(!0,t.prefill,!1):this.setHelpText(!0),t.directOnBlurValidation||this.changeProperty("error",!1),this._updateState();if(t.formatError&&t.validationEvent==="onBlur")this._validationPopupShow(this);else{this._validationPopupHide(this);if(t.directOnBlurValidation){if(t.bind){var r=t.bind.value;if(r){var i=r.inside,s=r.to,o=t.validationGroups;aria.utils.Data.validateValue(i,s,null,o,"onblur");if(!this._cfg)return}}this.
_onvalidate({popup:!1})}}}else this._currentCaretPosition=this.getCaretPosition(),this._hasFocus=!1},_setAutomaticBindings:function(e){this.$InputWithFrame._setAutomaticBindings.call(this,e);var t=null,n=null,r;e&&e.bind&&(t=e.bind.value,n=e.bind.prefill),t&&t.inside&&(r=aria.utils.Data._getMeta(t.inside,t.to,!1),e.bind.invalidText||(e.bind.invalidText={inside:r,to:"invalidText"})),n&&n.inside&&(r=aria.utils.Data._getMeta(n.inside,n.to,!1),e.bind.prefillError||(e.bind.prefillError={inside:r,to:"error"}))},_checkCfgConsistency
:function(){this.$InputWithFrame._checkCfgConsistency.call(this);var e=this._cfg;e.autoselect==null&&(e.autoselect=aria.widgets.environment.WidgetSettings.getWidgetSettings().autoselect);var t=e.value;if(e.invalidText){var n=this.checkValue({text:e.invalidText,value:t,performCheckOnly:!0});if(!n.isValid)e.directOnBlurValidation&&this.changeProperty("error",!0),t=e.invalidText,this._helpTextSet=!1,n.report&&n.report.$dispose();else if(n.report){this.changeProperty("error",!1);if(n.report.text==null||n.report.
text==="")e.prefill&&e.prefill+""?this._isPrefilled=!0:this._helpTextSet=e.helptext;n.report.$dispose()}this._setState()}else{if(aria.utils.Type.isArray(t)&&aria.utils.Array.isEmpty(t)||!t)e.prefill&&e.prefill+""?this._isPrefilled=!0:this._helpTextSet=e.helptext;this._isPrefilled&&this._setState()}},setHelpText:function(e){var t=this._cfg;if(!t)return;var n=t.helptext,r=this._skinObj.helpText;if(!n||!this._helpTextSet&&!e||(this._hasFocus||this._keepFocus)&&e)return;var i=this.getTextInputField();if(i.value&&
e)return;this._helpTextSet=e;if(!i)return;var s=e?r.color:this._getTextFieldColor(),o=e&&r.italics?"italic":"normal",u=e?n:"",a=i.style;a.color=s,a.fontStyle=o,i.value=u},setPrefillText:function(e,t,n){var r=this._cfg,i;if(!r)return;var s=this.getTextInputField();if(e){if(!s||s.value&&!this._helpTextSet&&!this._isPrefilled)return;this.setHelpText(!1),t==null?i="":i=this.controller&&this.controller.getDisplayTextFromValue?this.controller.getDisplayTextFromValue(t):t,r.prefillError&&(i=""),i?(this._isPrefilled=!0
,s.value=i):(s.value=i,this._isPrefilled=!1,this.setHelpText(!0),this._updateState())}else this._isPrefilled=!1;n&&(!e||this._state!="prefill")&&this._updateState()},focus:function(e,t){if(this._cfg.disabled)return!1;var n=this.getTextInputField();n.focus(),n.value=n.value,t||this._autoselect()},_autoselect:function(){if(this._firstFocus&&this._cfg.autoselect){this._firstFocus=!1;var e=this.getTextInputField(),t=0,n=e.value.length?e.value.length:0;n&&this.setCaretPosition(t,n)}}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.form.list.CfgBeans",$description:"Beans used for the data model of the list module controller.",$namespaces:{json:"aria.core.JsonTypes"},$beans:{ListModel:{$type:"json:Object",$description:"Root of the list data model.",$properties:{items:{$type:"ItemsArray"},itemsView:{$type:"json:ObjectRef",$description:"View on the items, with the correct order to display them.",$classpath:"aria.templates.View"},activateSort:{$type:"json:Boolean",$description:"Whether sorting is enabled."
},multipleSelect:{$type:"json:Boolean",$description:"Specify whether it is possible to select multiple items at the same time (true) or at most one (false)."},maxSelectedCount:{$type:"json:Integer",$minValue:1,$description:"Maximum number of items that can be selected at the same time. It is only taken into account if multipleSelect is true. A null value means there is no maximum."},disabled:{$type:"json:Boolean",$description:"Specify whether the list is disabled (true) or enabled (false)."},selectedIndex:{$type
:"json:Integer",$minValue:-1,$description:"Index of the selected element in the list, if only one is selected. -1 means no element is selected. A null value means several elements are selected."},selectedCount:{$type:"json:Integer",$description:"Number of selected items.",$minValue:0},displayOptions:{$type:"displayOptions"},cfg:{$type:"json:ObjectRef",$description:"Configuration which should be used for the div surrounding the widget."},skin:{$type:"json:ObjectRef",$description:"Skin properties."},numberOfColumns
:{$type:"numberOfColumns",$description:"How many Rows the multi-select should contain"},numberOfRows:{$type:"numberOfRows",$description:"How many rows are to be used in the display of the list, if the number of items isn't divisible (without remainder) by the number of rows then the next number of rows value that is divisible (without remainder) will be taken into account"},focusIndex:{$type:"json:Integer",$description:"The index of the list item with focus",$default:0},preselect:{$type:"json:String",$description
:"strict: for strict highlighting (exact match only), always: for selecting the first item everytime, none: for no highlighting",$default:"none"}}},numberOfColumns:{$type:"json:Integer",$description:"How many columns are to be used in the display of the list",$default:0,$minValue:0},numberOfRows:{$type:"json:Integer",$description:"How many columns are to be used in the display of the list",$default:0,$minValue:0},displayOptions:{$type:"json:Object",$description:"Display options that are not interpreted by the list controller."
,$default:{flowOrientation:"vertical",tableMode:!1},$properties:{flowOrientation:{$type:"json:Enum",$description:"The Orientation of a list whether items are listed horizontally or vertically first. Display options may not be supported by all list templates.",$enumValues:["horizontal","vertical"],$default:"vertical"},tableMode:{$type:"json:Boolean",$description:"Specifies whether the list uses Table Mode which is when the values of a list are split on a seperator and list resulting values are put 1 on each row"
,$default:!1},listDisplay:{$type:"json:Enum",$description:"Whether to display code, value or both on the label next to the checkbox.",$enumValues:["code","label","both"],$default:"code"},displayFooter:{$type:"json:Boolean",$description:"Used to display the select all, deselect all, and close links.",$default:!1}}},ItemsArray:{$type:"json:Array",$description:"Array of items.",$contentType:{$type:"Item"}},Item:{$type:"json:Object",$description:"Structure describing an item in the list",$properties:{label:{$type
:"json:String",$description:"Text to display to the user - must be translated in user language."},value:{$type:"json:String",$description:"Internal value associated to the item - usually a language-independent code."},currentlyDisabled:{$type:"json:Boolean",$description:"Whether the item is disabled (true) or enabled (false), taking into account whether the maximum number of selected items has been reached or not."},initiallyDisabled:{$type:"json:Boolean",$description:"Whether the item is disabled (true) or enabled (false), independently of whether the maximum number of selected items has been reached or not."
},object:{$type:"json:ObjectRef",$description:"Reference to the object storing extra information about the item."},selected:{$type:"json:Boolean",$description:"Specifies whether the item is selected (true) or not (false)."},index:{$type:"json:Integer",$description:"Index in the items array."}}}}});
//*******************
//LOGICAL-PATH:aria/widgets/form/list/IListController.js
//*******************
Aria.interfaceDefinition({$classpath:"aria.widgets.form.list.IListController",$extends:"aria.templates.IModuleCtrl",$events:{onChange:{description:"Raised when user changes selection of items",properties:{selectedIndexes:"Array of newly selected indexes.",unselectedIndexes:"Array of newly unselected indexes."}},itemClick:{description:"Raised when the user clicks on an item of the list, before or after the element is actually selected or unselected (see the alreadyChanged parameter).",properties:{item:"Item which the user clicked on."
,index:"Index of the item which the user clicked on.",value:"Value of the item which the user clicked on.",alreadyChanged:"If true, the event is raised after the value changed because of the click. Otherwise before. The event is raised only once, but whether it is raised before or after the change depends on the template.",cancelDefault:"If alreadyChanged is true, it is possible to cancel the change of the value by setting this parameter to true."}},itemMouseOver:{description:"Raised when the user moves the mouse over an item of the list."
,properties:{item:"Item over which the user moved the mouse.",index:"Index of the item over which the user moved the mouse.",value:"Value of the item over which the user moved the mouse."}},keyevent:{description:"Raised when the keyevent method is called, which is normally when the user has pressed a key. A listener of this event can change some of the event properties to change the default behavior.",properties:{charCode:"",keyCode:"",cancelDefault:""}},focusList:{description:"Notifies the template script to give focus to the first element of the list"
,properties:{report:"{aria.widgets.controllers.reports.ControllerReport} a check report"}},focusTextBox:{description:"Focus the text box when the user hits the up button",properties:{report:"{aria.widgets.controllers.reports.ControllerReport} a check report"}},close:{description:"Notification that the close method was called on the List module controller"}},$interface:{toggleSelection:function(e){},setSelection:function(e,t){},getSelectedIndexes:function(){},getSelectedItems:function(){},getSelectedValues:function(
){},setSelectedValues:function(e){},setSelectedIndex:function(e){},setMultipleSelect:function(e){},setMaxSelectedCount:function(e){},setItems:function(e){},setDisabled:function(e){},setFocus:function(e){},itemClick:function(e){},itemMouseOver:function(e){},setFocusedIndex:function(){},keyevent:function(e){},close:function(){},deselectAll:function(){},selectAll:function(){}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.frames.CfgBeans",$description:"Beans describing the configuration object for frames.",$namespaces:{json:"aria.core.JsonTypes",templates:"aria.templates.CfgBeans"},$beans:{FrameCfg:{$type:"json:Object",$description:"Parameter of the createFrame method.",$properties:{id:{$type:"json:String",$description:"Id of the top level widget. Used for generated test ids."},skinnableClass:{$type:"json:String",$description:"Name of the skinnable class to use when looking for the skin class."
,$sample:"Button"},sclass:{$type:"json:String",$description:"Name of the skin class",$sample:"std"},skinObject:{$type:"json:ObjectRef",$description:"Skin object corresponding to the skin class in the skinnable class. If not provided, it is completed automatically by calling aria.widgets.AriaSkinInterface.getSkinObject(skinnableClass,sclass)."},state:{$type:"json:String",$description:"Name of the state to use."},stateObject:{$type:"json:ObjectRef",$description:"Automatically filled with skinObject.states[state]."
},width:{$type:"json:Integer",$description:"External width of the frame, or -1 if the width of the frame should depend on its content. Can be ignored by some types of frames.",$default:-1},height:{$type:"json:Integer",$description:"External height of the frame, or -1 if the height of the frame should depend on its content. Can be ignored by some types of frames.",$default:-1},cssClass:{$type:"json:String",$description:"CSS class to be used inside the frame.",$default:""},scrollBarX:{$type:"json:Boolean",$description
:"A boolean whether the tab is disabled",$default:!0},scrollBarY:{$type:"json:Boolean",$description:"A boolean whether the tab is disabled",$default:!0},printOptions:{$type:"templates:PrintOptions"},block:{$type:"json:Boolean",$description:"This frames needs to be a block"},tooltipLabels:{$type:"json:Array",$description:"Labels for tooltips of the frame, from left to right active tooltips",$contentType:{$type:"json:String",$description:"Label for a tooltip"},$default:[]},hideIconNames:{$type:"json:Array",$description
:"Array of icon names which will not be displayed. This property is taken into account only when calling aria.widgets.frames.FrameWithIcons.createFrame.",$contentType:{$type:"json:String",$description:"Icon for widget"},$default:[]},iconsLeft:{$type:"json:Array",$description:"Filled with the content of the skin properties by the aria.widgets.frames.FrameWithIcons.createFrame method.",$contentType:{$type:"json:String",$description:"Icon to be displayed left"},$default:[]},iconsRight:{$type:"json:Array",$description
:"Filled with the content of the skin properties by the aria.widgets.frames.FrameWithIcons.createFrame method.",$contentType:{$type:"json:String",$description:"Icon to be displayed right"},$default:[]},inlineBlock:{$type:"json:Boolean",$description:"This frame needs to be inline-block."}}}}});
//*******************
...
$dispose(),this._frame=null),this._icons&&(aria.utils.Array.forEach(this._iconsLeft,this._destroyIcon,this),aria.utils.Array.forEach(this._iconsRight,this._destroyIcon,this),this._iconsLeft=null,this._iconsRight=null,this._icons=null),this._domElt=null},$events:{iconClick:{description:"Raised when an icon is clicked.",properties:{iconName:"Name of the icon."}},iconMouseDown:{description:"Raised when the mouse is pressed on an icon.",properties:{iconName:"Name of the icon."}},iconMouseUp:{description:"Raised when the mouse is released on an icon."
,properties:{iconName:"Name of the icon."}},iconBlur:{description:"Raised when an icon is blured.",properties:{iconName:"Name of the icon."}},iconFocus:{description:"Raised when an icon is focused.",properties:{iconName:"Name of the icon."}}},$statics:{createFrame:function(e){e=aria.widgets.frames.FrameFactory.normalizeFrameCfg(e);var t=e.skinObject;t.iconsLeft==null||t.iconsLeft===""?t.iconsLeft=[]:aria.utils.Type.isString(t.iconsLeft)&&(t.iconsLeft=t.iconsLeft.split(",")),t.iconsRight==null||t.iconsRight===""?
t.iconsRight=[]:aria.utils.Type.isString(t.iconsRight)&&(t.iconsRight=t.iconsRight.split(","));var n=this._filterIcons(t.iconsLeft,e.hideIconNames),r=this._filterIcons(t.iconsRight,e.hideIconNames);return e.iconsLeft=n,e.iconsRight=r,n.length===0&&r.length===0?aria.widgets.frames.FrameFactory.createFrame(e):new aria.widgets.frames.FrameWithIcons(e)},_filterIcons:function(e,t){if(t.length>0){var n=[];return aria.utils.Array.forEach(e,function(r,i){aria.utils.Array.contains(t,e[i])||n.push(e[i])}),n}return e},
eventMap:{click:"iconClick",mousedown:"iconMouseDown",mouseup:"iconMouseDown",blur:"iconBlur",focus:"iconFocus"},ICON_NOT_FOUND:"Icon was not found: %1"},$prototype:{writeMarkupBegin:function(e){var t=this;aria.utils.Array.forEach(this._iconsLeft,function(n){t._writeIcon(n,e)}),this._frame.writeMarkupBegin(e)},writeMarkupEnd:function(e){this._frame.writeMarkupEnd(e);var t=this;aria.utils.Array.forEach(this._iconsRight,function(n){t._writeIcon(n,e)})},getChild:function(e){return this._frame.getChild(e)},getSkinObject
:function(){return this._skinObject},getStateName:function(){return this._stateName},getStateObject:function(){return this._skinObject.states[this._stateName]},resize:function(e,t){this._updateFrameWidth(e),this._frame.resize(this._frameWidth,t),this.innerWidth=this._frame.innerWidth,this.innerHeight=this._frame.innerHeight},_initIcon:function(e){this._icons[e]={domElts:[]}},_destroyIcon:function(e){this._icons[e].domElts=null,aria.utils.Delegate.remove(this._icons[e].iconDelegateId),this._icons[e]=null,delete 
this._icons[e]},_updateIcons:function(){var e={width:0,activeIconIndex:0},t=this;aria.utils.Array.forEach(this._iconsLeft,function(n){t._computeIconSize(n,e)}),aria.utils.Array.forEach(this._iconsRight,function(n){t._computeIconSize(n,e)}),this._iconsWidth=e.width},_updateFrameWidth:function(){var e=this._outerWidth,t;return e<0?t=-1:(t=e-this._iconsWidth,t<0&&(t=0)),this._frameWidth!==t?(this._frameWidth=t,!0):!1},_computeIconSize:function(e,t){var n=this.getStateObject(),r=n.icons[e].split(":"),i=aria.widgets
.AriaSkinInterface.getIcon(r[0],r[1]),s=n.icons[e+"IsActive"];i?(this._icons[e].iconInfo=i,this._icons[e].active=s,s&&(this._icons[e].tooltip=this._tooltipLabels[t.activeIconIndex++]),t.width+=i.width):this.$logError(this.ICON_NOT_FOUND,e)},linkToDom:function(e){var t={domElt:e},n=this;aria.utils.Array.forEach(this._iconsLeft,function(e){n._linkIconToDom(e,t)}),this._frame.linkToDom(t.domElt),t.domElt=aria.utils.Dom.getNextSiblingElement(t.domElt,this._frame.domElementNbr),aria.utils.Array.forEach(this._iconsRight
,function(e){n._linkIconToDom(e,t)})},changeState:function(e){this._stateName=e,this._updateIcons(),this._updateFrameWidth()&&this._frame.resize(this._frameWidth,this._outerHeight),aria.utils.Array.forEach(this._iconsLeft,this._changeIconState,this),this._frame.changeState(e),aria.utils.Array.forEach(this._iconsRight,this._changeIconState,this),this.innerWidth=this._frame.innerWidth,this.innerHeight=this._frame.innerHeight},getIcon:function(e){var t=this._icons[e];return t?t.domElts[0]:null},_getIconStyle:function(
e,t){var n=["padding:0;display:inline-block;background-position:-",e.iconLeft,"px -",e.iconTop,"px;width:",e.width,"px;height:",e.height,"px;vertical-align: top;"];return t&&n.push("cursor:pointer;"),n.join("")},_writeIcon:function(e,t){var n=this._icons[e],r=n.iconInfo,i=this._getIconStyle(r,n.active),s=aria.utils.Delegate,o=s.add({fn:this._delegateIcon,scope:this,args:e});this._icons[e].iconDelegateId=o;var u=n.tooltip?' title="'+n.tooltip.replace(/\"/gi,"&quot;")+'"':"";t.write(["<span",Aria.testMode&&this
._baseId?' id="'+this._baseId+"_"+e+'"':"",' class="',r.cssClass,'" style="',i,'" '+s.getMarkup(o)+u+' tabIndex="-1">&nbsp;</span>'].join(""))},_linkIconToDom:function(e,t){var n=t.domElt;t.domElt=aria.utils.Dom.getNextSiblingElement(n),this._icons[e].domElts.push(n)},_changeIconState:function(e){var t=this._icons[e],n=t.domElts,r=t.iconInfo,i=this._getIconStyle(r,t.active);for(var s=0,o=n.length;s<o;s++){var u=n[s];u.className=r.cssClass,u.style.cssText=i}},_delegateIcon:function(e,t){var n=this.eventMap[e.
type];n&&this.$raiseEvent({name:n,iconName:t})}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.popups.Beans",$description:"Definition of the JSON beans used to set application variables",$namespaces:{json:"aria.core.JsonTypes",dom:"aria.utils.DomBeans"},$beans:{PopupConf:{$type:"json:Object",$description:"Configuration object for the aria.popups.Popup",$properties:{section:{$type:"json:ObjectRef",$description:"{aria.templates.Section} The section used to create the content of the popup",$mandatory:!0},keepSection:{$type:"json:Boolean",$description:"If true, the section is not disposed when the popup is closed (its content only is removed)."
,$default:!1},modal:{$type:"json:Boolean",$description:"If true, a mask is shown behind the popup so that mouse and keyboard interraction with elements behind the popup is not possible.",$default:!1},maskCssClass:{$type:"json:String",$description:"CSS classes to be applied on the mask. Only used if modal is true. If not specified, a default style is applied."},domReference:{$type:"json:ObjectRef",$description:"{HTMLElement} The DOM reference which will be used as the reference position for the tooltip",$default
:null},absolutePosition:{$type:"dom:Position",$description:"Takes priority over domReference if defined. The exact coordinates where the popup should be displayed. Anchors and offsets will still be applied",$default:null},center:{$type:"json:Boolean",$description:"If true, the popup will be in the center of the browser window. This takes priority over absolutePosition and domReference.",$default:!1},closeOnMouseClick:{$type:"json:Boolean",$description:"Close the popup when the user clicks outside of the popup"
,$default:!0},closeOnMouseScroll:{$type:"json:Boolean",$description:"Close the popup when the user scrolls outside of the popup",$default:!0},closeOnMouseOut:{$type:"json:Boolean",$description:"Close the popup when the user leaves the popup, after a delay, set in closeOnMouseOutDelay",$default:!1},closeOnMouseOutDelay:{$type:"json:Integer",$description:"Delay before closing the popup when the user leaves the popup",$default:500},preferredPositions:{$type:"json:Array",$description:"Array of positions such as 'bottom right' to describe the relative position of the popup with its reference."
,$contentType:{$type:"PreferredPosition",$mandatory:!0,$description:"A preferred position. The order indicates the order of preference."},$default:[{}]},offset:{$type:"OffsetConfig",$description:"Offset for displaying the popup",$default:{}},ignoreClicksOn:{$type:"json:Array",$description:"Array of HTMLElements. The popup should not close when one of the leemnts are clicked.",$contentType:{$type:"json:ObjectRef",$description:"(HTMLElement)"},$default:[{}]},parentDialog:{$type:"json:ObjectRef",$description:"[Optional] The dialog the popup belongs to"
...
,properties:{domEvent:"{aria.DomEvent} The event that triggered the closing of the popup",cancelClose:"{Boolean} Cancel the closing of the popup"}},onMouseClickClose:{description:"Event triggered when the popup is close with a mouse click outside the popup",properties:{domEvent:"{aria.DomEvent} The event that triggered the closing of the popup"}},onAfterClose:"",onBeforeOpen:"",onAfterOpen:"",onPositioned:{description:"Triggered when position of the popup is choosen, according to prefered position provided",
properties:{position:"Position choosed if any. If empty, no position in viewset was found."}}},$statics:{ANCHOR_BOTTOM:"bottom",ANCHOR_TOP:"top",ANCHOR_LEFT:"left",ANCHOR_RIGHT:"right"},$constructor:function(){this.preferredPositions=[],this.modalMaskDomElement=null,this._delegateId=aria.utils.Delegate.add({fn:this._handleDelegate,scope:this}),this.domElement=null,this.isOpen=!1,this.reference=null,this.referencePosition=null,this.referenceSize=null,this.section=null,this.sectionSize=null,this.ANCHOR_KEYS=[this
.ANCHOR_BOTTOM,this.ANCHOR_TOP,this.ANCHOR_LEFT,this.ANCHOR_RIGHT],this._ignoreClicksOn=null,this._rootElementOverflow=-1,this._rootElement=aria.utils.Dom.getDocumentScrollElement(),this._document=Aria.$window.document,aria.popups.PopupManager.registerPopup(this)},$destructor:function(){this.close(),this.reference=null,this._delegateId&&aria.utils.Delegate.remove(this._delegateId),this.section&&(this.section.$unregisterListeners(this),this.conf.keepSection?this.section.removeContent():this.section.$dispose()
,this.section=null),this.modalMaskDomElement&&(aria.utils.Dom.removeElement(this.modalMaskDomElement),this.modalMaskDomElement=null),this.domElement&&(aria.utils.Dom.removeElement(this.domElement),this.domElement=null),this.conf.domReference=null,this._parentDialog=null,this._ignoreClicksOn=null,this._document=null,this.$unregisterListeners(),aria.popups.PopupManager.unregisterPopup(this)},$prototype:{_applyConfig:function(e){aria.core.JsonValidator.normalize({json:e,beanName:"aria.popups.Beans.PopupConf"}),
this.modalMaskDomElement&&(aria.utils.Dom.removeElement(this.modalMaskDomElement),this.modalMaskDomElement=null),e.modal&&(this.modalMaskDomElement=this._createMaskDomElement(e.maskCssClass)),this.domElement!=null&&aria.utils.Dom.removeElement(this.domElement),this.domElement=this._createDomElement(),this.setPreferredPositions(e.preferredPositions),this.setSection(e.section),e.absolutePosition===null?this.setReference(e.domReference):this.setPositionAsReference(e.absolutePosition),this._ignoreClicksOn=e.ignoreClicksOn
,this._parentDialog=e.parentDialog,this.conf=e},_attachMouseOverListener:function(){this._detachMouseOverListener(),aria.utils.Event.addListener(this.getDomElement(),"mouseover",{fn:this._clearMouseOutTimer,scope:this})},_handleDelegate:function(e){e.type=="contentchange"&&this.refresh()},_createDomElement:function(){var e=this._document,t=e.createElement("div");t.style.cssText="position:absolute;top:-15000px;left:-15000px;",e.body.appendChild(t),t.innerHTML="<div "+aria.utils.Delegate.getMarkup(this._delegateId
)+" style='position:absolute;top:-15000px;left:-15000px;visibility:hidden;display:block;'></div>";var n=t.firstChild;return e.body.removeChild(t),e.body.appendChild(n),n},_createMaskDomElement:function(e){var t=this._document,n=t.createElement("div");return n.className=e||"xModalMask-default",n.style.cssText="position:absolute;top:-15000px;left:-15000px;visibility:hidden;display:block;",t.body.appendChild(n)},_clearMouseOutTimer:function(){aria.core.Timer.cancelCallback(this._mouseOutTimer)},_defaultBeforeOpenCallback
:function(){return!0},_defaultBeforeCloseCallback:function(){return!0},_detachMouseOverListener:function(){aria.utils.Event.removeListener(this.getDomElement(),"mouseover",{fn:this._clearMouseOutTimer})},_getComputedStyle:function(){var e,t;this.isOpen&&this.computedStyle.zIndex?t=this.computedStyle.zIndex:t=aria.popups.PopupManager.getZIndexForPopup(this),this.conf.preferredWidth>0?e={width:this.conf.preferredWidth,height:0}:e=this._getFreeSize();var n=this._getPosition(e),r={top:n.top,left:n.left,height:e.
height,width:e.width,zIndex:t};return r},_getFreeSize:function(){var e=this.domElement,t=aria.core.Browser;e.style.cssText="position:absolute;top:-15000px;left:-15000px;visibility:hidden;display:block;";var n=t.isIE9||t.isIE10?e.offsetWidth+1:e.offsetWidth;return{width:n,height:e.offsetHeight}},_getPosition:function(e){var t,n;if(this.conf.center){var r=this.conf.offset,i={width:e.width+r.left+r.right,height:e.height+r.top+r.bottom};t=aria.utils.Dom.centerInViewport(i,this.reference),t=aria.utils.Dom.fitInViewport
(t,i,this.reference)}else{var s=0,o;do o=this.preferredPositions[s],t=this._getPositionForAnchor(o,e),n=aria.utils.Dom.isInViewport(t,e),s++;while(!n&&this.preferredPositions[s]);var u={name:"onPositioned"};n?u.position=this.preferredPositions[s-1]:(t=this._getPositionForAnchor(this.preferredPositions[0],e),t=aria.utils.Dom.fitInViewport(t,e)),this.$raiseEvent(u)}return t},_getPositionForAnchor:function(e,t){var n=this.reference,r=e.reference,i=e.popup,s=this.referencePosition.top,o=this.referencePosition.left
;r.indexOf(this.ANCHOR_BOTTOM)!=-1&&(s+=this.referenceSize.height),r.indexOf(this.ANCHOR_RIGHT)!=-1&&(o+=this.referenceSize.width);var u=e.offset||this.conf.offset;i.indexOf(this.ANCHOR_BOTTOM)!=-1?(s-=t.height,s-=u.bottom):i.indexOf(this.ANCHOR_TOP)!=-1&&(s+=u.top),i.indexOf(this.ANCHOR_RIGHT)!=-1?(o-=t.width,o-=u.right):i.indexOf(this.ANCHOR_LEFT)!=-1&&(o+=u.left);var a=aria.utils.Dom._getDocumentScroll();o+=a.scrollLeft,s+=a.scrollTop;var f={top:s,left:o};return f},_hide:function(){if(!this.domElement)return;
this.domElement.style.cssText="position:absolute;display:none;overflow:auto;";if(this.modalMaskDomElement){this.modalMaskDomElement.style.cssText="position:absolute;display:none";if(this._rootElementOverflow!=-1){if(aria.core.Browser.isFirefox){var e=aria.utils.Dom._getDocumentScroll();this._rootElement.style.overflow=this._rootElementOverflow,this._rootElement.scrollTop=e.scrollTop,this._rootElement.scrollLeft=e.scrollLeft}else this._rootElement.style.overflow=this._rootElementOverflow;this._rootElementOverflow=-1
}}},_isValidAnchor:function(e){var t=e.split(" ");if(t.length>2)return!1;for(var n=0,r=t.length;n<r;n++){var i=t[n];if(!aria.utils.Array.contains(this.ANCHOR_KEYS,i))return!1}return!0},_isValidPosition:function(e){return this._isValidAnchor(e.reference)&&this._isValidAnchor(e.popup)},_onMouseOutTimeout:function(){this._detachMouseOverListener(),this.close()},_show:function(){if(this.modalMaskDomElement){if(this._rootElementOverflow==-1){this._rootElementOverflow=this._rootElement.style.overflow;if(aria.core.
Browser.isFirefox){var e=aria.utils.Dom._getDocumentScroll();this._rootElement.style.overflow="hidden",this._rootElement.scrollTop=e.scrollTop,this._rootElement.scrollLeft=e.scrollLeft}else this._rootElement.style.overflow="hidden"}var t=aria.utils.Dom._getViewportSize(),n=this._rootElement.scrollWidth,r=this._rootElement.scrollHeight;r=Math.max(t.height,r),n=Math.max(t.width,n),this.computedStyle=this._getComputedStyle(),this.modalMaskDomElement.style.cssText=["left:0px;top:0px;","width:",n,"px;","height:",
r,"px;","z-index:",this.computedStyle.zIndex,";","position:absolute;display:block;"].join("")}else this.computedStyle=this._getComputedStyle();this.domElement.style.cssText=["top:",this.computedStyle.top,"px;","left:",this.computedStyle.left,"px;","z-index:",this.computedStyle.zIndex,";","position:absolute;display:inline-block;"].join(""),aria.core.Browser.isIE7&&!this.isOpen&&this._document.body.appendChild(this.domElement)},refresh:function(){this.isOpen&&this._show()},moveTo:function(e){e&&("center"in e&&
(this.conf.center=e.center),"absolutePosition"in e&&this.setPositionAsReference(e.absolutePosition)),this.refresh(),this.refreshProcessingIndicators()},cancelMouseOutTimer:function(){this._mouseOutTimer&&this._clearMouseOutTimer()},close:function(e){if(this.isOpen){var t={name:"onBeforeClose",cancelClose:!1,domEvent:e};this.$raiseEvent(t),t.cancelClose||(this._hide(),this.isOpen=!1,aria.popups.PopupManager.onPopupClose(this),this.$raiseEvent("onAfterClose"))}},closeOnMouseClick:function(e){if(this.conf.closeOnMouseClick
){var t={name:"onMouseClickClose",cancelClose:!1,domEvent:e};return this.$raiseEvent(t),this.close(e),!0}},closeOnMouseOut:function(e){this.conf.closeOnMouseOut&&(this.conf.closeOnMouseOutDelay?(this.cancelMouseOutTimer(),this._mouseOutTimer=aria.core.Timer.addCallback({fn:this._onMouseOutTimeout,scope:this,delay:this.conf.closeOnMouseOutDelay}),this._attachMouseOverListener()):this.close(e))},closeOnMouseScroll:function(e){if(this.conf.closeOnMouseScroll)return this.close(e),!0},_isScrolling:function(){var e=
this.reference;if(e){var t=aria.utils.Dom.getGeometry(e);t?(this.referencePosition={left:t.x,top:t.y},this.referenceSize={width:t.width,height:t.height},this.refresh(),this.domElement&&this.domElement.style.visibility==="hidden"&&(this.domElement.style.visibility="visible")):this.domElement.style.visibility="hidden"}},getDomElement:function(){return this.domElement},open:function(e){this.isOpen||(this.$raiseEvent("onBeforeOpen"),this._applyConfig(e),this._show(),this.isOpen=!0,aria.popups.PopupManager.onPopupOpen
(this),this.refreshProcessingIndicators(),this.$raiseEvent("onAfterOpen"))},setPreferredPositions:function(e){this.preferredPositions=[];for(var t=0,n=e.length;t<n;t++){var r=e[t];this._isValidPosition(r)&&(this.preferredPositions[this.preferredPositions.length]=r)}},setPositionAsReference:function(e){var t={height:0,width:0};e={top:e.top,left:e.left},this.reference=null,this.referencePosition=e,this.referenceSize=t},setReference:function(e){var t=aria.utils.Size.getSize(e),n=aria.utils.Dom;n.scrollIntoView(
e);var r=n.calculatePosition(e);this.reference=e,this.referencePosition=r,this.referenceSize=t},setSection:function(e){aria.utils.Dom.replaceHTML(this.domElement,e.html);var t=this.domElement.firstChild;e.initWidgets(),this.section=e},refreshProcessingIndicators:function(){this.section&&this.section.refreshProcessingIndicator(!0)}}});
//*******************
//LOGICAL-PATH:aria/popups/PopupManager.js
//*******************
(function(){var e=null,t=null,n=null;Aria.classDefinition({$classpath:"aria.popups.PopupManager",$dependencies:["aria.DomEvent","aria.utils.Event","aria.utils.Array","aria.utils.Dom","aria.utils.Math","aria.templates.NavigationManager","aria.utils.AriaWindow"],$events:{modalPopupPresent:{description:"Notifies that a modal popup has been opened when no other modal popup was already opened."},modalPopupAbsent:{description:"Notifies that a modal popup has been closed when no other modal popup remains open."},popupOpen
:{description:"Notifies that a popup has been opened.",properties:{popup:"Reference to the popup"}},popupClose:{description:"Notifies that a popup has been closed",properties:{popup:"Reference to the popup"}}},$onload:function(){e=aria.utils.Array,t=aria.utils.Dom,n=aria.utils.Event},$onunload:function(){e=null,t=null,n=null},$singleton:!0,$constructor:function(){this.openedPopups=[],this.modalPopups=0,this.popups=[],this.baseZIndex=2e4,this.currentZIndex=this.baseZIndex,aria.utils.AriaWindow.$on({unloadWindow
:this._reset,scope:this})},$destructor:function(){aria.utils.AriaWindow.$unregisterListeners(this),this._reset()},$prototype:{_reset:function(){this._closeAllPopups(),this._unregisterAllPopups(),this.disconnectEvents()},_closeAllPopups:function(){for(var e=this.openedPopups.length-1;e>=0;e--){var t=this.openedPopups[e];t.close()}},_isEventInsidePopup:function(e,t){var n=aria.utils.Dom._getDocumentScroll(),r={top:e.clientY+n.scrollTop,left:e.clientX+n.scrollLeft},i={top:t.computedStyle.top,left:t.computedStyle
.left},s={width:t.computedStyle.width,height:t.computedStyle.height};return r.top>=i.top&&r.left>=i.left&&r.top<=i.top+s.height&&r.left<=i.left+s.width},_unregisterAllPopups:function(){for(var e=this.popups.length-1;e>=0;e--){var t=this.popups[e];this.unregisterPopup(t)}},connectEvents:function(){this.disconnectEvents(),aria.utils.AriaWindow.attachWindow(),this._document=Aria.$window.document,n.addListener(this._document,"mousedown",{fn:this.onDocumentClick,scope:this},!0),n.addListener(this._document,"mouseout"
,{fn:this.onDocumentMouseOut,scope:this},!0),n.addListener(this._document,"mousewheel",{fn:this.onDocumentMouseScroll,scope:this},!0),aria.core.Browser.isIE?aria.utils.Event.addListener(Aria.$window,"mousewheel",{fn:this._onScroll,scope:this},!0):aria.utils.Event.addListener(Aria.$window,"scroll",{fn:this._onScroll,scope:this},!0)},disconnectEvents:function(){this._document&&(n.removeListener(this._document,"mousedown",{fn:this.onDocumentClick}),n.removeListener(this._document,"mouseout",{fn:this.onDocumentMouseOut
}),n.removeListener(this._document,"mousewheel",{fn:this.onDocumentMouseScroll}),aria.utils.AriaWindow.detachWindow(),this._document=null,aria.core.Browser.isIE?aria.utils.Event.removeListener(Aria.$window,"mousewheel",{fn:this._onScroll}):aria.utils.Event.removeListener(Aria.$window,"scroll",{fn:this._onScroll}))},connectModalEvents:function(){n.addListener(this._document.body,"focusin",{fn:this.onDocumentFocusIn,scope:this})},disconnectModalEvents:function(){n.removeListener(this._document.body,"focusin",{
fn:this.onDocumentFocusIn})},_onScroll:function(e){for(var t=this.openedPopups.length-1;t>=0;t--){var n=this.openedPopups[t];e.type==="mousewheel"?aria.core.Timer.addCallback({fn:n._isScrolling,scope:n}):e.type==="scroll"&&n._isScrolling()}},getZIndexForPopup:function(e){return this.currentZIndex+=10,this.currentZIndex},hide:function(e){e.close(),e.$dispose()},onDocumentFocusIn:function(e){var n=new aria.DomEvent(e),r=n.target,i=r!=this._document.body;if(i)for(var s=this.openedPopups.length-1;s>=0;s--){var o=
this.openedPopups[s];if(t.isAncestor(r,o.getDomElement()))break;if(o.modalMaskDomElement){aria.templates.NavigationManager.focusFirst(o.domElement);break}}n.$dispose()},onDocumentClick:function(e){var n=new aria.DomEvent(e),r=n.target;if(this.openedPopups.length===0){n.$dispose();return}var i=this.openedPopups[this.openedPopups.length-1],s=!1;for(var o=0,u=i._ignoreClicksOn.length;o<u;o++)if(t.isAncestor(r,i._ignoreClicksOn[o])){s=!0;break}!s&&!t.isAncestor(r,i.getDomElement())&&i.closeOnMouseClick(n),n.$dispose
()},onDocumentMouseOut:function(e){var n=new aria.DomEvent(e),r=n.target,i=n.relatedTarget;for(var s=this.openedPopups.length-1;s>=0;s--){var o=this.openedPopups[s];!t.isAncestor(i,o.getDomElement())&&t.isAncestor(r,o.getDomElement())&&o.closeOnMouseOut(n)}n.$dispose()},onDocumentMouseScroll:function(e){var n=new aria.DomEvent(e),r=n.target,i=!1,s=[];for(var o=this.openedPopups.length-1;o>=0;o--){var u=this.openedPopups[o];if(!t.isAncestor(r,u.getDomElement())){var a=u.closeOnMouseScroll(n);if(a)break}}n.$dispose
()},onPopupOpen:function(t){e.isEmpty(this.openedPopups)&&this.connectEvents(),t.modalMaskDomElement&&(this.modalPopups===0&&(this.connectModalEvents(),this.$raiseEvent("modalPopupPresent")),this.modalPopups+=1),this.openedPopups.push(t),this.$raiseEvent({name:"popupOpen",popup:t})},onPopupClose:function(t){e.remove(this.openedPopups,t),t.modalMaskDomElement&&(this.modalPopups-=1,this.modalPopups===0&&(this.disconnectModalEvents(),this.$raiseEvent("modalPopupAbsent"))),e.isEmpty(this.openedPopups)&&this.disconnectEvents
(),this.$raiseEvent({name:"popupClose",popup:t})},registerPopup:function(t){e.contains(this.popups,t)||this.popups.push(t)},show:function(e){var t=new aria.popups.Popup;return t.open(e),t},unregisterPopup:function(t){e.contains(this.openedPopups,t)&&e.remove(this.openedPopups,t),e.contains(this.popups,t)&&e.remove(this.popups,t),e.isEmpty(this.openedPopups)&&(this.currentZIndex=this.baseZIndex)},getPopupFromDom:function(e){var t=this.popups;for(var n=0,r=t.length;n<r;n++){var i=t[n];if(i.domElement==e)return i
}return null}}})})();
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.utils.environment.NumberCfgBeans",$description:"A definition of the JSON beans used to set the environment settings.",$namespaces:{json:"aria.core.JsonTypes",environmentBase:"aria.core.environment.EnvironmentBaseCfgBeans"},$beans:{AppCfg:{$type:"json:Object",$description:"Application environment variables",$restricted:!1,$properties:{decimalFormatSymbols:{$type:"DecimalFormatSymbols",$description:"Represents the set of symbols used to interpret and format numbers.",$default
:{}},currencyFormats:{$type:"CurrencyFormatsCfg",$description:"Default currency formatting for the application.",$default:{}}}},DecimalFormatSymbols:{$type:"json:Object",$description:"",$properties:{decimalSeparator:{$type:"json:String",$description:"Character used for decimal sign. (e.g. '.' dot in en_US or ',' comma in fr_FR.",$default:"."},groupingSeparator:{$type:"json:String",$description:"Character used for grouping separator. (e.g. ',' dot in en_US or ' ' space in fr_FR.",$default:","},strictGrouping:
{$type:"json:Boolean",$description:"Enforce strict group validation. If true, a grouping separation will be checked against the pattern.",$default:!1}}},CurrencyFormatsCfg:{$type:"json:Object",$description:"",$properties:{currencyFormat:{$type:"environmentBase:FormatTypes",$description:"Pattern for number formatting.",$default:"#.######"},currencySymbol:{$type:"environmentBase:FormatTypes",$description:"Currency symbol.",$default:"USD"}}}}});