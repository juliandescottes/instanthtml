...
//*******************
Aria.beanDefinitions({$package:"aria.widgets.AriaSkinBeans",$description:"Structure of a skin.",$namespaces:{json:"aria.core.JsonTypes"},$beans:{Object:{$type:"json:Object",$description:"",$default:{}},Color:{$type:"json:String",$description:"Description of the desired color in any accepted format."},Pixels:{$type:"json:Integer",$description:"Number of pixels for the property."},Opacity:{$type:"json:Float",$description:"",$minValue:0,$maxValue:100},GeneralCfg:{$type:"Object",$description:"",$properties:{imagesRoot
:{$type:"json:String",$description:"Root path for skin images (relative to Aria.rootFolderPath). It is supposed to end with a slash.",$default:"css/"},font:{$type:"Object",$description:"",$properties:{size:{$type:"Pixels",$description:"[Deprecated, please use a CSS file directly] General font size for the application (in pixels)."},family:{$type:"json:String",$description:"[Deprecated, please use a CSS file directly] General font family for the application."}}},colors:{$type:"Object",$description:"General color settings for your application"
,$properties:{bkg:{$type:"Color",$description:"[Deprecated, please use a CSS file directly] General background color of the application."},disabled:{$type:"Color",$description:"Background color assigned to disabled elements."}}},loadingOverlay:{$type:"Object",$description:"General settings for loading indicators.",$properties:{backgroundColor:{$type:"Color"},spriteURL:{$type:"json:String",$description:""},opacity:{$type:"Opacity",$description:""}}},overlay:{$type:"Object",$description:"General settings for overlays."
,$properties:{backgroundColor:{$type:"Color",$default:"#ddd"},opacity:{$type:"Opacity",$description:"",$default:100},border:{$type:"json:String",$description:"",$default:"1px solid black"}}},dialogMask:{$type:"Object",$description:"General settings for the mask displayed in modal dialogs.",$properties:{backgroundColor:{$type:"Color",$default:"black"},opacity:{$type:"Opacity",$description:"",$default:40}}},anchor:{$type:"Object",$description:"[Deprecated, please use a CSS file directly] General settings for anchors."
,$properties:{states:{$type:"StatesSet",$description:"",$properties:{normal:{$type:"AnchorState"},link:{$type:"AnchorState"},visited:{$type:"AnchorState"},hover:{$type:"AnchorState"},focus:{$type:"AnchorState"}}}}},disable:{$type:"Object",$description:"",$properties:{ul:{$type:"Object",$description:"",$properties:{list:{$type:"Object",$description:"",$properties:{style:{$type:"json:Boolean",$description:"[Deprecated, please use a CSS file directly]"}}}}}}}}},AnchorState:{$type:"Object",$description:"[Deprecated, please use a CSS file directly] Settings for anchors."
,$properties:{color:{$type:"Color",$description:"[Deprecated, please use a CSS file directly]"},text:{$type:"Object",$properties:{decoration:{$type:"json:String",$description:"[Deprecated, please use a CSS file directly]"}}},outline:{$type:"json:String",$description:"[Deprecated, please use a CSS file directly]"}}},Icons:{$type:"json:String",$description:'Identifier for the icon to use. It has the syntax "group:name": the group is the key used to define the group of icons and the name represents the key used to refer to a specific icon inside the "content" property of the group of icons.'
},IconsLeft:{$type:"Icons",$description:'Identifier for the icon to place at the left of the widget. It has the syntax "group:name": the group is the key used to define the group of icons and the name represents the key used to refer to a specific icon inside the "content" property of the group of icons.'},IconsRight:{$type:"Icons",$description:'Identifier for the icon to place at the right of the widget. It has the syntax "group:name": the group is the key used to define the group of icons and the name represents the key used to refer to a specific icon inside the "content" property of the group of icons.'
},StatesSet:{$type:"Object",$description:'Description of the properties to apply to a widget depending on the state in which it is. Every widget has at least a "normal" state.'},StateWithFrame:{$type:"json:Object",$description:"Description of the properties to applied in a certain state of a widget which has a frame.",$properties:{frame:{$type:"json:MultiTypes",$description:"Description of the properties of a frame. The available properties depend on the type of frame that has been selected in the general widget skin settings."
,$contentTypes:[{$type:"FixedHeightFrameStateCfg"},{$type:"SimpleFrameStateCfg"},{$type:"TableFrameStateCfg"},{$type:"SimpleHTMLFrameStateCfg"},{$type:"Old0FrameStateCfg"},{$type:"Old1FrameStateCfg"},{$type:"Old2FrameStateCfg"}]}},$default:{}},StateWithFrameWithIcons:{$type:"StateWithFrame",$description:"Description of the properties to applied in a certain state of a widget which has a frame with icons.",$properties:{icons:{$type:"json:Map",$description:"",$contentType:{$type:"json:MultiTypes",$description:""
,$contentTypes:[{$type:"json:Boolean",$description:""},{$type:"Icons"}]}}}},Frame:{$type:"json:MultiTypes",$description:"General state-independent settings for the frame of a widget. This object allows to define the type of frame to use. Its properties can also be set on the parent object for backward compatibility.",$contentTypes:[{$type:"FixedHeightFrameCfg"},{$type:"SimpleFrameCfg"},{$type:"TableFrameCfg"},{$type:"SimpleHTMLFrameCfg"},{$type:"Old0FrameCfg"},{$type:"Old1FrameCfg"},{$type:"Old2FrameCfg"}]},
ButtonCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"StateWithFrame"},msdown:{$type:"StateWithFrame"},msover:{$type:"StateWithFrame"},selected:{$type:"StateWithFrame"},disabled:{$type:"StateWithFrame"}}},frame:{$type:"Frame"},simpleHTML:{$type:"json:Boolean",$description:'true when the widget has to have a basic markup as close as possible to standard HTML. As a consequence, a frame of type "SimpleHTML" will be used, which basically means that no further frame markup will be added.'
,$default:!1},label:{$type:"Object",$description:"",$properties:{fontWeight:{$type:"json:String",$description:"",$default:"normal"}}}}},CalendarCfg:{$type:"Object",$description:"",$properties:{generalBackgroundColor:{$type:"Color"},monthTitleBorderColor:{$type:"Color",$default:"#E6D9C6"},monthTitleColor:{$type:"Color",$default:"black"},monthTitleBackgroundColor:{$type:"Color",$default:"transparent"},monthTitlePaddingTop:{$type:"json:String",$description:"",$default:"0px"},monthTitlePaddingBottom:{$type:"json:String"
,$description:"",$default:"0px"},dayBorderColor:{$type:"Color"},dayBackgroundColor:{$type:"Color",$default:"transparent"},dayColor:{$type:"Color",$default:"black"},dayPadding:{$type:"json:String",$description:"",$default:"0px"},dayFontWeight:{$type:"json:String",$description:"",$default:"normal"},weekEndBackgroundColor:{$type:"Color",$default:"#F2ECDE"},weekEndBorderColor:{$type:"Color",$default:"#F2ECDE"},weekEndColor:{$type:"Color",$default:"black"},unselectableBorderColor:{$type:"Color"},unselectableBackgroundColor
:{$type:"Color"},unselectableColor:{$type:"Color"},todayBorderColor:{$type:"Color",$default:"black"},todayBackgroundColor:{$type:"Color",$default:"transparent"},todayColor:{$type:"Color",$default:"black"},weekNumberBackgroundColor:{$type:"Color",$default:"#E7DBC6"},weekNumberBorderColor:{$type:"Color",$default:"#E7DBC6"},weekDaysLabelBackgroundColor:{$type:"Color",$default:"transparent"},weekDaysLabelBorderColor:{$type:"Color",$default:"white"},weekDaysLabelFontWeight:{$type:"json:String",$description:"",$default
:"bold"},weekDaysLabelColor:{$type:"Color",$default:"black"},weekDaysLabelPadding:{$type:"json:String",$description:"",$default:"0px"},selectedBackgroundColor:{$type:"Color",$default:"#FFCC66"},selectedBorderColor:{$type:"Color",$default:"black"},selectedColor:{$type:"Color",$default:"black"},defaultTemplate:{$type:"json:PackageName",$description:"Classpath of the default template used to display the Calendar widget."},divsclass:{$type:"json:String",$description:"sclass of the Div to use inside the widget. It must be defined in the skin."
},previousPageIcon:{$type:"Icons"},nextPageIcon:{$type:"Icons"}}},ListCfg:{$type:"Object",$description:"",$properties:{divsclass:{$type:"json:String",$description:"sclass of the Div to use inside the widget. It must be defined in the skin."},enabledColor:{$type:"Color",$default:"#666"},mouseOverBackgroundColor:{$type:"Color"},mouseOverColor:{$type:"Color"},highlightMouseOver:{$type:"json:Boolean",$description:"",$default:!0},selectedItemBackgroundColor:{$type:"Color"},selectedItemColor:{$type:"Color"},link:{
$type:"Object",$description:"",$properties:{marginLeft:{$type:"Pixels",$default:3},marginRight:{$type:"Pixels",$default:3}}},footer:{$type:"Object",$description:"",$properties:{padding:{$type:"Pixels",$default:5},backgroundColor:{$type:"Color",$default:"#eadbc8"},borderColor:{$type:"Color",$default:"#d3c3ab"},borderTopOnly:{$type:"json:Boolean",$description:"",$default:!1},borderStyle:{$type:"json:String",$description:"",$default:"solid"},borderWidth:{$type:"Pixels",$default:1},marginTop:{$type:"Pixels",$default
:5},marginRight:{$type:"Pixels",$default:0},marginBottom:{$type:"Pixels",$default:0},marginLeft:{$type:"Pixels",$default:-1}}}}},LinkCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"LinkStateCfg"},hover:{$type:"LinkStateCfg"},focus:{$type:"LinkStateCfg"}}}}},LinkStateCfg:{$type:"Object",$description:"",$properties:{color:{$type:"Color"}}},GaugeCfg:{$type:"Object",$description:"",$properties:{spriteUrl:{$type:"json:String",$description:"",$default:"atdefskin/sprites/back.gif"
},sprHeight:{$type:"Pixels"},border:{$type:"json:String",$description:""},borderPadding:{$type:"Pixels"},labelMargins:{$type:"json:String",$description:""},labelFontSize:{$type:"Pixels"}}},RadioButtonCfg:{$type:"CheckBoxCfg",$description:""},CheckBoxCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"CheckBoxStateCfg"},normalSelected:{$type:"CheckBoxStateCfg"},focused:{$type:"CheckBoxStateCfg"},focusedSelected:{$type:"CheckBoxStateCfg"},disabled:{$type:"CheckBoxStateCfg"
},disabledSelected:{$type:"CheckBoxStateCfg"},readonly:{$type:"CheckBoxStateCfg"},readonlySelected:{$type:"CheckBoxStateCfg"}}},simpleHTML:{$type:"json:Boolean",$description:'true when the widget has to have a basic markup as close as possible to standard HTML. As a consequence, a frame of type "SimpleHTML" will be used, which basically means that no further frame markup will be added.',$default:!1},iconset:{$type:"json:String",$description:""},iconprefix:{$type:"json:String",$description:""}}},CheckBoxStateCfg
:{$type:"Object",$description:"",$properties:{color:{$type:"Color"}}},DatePickerCfg:{$type:"DropDownTextInputCfg",$description:"",$properties:{calendar:{$type:"Object",$properties:{showWeekNumbers:{$type:"json:Boolean",$description:"",$default:!0},restrainedNavigation:{$type:"json:Boolean",$description:"",$default:!0},showShortcuts:{$type:"json:Boolean",$description:"",$default:!0},numberOfUnits:{$type:"json:Integer",$description:"",$default:3}}}}},SelectBoxCfg:{$type:"DropDownTextInputCfg",$description:""},
TextareaCfg:{$type:"TextInputCfg",$description:""},ErrorListCfg:{$type:"Object",$description:"",$properties:{divsclass:{$type:"json:String",$description:"sclass of the Div to use inside the widget. It must be defined in the skin."}}},FieldsetCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"FieldsetStateCfg"}}},frame:{$type:"Frame"}}},FieldsetStateCfg:{$type:"StateWithFrame",$description:"",$properties:{label:{$type:"Object",$description:"",$properties:{left
:{$type:"Pixels",$default:0},top:{$type:"Pixels",$default:0},paddingTop:{$type:"Pixels",$default:0},paddingLeft:{$type:"Pixels",$default:0},paddingRight:{$type:"Pixels",$default:0},paddingBottom:{$type:"Pixels",$default:0},backgroundColor:{$type:"Color",$default:"white"},fontWeight:{$type:"json:String",$description:"",$default:"bold"},color:{$type:"Color",$default:"black"}}}}},MultiSelectCfg:{$type:"DropDownTextInputCfg",$description:""},SelectCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet"
...
:{$type:"IconsLeft"},iconsRight:{$type:"IconsRight"},simpleHTML:{$type:"json:Boolean",$description:'true when the widget has to have a basic markup as close as possible to standard HTML. As a consequence, a frame of type "SimpleHTML" will be used, which basically means that no further frame markup will be added.',$default:!1},offsetTop:{$type:"Pixels"}}},SortIndicatorCfg:{$type:"Object",$description:"",$properties:{iconset:{$type:"json:String",$description:""},iconprefix:{$type:"json:String",$description:""}
}},SplitterCfg:{$type:"Object",$description:"",$properties:{separatorHeight:{$type:"Pixels"},handleBackgroundColor:{$type:"Color",$default:"transparent"},handleSpriteURLh:{$type:"json:String",$description:""},proxyBackgroundColor:{$type:"Color",$default:"transparent"},proxySpriteURLh:{$type:"json:String",$description:""},borderColor:{$type:"Color"}}},IconCfg:{$type:"Object",$description:"Description of a group of icons.",$properties:{iconWidth:{$type:"Pixels"},iconHeight:{$type:"Pixels"},spriteSpacing:{$type
:"Pixels"},biDimensional:{$type:"json:Boolean",$description:"",$default:!1},direction:{$type:"json:Enum",$description:"Whether the sprite is horizontal or vertical",$enumValues:["x","y"]},content:{$type:"json:Map",$default:{},$description:"",$contentType:{$type:"json:Integer",$description:"Index of the icon inside the sprite."},$keyType:{$type:"json:String",$description:'Name of the icon within this sprite. To be used to refer to a specific icon with the syntax "group:icon".'}},spriteURL:{$type:"json:String"
,$description:""}}},DivCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"StateWithFrame"},topLeft:{$type:"StateWithFrame"},bottomRight:{$type:"StateWithFrame"},bottomLeft:{$type:"StateWithFrame"}}},frame:{$type:"Frame"}}},DialogCfg:{$type:"Object",$description:"",$properties:{titleBarTop:{$type:"Pixels"},titleBarLeft:{$type:"Pixels"},titleBarRight:{$type:"Pixels"},titleBarHeight:{$type:"Pixels"},titleColor:{$type:"Color",$default:"#615E55"},divsclass:{$type
:"json:String",$description:"sclass of the Div to use inside the widget. It must be defined in the skin."},closeIcon:{$type:"json:String",$description:""}}},TextInputCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"TextInputStateCfg"},normalFocused:{$type:"TextInputStateCfg"},mandatory:{$type:"TextInputStateCfg"},mandatoryFocused:{$type:"TextInputStateCfg"},normalError:{$type:"TextInputStateCfg"},normalErrorFocused:{$type:"TextInputStateCfg"},mandatoryError
:{$type:"TextInputStateCfg"},mandatoryErrorFocused:{$type:"TextInputStateCfg"},disabled:{$type:"TextInputStateCfg"},readOnly:{$type:"TextInputStateCfg"},prefill:{$type:"TextInputStateCfg"}}},simpleHTML:{$type:"json:Boolean",$description:'true when the widget has to have a basic markup as close as possible to standard HTML. As a consequence, a frame of type "SimpleHTML" will be used, which basically means that no further frame markup will be added.',$default:!1},frame:{$type:"Frame"},iconsLeft:{$type:"IconsLeft"
},iconsRight:{$type:"IconsRight"},label:{$type:"Object",$description:"",$properties:{fontWeight:{$type:"json:String",$description:"",$default:"normal"}}},helpText:{$type:"Object",$description:"",$properties:{color:{$type:"Color"},italics:{$type:"json:Boolean",$description:""}}},innerPaddingTop:{$type:"Pixels",$default:0},innerPaddingRight:{$type:"Pixels",$default:0},innerPaddingBottom:{$type:"Pixels",$default:0},innerPaddingLeft:{$type:"Pixels",$default:0}}},TextInputStateCfg:{$type:"StateWithFrameWithIcons"
,$description:"",$properties:{color:{$type:"Color",$default:"#000"}}},DropDownTextInputCfg:{$type:"TextInputCfg",$description:"",$properties:{offsetTop:{$type:"Pixels"}}},AutoCompleteCfg:{$type:"DropDownTextInputCfg",$description:""},TabPanelCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"StateWithFrame"}}},frame:{$type:"Frame"}}},TabCfg:{$type:"Object",$description:"",$properties:{states:{$type:"StatesSet",$properties:{normal:{$type:"StateWithFrame"},msover
:{$type:"StateWithFrame"},selected:{$type:"StateWithFrame"},disabled:{$type:"StateWithFrame"},normalFocused:{$type:"StateWithFrame"},msoverFocused:{$type:"StateWithFrame"},selectedFocused:{$type:"StateWithFrame"}}},frame:{$type:"Frame"}}},SimpleFrameCfg:{$type:"Object",$description:"Used for widgets which have a basic frame around them. Frame properties are then specified state-wise.",$properties:{sprType:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 6."
},frameType:{$type:"json:Enum",$enumValues:["Simple"],$description:'The value that indicates that a simple frame is desired is "Simple".'}}},SimpleFrameStateCfg:{$type:"Object",$description:'Properties of a frame of type "Simple" for this state.',$properties:{paddingTop:{$type:"Pixels",$default:0},paddingRight:{$type:"Pixels",$default:0},paddingBottom:{$type:"Pixels",$default:0},paddingLeft:{$type:"Pixels",$default:0},border:{$type:"json:String",$description:"Style of the border",$default:"",$sample:"solid"}
,borderSize:{$type:"Pixels",$default:0},borderColor:{$type:"Color",$default:""},backgroundColor:{$type:"Color",$default:"#FFF"},color:{$type:"Color",$default:""}}},SkipBorderCfg:{$type:"json:MultiTypes",$description:"",$default:!1,$contentTypes:[{$type:"json:Boolean",$description:""},{$type:"json:Enum",$description:"",$enumValues:["dependsOnIcon"]}]},FixedHeightFrameCfg:{$type:"Object",$description:"Used for widgets which have a fixed height. Frame properties are then specified state-wise.",$properties:{sprType
:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 2."},frameType:{$type:"json:Enum",$enumValues:["FixedHeight"],$description:'The value that indicates that a fixed height frame is desired is "FixedHeight".'}}},FixedHeightFrameStateCfg:{$type:"Object",$description:'Properties of a frame of type "FixedHeight" for this state.',$properties:{color:{$type:"Color",$default:"#000"},spriteURL:{$type:"json:String",$description:""},spriteURLv
:{$type:"json:String",$description:""},skipLeftBorder:{$type:"SkipBorderCfg",$description:""},skipRightBorder:{$type:"SkipBorderCfg",$description:""},sprWidth:{$type:"Pixels"},sprHeight:{$type:"Pixels"},sprIdx:{$type:"json:Integer",$description:""},sprSpacing:{$type:"Pixels",$default:2},spcLeft:{$type:"Pixels"},marginTop:{$type:"Pixels",$default:0},marginLeft:{$type:"Pixels",$default:0},marginRight:{$type:"Pixels",$default:0},marginBottom:{$type:"Pixels",$default:0}}},TableFrameCfg:{$type:"Object",$description
:"Used for widgets which have a layout based on a table. Frame properties are then specified state-wise.",$properties:{sprType:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 3."},frameType:{$type:"json:Enum",$enumValues:["Table"],$description:'The value that indicates that a table layout is desired is "Table".'}}},TableFrameStateCfg:{$type:"Object",$description:'Properties of a frame of type "Table" for this state.',$properties:{
sprWidth:{$type:"Pixels"},sprHeight:{$type:"Pixels"},sprIdx:{$type:"json:Integer",$description:"",$default:0},sprSpacing:{$type:"Pixels",$default:2},spcLeft:{$type:"Pixels"},spcTop:{$type:"Pixels"},spriteURL:{$type:"json:String",$description:""},spriteURLv:{$type:"json:String",$description:""},spriteURLh:{$type:"json:String",$description:""},marginTop:{$type:"Pixels",$default:0},marginLeft:{$type:"Pixels",$default:0},marginRight:{$type:"Pixels",$default:0},marginBottom:{$type:"Pixels",$default:0},color:{$type
:"Color",$default:"#000"},backgroundColor:{$type:"Color",$default:"#FFF"},frameHeight:{$type:"Pixels"},frameIcon:{$type:"json:String",$description:"",$default:""},frameIconHPos:{$type:"json:String",$description:"",$default:"left"},frameIconVPos:{$type:"json:String",$description:"",$default:"bottom"}}},OldFrame:{$type:"Object",$description:"",$properties:{spriteURL:{$type:"json:String",$description:""},spcLeft:{$type:"Pixels"},spcRight:{$type:"Pixels"},spcTop:{$type:"Pixels"},spcBottom:{$type:"Pixels"},sprWidth
:{$type:"Pixels"},sprHeight:{$type:"Pixels"},offsetLeft:{$type:"Pixels"}}},Old0FrameCfg:{$type:"OldFrame",$description:'Deprecated, please use farmes of types "FixedHeight", "Simple", "Table", "SimpleHTML" instead. Frame properties have to be specified state-wise.',$properties:{sprType:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 0."},frameType:{$type:"json:Enum",$enumValues:["Old0"],$description:'The value that indicates that no frame is desired is "Old0".'
}}},Old1FrameCfg:{$type:"OldFrame",$description:'Deprecated, please use farmes of types "FixedHeight", "Simple", "Table", "SimpleHTML" instead. Frame properties have to be specified state-wise.',$properties:{sprType:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 1."},frameType:{$type:"json:Enum",$enumValues:["Old1"],$description:'The value that indicates that no frame is desired is "Old1".'}}},Old2FrameCfg:{$type:"OldFrame",$description
:'Deprecated, please use farmes of types "FixedHeight", "Simple", "Table", "SimpleHTML" instead. Frame properties have to be specified state-wise.',$properties:{sprType:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 2."},frameType:{$type:"json:Enum",$enumValues:["Old2"],$description:'The value that indicates that no frame is desired is "Old2".'}}},OldFrameState:{$type:"Object",$description:"Deprecated properties of a frames of old types for this state."
,$properties:{sprIdx:{$type:"json:Integer",$description:""},textAlign:{$type:"json:String",$description:""},color:{$type:"Color"}}},Old0FrameStateCfg:{$type:"OldFrameState"},Old1FrameStateCfg:{$type:"OldFrameState"},Old2FrameStateCfg:{$type:"OldFrameState"},SimpleHTMLFrameCfg:{$type:"Object",$description:"Used for widgets which have no frame at all. No frame properties have to be specified state-wise.",$properties:{sprType:{$type:"json:Integer",$description:"Deprecated, please use frameType instead. The value corresponding to this type of frame is 5."
},frameType:{$type:"json:Enum",$enumValues:["SimpleHTML"],$description:'The value that indicates that no frame is desired is "SimpleHTML".'}}},SimpleHTMLFrameStateCfg:{$type:"Object",$description:'No properties to specify when the selected frame type is "SimpleHTML".',$properties:{}}}});
//*******************
...
null,this._splitBar=null,this._splitBarProxy=null},$destructor:function(){this._skinObj=null,this._height=null,this._handleBarClass=null,this._splitBar=null,this._splitBarProxy=null,this._splitPanel1=null,this._splitPanel2=null,this._splitBarProxyClass.$dispose(),this._destroyDraggable(),this.$Container.$destructor.call(this)},$statics:{SPLITTER_BORDER_SIZE:2},$prototype:{initWidget:function(){this.$Container.initWidget.apply(this,arguments);var e=aria.utils.Dom.getDomElementChild,t=e(e(this.getDom(),0),0);this
._splitPanel1=e(t,0),this._splitBar=e(t,1),this._splitBarProxy=e(t,2),this._splitPanel2=e(t,3),this._splitBarProxyClass=new aria.utils.ClassList(this._splitBarProxy);var n="splitBarProxy_"+this._domId;this._draggable=new aria.utils.dragdrop.Drag(n,{handle:n,cursor:"n-resize",proxy:null,constrainTo:t}),this._draggable.$on({dragstart:{fn:this._onDragStart,scope:this},dragend:{fn:this._onDragEnd,scope:this}})},_onDragStart:function(){aria.core.Browser.isIE&&(this.getDom().onselectstart=Aria.returnFalse),this._splitBarProxyClass
.remove(this._handleBarClass),this._splitBarProxyClass.add("xSplitter_"+this._cfg.sclass+"_sSplitBarProxyH")},_onDragEnd:function(){this.getDom().onselectstart=Aria.returnTrue,this._splitBarProxyClass.remove("xSplitter_"+this._cfg.sclass+"_sSplitBarProxyH"),this._splitBarProxyClass.add(this._handleBarClass),this._context.$refresh({outputSection:"_splitterContent1_"+this._domId}),this._context.$refresh({outputSection:"_splitterContent2_"+this._domId});var e=this._draggable.element,t=e.offsetTop<=0?0:e.offsetTop
,n=this._height-t<=0?0:this._height-t;this.setProperty("size1",t),this.setProperty("size2",n),this._splitPanel1.style.height=t+"px",this._splitPanel2.style.height=n+"px",this._splitBar.style.top=t+"px",this._splitBarProxy.style.top=t+"px"},_widgetMarkupBegin:function(e){var t=this._cfg,n=this._calculateSize(t);this.setProperty("size1",n.size1),this.setProperty("size2",n.size2);var r="",i=t.width,s=this._height+Number(this._skinObj.separatorHeight);t.border&&(r="xSplitter_"+t.sclass+"_sBdr"),this._handleBarClass=
t.orientation=="horizontal"?"xSplitter_"+t.sclass+"_sHandleH":"xSplitter_"+t.sclass+"_sHandleV",e.write(['<span class="xSplitter_',t.sclass,"_sContainer ",r,'" style="height:',s,"px;width:",t.width,'px;"><span class="xSplitter_',t.sclass,'_sConstrained"  ><span class="xSplitter_',t.sclass,'_sMacro" style="height: ',n.size1,"px; width:",t.width,'px;">'].join("")),e.beginSection({id:"_splitterContent1_"+this._domId,macro:t.macro1}),e.endSection(),e.write("</span> "),e.write(['<span class="',this._handleBarClass
,'" style="width:',i,"px;top:",n.size1,'px; "> </span><span id="splitBarProxy_',this._domId,'" class="',this._handleBarClass,' " style="top:',n.size1,'px; width:100%;"></span><span class="xSplitter_',t.sclass,'_sMacro" style="height: ',n.size2,"px;width:",t.width,'px;bottom:0px">'].join("")),e.beginSection({id:"_splitterContent2_"+this._domId,macro:t.macro2}),e.endSection(),e.write(["</span> </span> </span>"].join(""))},_calculateSize:function(e){var t=e.border?this.SPLITTER_BORDER_SIZE:0;this._height=e.height-
this._skinObj.separatorHeight-t,this._height<0&&(this._height=0),e.size1<0&&(e.size1=0),e.size2<0&&(e.size2=0),e.size1==null&&e.size2==null?(e.size1=Math.floor(this._height/2),e.size2=this._height-e.size1):e.size1==null&&e.size2!=null?e.size1=this._height-e.size2:e.size1!=null&&e.size2==null&&(e.size2=this._height-e.size1);var n=e.size1+e.size2,r=this._height-n,i={};return this._height==n?(i.size1=e.size1,i.size2=e.size2):e.adapt=="size1"?(i.size2=e.size2,i.size2>this._height&&(i.size2=this._height),i.size1=
this._height-i.size2):e.adapt=="size2"?(i.size1=e.size1,i.size1>this._height&&(i.size1=this._height),i.size2=this._height-i.size1):n!==0?(i.size1=Math.floor(this._height*e.size1/n),i.size2=this._height-i.size1):(i.size1=Math.floor(this._height/2),i.size2=this._height-e.size1),i},_onBoundPropertyChange:function(e,t,n){if(e=="size1"||e=="size2"){var r=this._height;t>r&&(t=r),t<0&&(t=0);var i=r-t;e=="size1"?(this._splitPanel2.style.height=i+"px",this._splitPanel1.style.height=t+"px",this._splitBar.style.top=t+"px"
,this._splitBarProxy.style.top=t+"px",this.setProperty("size1",t),this.setProperty("size2",i)):(this._splitPanel1.style.height=i+"px",this._splitPanel2.style.height=t+"px",this._splitBar.style.top=i+"px",this._splitBarProxy.style.top=i+"px",this.setProperty("size2",t),this.setProperty("size1",i)),this._context.$refresh({outputSection:"_splitterContent1_"+this._domId}),this._context.$refresh({outputSection:"_splitterContent2_"+this._domId})}else this.$Container._onBoundPropertyChange.apply(this,arguments)},_destroyDraggable
:function(){this._draggable.$removeListeners({dragstart:{fn:this._onDragStart,scope:this},dragend:{fn:this._onDragEnd,scope:this}}),this._draggable.$dispose(),this._draggable=null}}});
//*******************
...
:"Tab",printOptions:e.printOptions,id:Aria.testMode?this._domId+"_"+e.tabId:undefined}),this._spanStyle="z-index:100;vertical-align:top;"},$destructor:function(){this._frame&&(this._frame.$dispose(),this._frame=null),this.$Container.$destructor.call(this)},$prototype:{$init:function(e,t,n){e.bindableProperties=e.bindableProperties.concat(["selectedTab"])},_init:function(){var e=this.getDom(),t=aria.utils.Dom.getDomElementChild(e,0);t&&this._frame.linkToDom(t),aria.widgets.container.Tab.superclass._init.call(
this)},_focus:function(){try{this.getDom().focus()}catch(e){}},_onBoundPropertyChange:function(e,t,n){var r=!1;if(e==="selectedTab"){if(t===this._cfg.tabId||n===this._cfg.tabId)r=!0}else this.$Container._onBoundPropertyChange.call(this,e,t,n);r&&(this._cfg[e]=t,this._updateState())},_widgetMarkupBegin:function(e){this._frame.writeMarkupBegin(e)},_widgetMarkupEnd:function(e){this._frame.writeMarkupEnd(e)},_setSkinObj:function(e){this._skinObj=aria.widgets.AriaSkinInterface.getSkinObject(e,this._cfg.sclass)},_updateState
:function(e){var t="normal",n=this._cfg;n.disabled?t="disabled":n.tabId===n.selectedTab?t="selected":this._mouseOver&&(t="msover"),this._hasFocus&&(t+="Focused"),this._state=t,e||(this.getDom(),this._frame.changeState(this._state))},_selectTab:function(){this.changeProperty("selectedTab",this._cfg.tabId)},_dom_onclick:function(e){this._selectTab(),this._hasFocus||this._focus()},_dom_onmouseover:function(e){this.$Container._dom_onmouseover.call(this,e),this._mouseOver=!0,this._updateState()},_dom_onmouseout:function(
e){this.$Container._dom_onmouseout.call(this,e),this._mouseOver=!1,this._updateState()},_dom_onfocus:function(e){var t=this._cfg;this._hasFocus=!0,this._updateState()},_dom_onblur:function(e){var t=this._cfg;this._hasFocus=!1,this._updateState()},_dom_onkeyup:function(e){return!1},_dom_onkeydown:function(e){(e.keyCode==aria.DomEvent.KC_SPACE||e.keyCode==aria.DomEvent.KC_ENTER)&&this._selectTab()}}});
//*******************
...
:e.block}),this._container=!0,this._defaultMargin=0,this._spanStyle="top:-1.5px;"},$destructor:function(){this._frame&&(this._frame.$dispose(),this._frame=null),this.$Container.$destructor.call(this)},$statics:{TABPANEL_INVALID_CONFIG_MACRO:"%1Invalid tab panel configuration, you must pass a macro if your panel is not a container.",TABPANEL_INVALID_CONFIG_ID:"%1Invalid tab panel configuration, you must pass an ID if your panel is a container"},$prototype:{$init:function(e,t,n){e.bindableProperties=e.bindableProperties
.concat(["selectedTab"])},_init:function(){var e=aria.utils.Dom.getDomElementChild(this.getDom(),0);e&&this._frame.linkToDom(e),this.$Container._init.call(this)},_onBoundPropertyChange:function(e,t,n){e=="selectedTab"?this._container?this._context.$refresh({filterSection:"__tabPanel_"+this._domId}):this._context.$refresh({outputSection:"__tabPanel_"+this._domId,macro:this._cfg.macro}):this.$Container._onBoundPropertyChange.call(this,e,t,n)},_widgetMarkup:function(e){this._container=!1,this._cfg.macro?(this._widgetMarkupBegin
(e),e.callMacro(this._cfg.macro),this._widgetMarkupEnd(e)):this.$logError(this.TABPANEL_INVALID_CONFIG_MACRO)},_widgetMarkupBegin:function(e){this._container&&(this._cfg.id||this.$logError(this.TABPANEL_INVALID_CONFIG_ID)),this._frame.writeMarkupBegin(e),e.beginSection({id:"__tabPanel_"+this._domId})},_widgetMarkupEnd:function(e){e.endSection(),this._frame.writeMarkupEnd(e)},_setSkinObj:function(e){this._skinObj=aria.widgets.AriaSkinInterface.getSkinObject(e,this._cfg.sclass)}}});
//*******************
...
//*******************
Aria.beanDefinitions({$package:"aria.utils.environment.DateCfgBeans",$description:"A definition of the JSON beans used to set the environment settings.",$namespaces:{json:"aria.core.JsonTypes",environmentBase:"aria.core.environment.EnvironmentBaseCfgBeans"},$beans:{AppCfg:{$type:"json:Object",$description:"Application environment variables",$restricted:!1,$properties:{dateFormats:{$type:"DateFormatsCfg",$description:"Default date formatting for the application",$default:{dateBeforeMonth:!0,shortFormat:"d/M/y"
,mediumFormat:"d MMM y",longFormat:"d MMMM yyyy",fullFormat:"EEEE d MMMM yyyy"}},timeFormats:{$type:"TimeFormatsCfg",$description:"Default time formatting for the application",$default:{shortFormat:"HH:mm",fullFormat:"HH:mm:ss"}},firstDayOfWeek:{$type:"json:Integer",$description:"Defines first day of week in the locale. Available values: aria.utils.Date.SUNDAY, aria.utils.Date.MONDAY, aria.utils.Date.SATURDAY (0, 1, 6).",$default:0,$sample:1}}},DateFormatsCfg:{$type:"json:Object",$description:"",$properties:
{dateBeforeMonth:{$type:"json:Boolean",$description:"In European display, date is before month in 21/12/2012. In US display, month is before day in  12/21/2012",$default:!0},shortFormat:{$type:"environmentBase:FormatTypes",$description:"Short format for date formatting",$default:"d/M/y"},mediumFormat:{$type:"environmentBase:FormatTypes",$description:"Medium format for date formatting",$default:"d MMM y"},longFormat:{$type:"environmentBase:FormatTypes",$description:"Long format for date formatting",$default:"d MMMM yyyy"
},fullFormat:{$type:"environmentBase:FormatTypes",$description:"Full format for date formatting",$default:"EEEE d MMMM yyyy"}}},TimeFormatsCfg:{$type:"json:Object",$description:"",$properties:{shortFormat:{$type:"environmentBase:FormatTypes",$description:"Short format for the time formatting",$default:"hh:mm"},fullFormat:{$type:"environmentBase:FormatTypes",$description:"Full format for time formatting",$default:"hh:mm:ss"}}}}});
//*******************
